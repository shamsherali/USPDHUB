<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnsubscribeCallEmail.aspx.cs"
    Inherits="USPDHUB.UnsubscribeCallEmail" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="new-header align-right">
                                <a href="#">
                                    <img src="<%=Page.ResolveClientUrl("~/images/OuterImages/close-btn.gif")%>" width="18"
                                        height="18" border="0" onclick="Javascript:window.close();" alt="Close Window" /></a>
                            </td>
                            <td style="vertical-align: top">
