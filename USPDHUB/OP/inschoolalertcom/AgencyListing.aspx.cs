...
namespace USPDHUB.OP.inschoolalertcom
{
    public partial class AgencyListing : System.Web.UI.Page
    {
        ...
        public static string Vertical = "inschoolalert";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["VerticalDomain"] == null)
            {
                ...
                _objCommon.CreateDomainUrl(url);
            }
                            ...
                            if (checkUser == 0)
                            {
                                if (checkAgency == 0)
                                {
                                    if (isPromo)
                                    {
                                        ...
                                        if (inquiryId > 0)
                                        {
                                            _objAgency.UpdateLiteVersion(inquiryId, 1); // *** @FlagType = 1 means new registration *** This method also call in Store project  //
        ...
        private int InsertAgencyDetails(int? parentProfileID)
        {
            ...
            int InquiryID = _objAgency.AddAgencyUser("",txtAgencyname.Text, txtEmail.Text.Trim(), txtFirstName.Text.Trim(), "", date,
                remarks, 0, title, "", Vertical, "", parentProfileID, null, txtLastName.Text.Trim(), Country, "",
