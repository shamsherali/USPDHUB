...
namespace USPDHUB.OP.myyouthhubcom
{
    public partial class ForgotPassword : System.Web.UI.Page
    {
        ...
        protected void Sent_Password(object sender, ImageClickEventArgs e)
        {
            ...
            {
                lblmsg.Text = "<font face=arial color=red size=2>The username you have provided is incorrect, please try again.</font>";
            }
        }
