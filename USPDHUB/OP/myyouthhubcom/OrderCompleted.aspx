<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderCompleted.aspx.cs"
    Inherits="USPDHUB.OP.myyouthhubcom.OrderCompleted" %>
    ...
    <div id="wrapper">
        <div id="container">
            <div id="bannersecondary">
                <div id="bannerleft">
                    <img src="<%=Page.ResolveClientUrl("~/images/MYHOuterImages/my-youth-hub.png")%>" alt="MyYouthHub" border="0"></div>
                <!--bannerleft-->
                <div id="rightcol">
                    <div id="navigation">
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-family: Arial; font-size: 16px; font-weight: bold; color: Green;
                                                            ...
                                                            <span>NOTE: If you do not see the email delivered to your "inbox", please check your
                                                                junk mail folder for an email from info@inschoolhub.com before contacting customer
                                                                service. </span>
                                                        </td>
                                                    </tr>
                                                </table>
