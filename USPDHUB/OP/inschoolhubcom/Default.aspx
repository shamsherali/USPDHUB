<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="USPDHUB.OP.inschoolhubcom.Default" %>
    ...
    <div id="mainwrapper">
        <div id="container">
                        ...
                        <div align="right">
                            <p>
                                <a href="Javascript:void(0);" class="active">Home</a> | <a href="contactus.aspx">Contact
                                    Us</a> | <a href="AddTools.aspx">Features & Pricing</a> | <a href="aboutus.html">About
            ...
            <div id="homeleft">
                ...
                <p>
                    <div class="not-heading">
                        ...
                        <div class="not1">
                            <a href="https://www.microsoft.com/en-us/store/p/inschoolhub/9nblgggzj9dk" target="_blank">
            ...
            <div id="homecenter">
                ...
                true" href="<%=SecureRootPath %>/OP/inschoolhubcom/AddTools.aspx">
                            <img id="button_signup" src="<%=Page.ResolveClientUrl("~/images/ISHOuterImages/button-signup.jpg")%>"
                                alt="" name="button_signup" border="0"></a></div>
                </div>
            </div>
            <!--homecenter-->
            <div id="homeright">
                ...
                <div align="center" style="margin-top: 170px;">
                    <a class="myvideo" target="_blank" href="<%=Page.ResolveClientUrl("~/ISH/Default.html")%>">
                    </a>
                </div>
            </div>
            <!--homeright-->
