...
namespace USPDHUB.OP.uspdhubcom
{
    public partial class OrderCompleted : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (passwordchange == 0)
            {
                statustext = " Thank you for registering for USPDhub. An email has been sent to " + username + " with your user name and password.";
            }
            else
            {
                // *** Start Issue 899 ***
                ...
                {
                    Upgrade = "1";
                    statustext = " Thank you for upgrading your USPDhub. In order to complete your upgrade, please re-login.<br /><a href=" + RootPath + "/OP/" + Session["VerticalDomain"] + "/login.aspx ><img src='" + RootPath + "/secure/images/loginupgrade.gif' border='0'/></a> <br /><br />An email has been sent to " + username + " with your user name and password.";
                }
                else
                {
                    statustext = " Thank you for upgrading your USPDhub. An email has been sent to " + username + "&nbsp <br />with your user name and password.";
                }
                // *** End Issue 899 ***
            }
