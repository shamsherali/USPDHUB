<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactus.aspx.cs" Inherits="USPDHUB.OP.localhost.Contactus" %>
    ...
    <div id="menu">
        <div id="footer">
            ...
            <div class="footerlinks">
                <%--<a href="javascript:void(0);">Privacy Policy</a> |--%> <a href="<%=Page.ResolveClientUrl("~/OP/localhost/Terms.html")%>" target="_blank">
