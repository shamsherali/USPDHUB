<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgencyListing.aspx.cs"
    Inherits="USPDHUB.OP.localhost.AgencyListing" %>
                    ...
                    <div id="contact">
                        ...
                        <div class="formwrap">
                            ...
                            <div class="label">
                                &nbsp;&nbsp;&nbsp;Title</div>
                            <div class="txtfildwrap">
                                <asp:TextBox ID="txtTitle" TabIndex="4" class="txtfild" runat="server" MaxLength="200">
                                </asp:TextBox></div>
                            <div class="clear15">
                            </div>
                            <div class="label">
                            ...
                            <div class="txtfildwrap">
                                ...
                                <asp:TextBox ID="txtphonenumber" TabIndex="6" runat="server" MaxLength="14" class="txtfild">
                                </asp:TextBox>
                            ...
                            <div class="txtfildwrap">
                                <asp:TextBox ID="txtStartDate" runat="server" Width="90px" TabIndex="8" class="txtfild"></asp:TextBox>
                                <asp:CalendarExtender ID="calex" runat="server" Format="MM/dd/yyyy" TargetControlID="txtStartDate"
                                    CssClass="MyCalendar">
                                </asp:CalendarExtender>
                                &nbsp;
                                <asp:DropDownList ID="ddlHours" runat="server" TabIndex="9" Height="28px">
                                ...
                                <asp:DropDownList ID="ddlMints" runat="server" TabIndex="10" Height="28px">
                            ...
                            <div class="label">
                                &nbsp;&nbsp;&nbsp;Remarks</div>
                            <div class="txtfildwrap">
                                <asp:TextBox ID="txtRemarks" TabIndex="11" class="txtarea" runat="server" TextMode="MultiLine">
                                </asp:TextBox></div>
                            <div class="clear15">
                            </div>
                            <div class="label1">
                            ...
                            <div class="txtfildwrap">
                                <asp:TextBox ID="txtcaptcha" TabIndex="13" runat="server" class="txtfild">
                                </asp:TextBox>
                        ...
                        <div class="submit">
                            <asp:LinkButton ID="lnkSubmit" runat="server" Text="I Accept" OnClick="btnSubmit_Click"
                                OnClientClick="return Validate();" CausesValidation="true" TabIndex="14" ValidationGroup="A"><img src="<%=Page.ResolveClientUrl("~/images/Homepage/submit.png")%>" alt="" /></asp:LinkButton>
                            <br />
