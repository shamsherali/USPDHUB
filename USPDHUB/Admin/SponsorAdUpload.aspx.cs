...
{
    public partial class SponsorAdUpload : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (Request.QueryString["OrderNum"] == null && Request.QueryString["banid"] == null)
                        Response.Redirect(Page.ResolveClientUrl("~/Admin/SponsorAdsPreview.aspx?profileid=" + EncryptDecrypt.DESEncrypt(ProfileID.ToString())));
                    else
                    {
                        if (Request.QueryString["OrderNum"] != null)
                            hdnSlotNumber.Value = EncryptDecrypt.DESDecrypt(Request.QueryString["OrderNum"]);
                    ...
                    {
                        lblHeader.Text = Resources.LabelMessages.SponsorBannerAdLinkEdit;
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "Page_Load", ex.Message,
        ...
        private void DisableAllPanels()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "DisableAllPanels", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void EnablePanels(bool isUpload)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "EnablePanels", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void ShowBannerPreview()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "ShowBannerPreview", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnUpload_OnClick(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "btnUpload_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            finally
            {
        ...
        private void DeleteProfilePath(string bgPath)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "DeleteProfilePath", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void SaveToLocal()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "SaveToLocal", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void UploadBannerImage()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "UploadBannerImage()", ex.Message,
                    Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void MakeCropOrSubmit(int imgWidth, int imgHeight)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "MakeCropOrSubmit", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void OverlayWhiteImage(int width, int height)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "OverlayWhiteImage()", ex.Message,
                    Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void PngImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "PngImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void JpegImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "JpegImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void BmpImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "BmpImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void BindBannerImages(int Width, int Height, bool IsCrop)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "BindBannerImages()", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void ResizeThumbnail()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "ResizeThumbnail()", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnSubmit_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objBus.Insert_SponsorAds(Convert.ToInt32(hdnBannerId.Value), ProfileID, UserID, txtLinkUrl.Text.Trim(), Convert.ToInt32(hdnSlotNumber.Value), fileWith, true, UserID, false);
               Session["SaveMessage"] = "<font color='green'>" + Resources.LabelMessages.SponsorBGImageSubmitted.ToString() + "</font>";
                DeleteProfilePath(TempBannerImagesPath);
                Response.Redirect("~/Admin/SponsorAdsPreview.aspx?profileid=" + EncryptDecrypt.DESEncrypt(ProfileID.ToString()));
            }
            catch (Exception ex)
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "btnSubmit_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        ...
        protected void lnkUpadteLink_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Convert.ToInt32(hdnBannerId.Value) > 0)
                {
                    ...
                    Session["SaveMessage"] = "<font color='green'>" + Resources.LabelMessages.SponsorBannerAdLinkSaved + "</font>";
                    Response.Redirect("~/Admin/SponsorAdsPreview.aspx?profileid=" + EncryptDecrypt.DESEncrypt(ProfileID.ToString()));
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "lnkUpadteLink_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void ResizeAllBannerAds(string bgPath, string fileWith)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "ResizeAllBGImages()", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            #endregion
        }
        protected void lnkTryAgain_OnClick(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "lnkTryAgain_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnCrop_OnClick(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "btnCrop_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void lnkResizeImage_OnClick(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "lnkResizeImage_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        {
            Response.Redirect("~/Admin/SponsorAdsPreview.aspx?profileid=" + EncryptDecrypt.DESEncrypt(ProfileID.ToString()) + "&userid="+ EncryptDecrypt.DESEncrypt(UserID.ToString()));
        ...
        protected void lnkCancel_OnClick(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdUpload.aspx.cs", "lnkCancel_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
