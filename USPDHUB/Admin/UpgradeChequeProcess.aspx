<%@ Page Title="" Language="C#" MasterPageFile="~/AdminHome.master" AutoEventWireup="true"
    CodeBehind="UpgradeChequeProcess.aspx.cs" Inherits="USPDHUB.Admin.UpgradeChequeProcess" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
                    ...
                    <div class="divwrap">
                        ...
                        <div class="csdivwrap">
                            ...
                            <asp:Panel runat="server" ID="pnlCredit" Visible="false">
                                ...
                                <div class="payalign">
                                    <strong>$
                                        <asp:Label ID="lblCredit" runat="server" Text="0.00"></asp:Label></strong></div>
                                <div class="clear10">
                                </div>
                            </asp:Panel>
                            <div class="labeladm">
                            ...
                            <div>
                                <asp:TextBox ID="txtzip" runat="server" MaxLength="5" CssClass="textfieldadm2" ClientIDMode="Static" onkeypress="return isNumber(event)"></asp:TextBox>
                                &nbsp;
            ...
            <div class="submitadm">
                ...
                <asp:LinkButton ID="lnkMainScreen" runat="server" CausesValidation="false" OnClick="lnkback_OnClick"><img src="../images/Admin/back.png" alt="" /></asp:LinkButton>
                ...
                <asp:Panel ID="pnlcreateshortcut" runat="server" Style="display: none" Width="600px">
                    <table cellpadding="0" cellspacing="0" class="reveal-modal">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <iframe src="../ProfileIframes/AddNotes.aspx?ID=<%=PID%>" frameborder="0" scrolling="no"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="height: 500px; position: relative; width: 960px; padding-right: 30px; overflow-x:auto;">
