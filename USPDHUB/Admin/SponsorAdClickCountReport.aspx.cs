...
{
    public partial class SponsorAdClickCountReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdClickCountReport.aspx.cs", "Page_Load", ex.Message,
        ...
        private int BindChart()
        {
            ...
            try
            {
                ...
                lblTitle.Text = "<b>Sponsor Ad Click Count between " + txtStartDate.Text + " and " + txtEndDate.Text + " - " + count.ToString() + "</b";
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdClickCountReport.aspx.cs", "BindChart", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        private void LoadChartData(DataTable initialDataSource)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdClickCountReport.aspx.cs", "LoadChartData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnchart_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdClickCountReport.aspx.cs", "btnchart_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        {
            Response.Redirect("~/Admin/SponsorAdsPreview.aspx?profileid=" + EncryptDecrypt.DESEncrypt(ProfileID.ToString()) + "&userid="+ EncryptDecrypt.DESEncrypt(C_UserID.ToString()));
        }
        ...
        protected void btnPrint_OnClick(object sender, EventArgs e)
        {
            try
            {
                string url = RootPath + "/PrintBannerAdClickReport.aspx?sDate=" + EncryptDecrypt.DESEncrypt(txtStartDate.Text) + "&eDate=" + EncryptDecrypt.DESEncrypt(txtEndDate.Text) + "&PID=" + EncryptDecrypt.DESEncrypt(ProfileID.ToString()) + "&isSponserAd=" + true;
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SponsorAdClickCountReport.aspx.cs", "btnPrint_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
