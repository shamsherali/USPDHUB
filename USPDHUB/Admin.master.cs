...
public partial class Admin_Master : System.Web.UI.MasterPage
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "OnInit", ex.Message, Convert.ToString(ex.StackTrace),
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
                ...
                if (Session["UserID"] != null)
                {
                    ...
                    if (Session["ProfileID"] != null)
                    {
                        if (Session["ProfileID"].ToString() != "")
                        {
                            ...
                            {
                                //if (DomainName.ToLower() != "inschoolalertcom")
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "Page_Load", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    }
    ...
    private void CheckDashboardFlow()
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "CheckDashboardFlow", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    }
    private void GetMenu()
    {
                    ...
                    if (dr["NodeName"].ToString().Contains("Renew"))
                    {
                        if (Session["Renewal"] != null && Session["Renewal"].ToString() == "1")
                           // categoryMessage.ChildItems.Add(categoryItem);
                            categoryItem.NavigateUrl = System.Configuration.ConfigurationManager.AppSettings["ShoppingCartRootPath"] + "/RedirectStore.aspx?MID=" + EncryptDecrypt.DESEncrypt(UserID.ToString()) + "&MPID=" + EncryptDecrypt.DESEncrypt(ProfileID.ToString()) + "&CID=" + EncryptDecrypt.DESEncrypt(UserID.ToString()) + "&VC=" + EncryptDecrypt.DESEncrypt(DomainName.ToString()) + "&type=renewal";
                                ...
                                if (Dtpermissions.Rows.Count > 0) //Roles & Permissions...
                                {
                                    if (permissionName != "")
                                    {
                                        if (dtMenulinks.Rows[i]["NodeName"].ToString() == "App Buttons")
                                            chkPermission = cmbobj.returnUserPermission(Convert.ToInt32(Session["C_USER_ID"]), 0, "ManageButtons");
                                        else if (dtMenulinks.Rows[i]["PermissionName"].ToString() == "Mobile App")
                                            chkPermission = cmbobj.returnUserPermission(Convert.ToInt32(Session["C_USER_ID"]), 0, "AppSettings");
                                        else if (dtMenulinks.Rows[i]["PermissionName"].ToString() == "Contacts")
                                            chkPermission = cmbobj.returnUserPermission(Convert.ToInt32(Session["C_USER_ID"]), 0, "Contacts");
                                        else if (dtMenulinks.Rows[i]["PermissionName"].ToString() == "SubAffiliates")
                                            chkPermission = cmbobj.returnUserPermission(Convert.ToInt32(Session["C_USER_ID"]), 0, "AppSettings");
                                        else if (dtMenulinks.Rows[i]["PermissionName"].ToString() != "")
                                            chkPermission = cmbobj.returnUserPermission(Convert.ToInt32(Session["C_USER_ID"]), 0, dtMenulinks.Rows[i]["PermissionName"].ToString());
                                        else
                                            chkPermission = "P";
                                        if (chkPermission == "P")
                                            categoryItem.NavigateUrl = navigationUrl;
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "GetMenu", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    }
    ...
    private void Gethelpmenudata()
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "Gethelpmenudata", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    }
    ...
    protected void btnsend_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "btnsend_Click", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    ...
    protected void Sendmail(int value)
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "Sendmail", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    ...
    protected void lnkHelpDownload_OnClick(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "lnkHelpDownload_OnClick", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    }
    protected void btnHelpSearch_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "btnHelpSearch_Click", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    }
    protected void btnHelpClear_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "btnHelpClear_Click", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    ...
    protected void imgBtnHidePopup_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
            /*** Error Log ***/
            objInBuiltData.ErrorHandling("ERROR", "Admin.master.cs", "imgBtnHidePopup_Click", ex.Message, Convert.ToString(ex.StackTrace),
                Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        }
    }
}