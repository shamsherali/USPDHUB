...
namespace USPDHUB
{
    public partial class PrintPSCMessageChart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                catch (Exception ex)
                {
                    InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
                    /*** Error Log ***/
                    objInBuiltData.ErrorHandling("ERROR", "PrintPSCMessageChart.aspx.cs", "Page_Load", ex.Message, Convert.ToString(ex.StackTrace),
        ...
        private void BindChart(DataTable dtGraph)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "PrintPSCMessageChart.aspx.cs", "BindChart", ex.Message,
