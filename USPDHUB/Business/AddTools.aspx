<%@ Page Language="C#" AutoEventWireup="true" Inherits="Business_AddTools" EnableViewState="True"
    CodeBehind="AddTools.aspx.cs" %>
                ...
                <div class="navwrap">
                    <div class="nav">
                        <ul>
                            ...
                            <li><a href="<%=outerUrl %>/login.aspx">Login</a></li>
                        </ul>
                    </div>
                </div>
                <div class="clear">
    ...
    <div id="contentwrap">
        <div id="content">
            <div class="pagehead">
                Pricing</div>
            <div align="center">
                <img src="../images/OuterImages/shadow.png" /></div>
            ...
            <div id="pricingcol2">
                <br/>
                <div class="phead">
                    Two way communication<br /> for your community
                    <br />
                    <br />
                    <br />
                    Available for</div>
                <div style="width: 300px; margin-left: 50px;">
                    <div class="not1">
                        <img src="../images/OuterImages/android_icon.png" /><br />
                        <span>Android</span></div>
                    <div class="not1">
                        <img src="../images/OuterImages/apple_icon.png" /><br />
                        <span>iPhone</span></div>
                    <div class="not1">
                        <img src="../images/OuterImages/windows_icon.png" /><br />
                ...
                <div class="signup1">
                    <asp:ImageButton ID="btnContinuePremiumPlus" runat="server" ImageUrl="~/images/OuterImages/signup.png"
                        ...
                        <div class="brandapp">
                    If you would like a <span class="brandapp_red">Branded app</span> in the App store
                    for your Agency, call us at <br /> 800-281-0263 or click <span><a href="<%= outerUrl %>/contactus.aspx"
                        class="brandapp_contact">Contact Us</a></span></div>
            </div>
            <div class="clear40">                
            </div>
        </div>
