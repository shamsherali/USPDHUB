<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="CMWanted.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.CMWanted" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
                <div id="wrapper">
                    <div class="headernav">
                        <%--<%=BulletinName %>--%>Wanted<asp:TextBox ID="txt" runat="server" Width="0" BorderStyle="none"
                    ...
                    <div class="contentwrap">
                        ...
                        <div class="form_wrapper">
                                    ...
                                    <table width="85%" cellpadding="0" cellspacing="0" id='tblExTime'>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender5" TargetControlID="txtExHours"
                                                ...
                                                <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender6" TargetControlID="txtExMinutes"
                            ...
                            <div class="fields_wrap ">
                                ...
                                <div class="right_fields">
                                    <asp:CheckBox runat="server" ID="chkLocated" Text=" Located" />
                                </div>
                            </div>
                            <div class="clear">
                            </div>
