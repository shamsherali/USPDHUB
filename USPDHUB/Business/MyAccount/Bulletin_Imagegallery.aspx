<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bulletin_Imagegallery.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.Bulletin_Imagegallery" ValidateRequest="false" %>
...
<body class="yui-skin-sam" style="background-color: #F8F6F6;">
                    ...
                    <td valign="top" style="border-right: 1px solid #BED1F4;">
                        <table border="0" cellpadding="0" cellspacing="0" style="line-height: 18px; padding: 10px;">
                            ...
                            <tr><td style="display:none;">
                              <asp:Button ID="btnSystemImages" runat="server" Text="System Images"  OnClick="btnSystemImages_Click"/>
                            </td></tr>
                        </table>
                    </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;
                            ...
                            <tr>
                                ...
                                <td rowspan="2" style="padding-left: 10px;">
                                    <asp:ImageButton ID="ImgUserImg" runat="server" ImageUrl='<%# Eval("Image_Thumb","~/Upload/Common/" + ProfileID + "/{0}") %>'
                            ...
                            <tr>
                                ...
                                <td style="line-height: 18px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                    ...
                                    <asp:Label ID="lblimgdim" runat="server" Text='<%#Eval("Image_Name") %>'></asp:Label><br />
    ...
    <script type="text/javascript" language="javascript">
        ...
        if (document.getElementById('hdnClose').value != "") {debugger;
            ...
            ImgDivID1 = ImgDivID;
            document.getElementById('<%=CheckWidth.ClientID %>').value = parent.document.getElementById(ImgDivID1).offsetWidth - 32;
            ...
            if (document.getElementById('<%=hdnChangeResize.ClientID %>').value != '') {
                if (document.getElementById('<%=txtimagewidth1.ClientID%>').value != document.getElementById('<%=txtimagewidth2.ClientID%>').innerHTML || document.getElementById('<%=txtimageheight1.ClientID%>').value != document.getElementById('<%=txtimageheight2.ClientID%>').innerHTML) {
                    if (document.getElementById('<%=txtimagewidth2.ClientID%>').innerHTML > parent.document.getElementById(ImgDivID1).offsetWidth) {
                        document.getElementById('<%=txtimagewidth2.ClientID%>').innerHTML = parent.document.getElementById(ImgDivID1).offsetWidth - 22;
                        document.getElementById('<%=hdnimgwidth2.ClientID %>').value = parent.document.getElementById(ImgDivID1).offsetWidth - 22;
                    }
                }
            }
        }
        ...
        if (document.getElementById('<%=hdnOrgDivDim.ClientID %>').value != "") {
            ...
            if (ImgDivID1 != "") {
                ...
                document.getElementById("imgdotteddiv").style.width = parent.document.getElementById(ImgDivID1).offsetWidth - 28 + "px";
            }
