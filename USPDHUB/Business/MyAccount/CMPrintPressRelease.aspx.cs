...
{
    public partial class CMPrintPressRelease : BaseWeb
    {
        ...
        private string BuildHTML()
        {
            try
            {
                ...
                if (txtSummary.Text.Trim() != "")
                {
                    ...
                    strPrintHtml.Append("<div style=\"float: left; width: 600px; margin-right: 10px; margin-bottom: 10px; text-align: justify;\"><span style=\"font-weight: bold; float: left; width: 115px;\">Summary:</span>");
        ...
        private string BuildHeader()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPrintPressRelease.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
