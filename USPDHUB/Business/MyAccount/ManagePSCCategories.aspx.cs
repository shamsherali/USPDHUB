...
{
    public partial class ManagePSCCategories : System.Web.UI.Page
    {
                ...
                if (!IsPostBack)
                {
                    if (Session["C_USER_ID"] != null && Session["C_USER_ID"].ToString() != "")
                    {
                        ...
                        for (int i = 0; i < dtpermissions.Rows.Count; i++)
                        {
                            ...
                            {
                                //IsCategory checking
                                if (Convert.ToBoolean(dtpermissions.Rows[i]["IsReviewer"]))
                                    hdnCategoryPermission.Value = "P";
                                break;
                            }
                        }

                        if (string.IsNullOrEmpty(hdnCategoryPermission.Value))
                        {
        ...
        private void BindCategories()
        {
            ...
            {
                hdnCommandArg.Value = "";
                dtCategories = objPSCBLL.GetPrivateSmartConnectCategories(CustomModuleId, DomainName, ProfileID);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManagePSCCategories.aspx.cs", "BindCategories()", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void GrdCategories_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManagePSCCategories.aspx.cs", "GrdCategories_PageIndexChanging", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void GrdCategories_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManagePSCCategories.aspx.cs", "GrdCategories_Sorting", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void lnkdelete_Click(object sender, EventArgs e)
        {
            try
            {
                objPSCBLL.DeletePrivateSmartConnectCategory(Convert.ToInt32(hdnCommandArg.Value), UserID, ProfileID);
                hdnCommandArg.Value = "";
                BindCategories();
                lblmess.Text = "<font size='3'>Your category has been deleted successfully.</font>";
                objBus.Insert_SilentPushMessages(ProfileID, DateTime.Now, false, 0, "PrivateSmartConnectCategory", "Delete");
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManagePSCCategories.aspx.cs", "lnkdelete_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnSumbit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = objPSCBLL.Insert_Update_PrivateSmartConnectCategory(categoryID, txtCategoryName.Text.Trim(), txtDescription.Text.Trim(), CustomModuleId, ProfileID, UserID, SmartConnectCategoryType.User.ToString());
                ...
                else
                {
                    if (categoryID == 0)
                    {
                        ...
                        objBus.Insert_SilentPushMessages(ProfileID, DateTime.Now, false, 0, "PrivateSmartConnectCategory", "Create");
                    }
                    else
                    {
                        lblmess.Text = "Category has been updated successfully.";
                        objBus.Insert_SilentPushMessages(ProfileID, DateTime.Now, false, 0, "PrivateSmartConnectCategory", "Update");
                    }
                    BindCategories();
                }
            }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManagePSCCategories.aspx.cs", "btnSumbit_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        private void GetCategoryDetails()
        {
            try
            {
                ...
                mpeWebLink.Show();
                var dtDetails = objPSCBLL.GetPrivateSmartConnectCategoryDetailsByID(Convert.ToInt32(hdnCommandArg.Value));
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManagePSCCategories.aspx.cs", "GetCategoryDetails", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
