...
{
    public partial class MissingChild : BaseWeb
    {
        public int UserID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "MissingChild.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
        ...
        private void LoadDefaultData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "MissingChild.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "MissingChild.aspx.cs", "LoadDefaultData", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private void LoadFormData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "MissingChild.aspx.cs", "LoadFormData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "MissingChild.aspx.cs", "LoadFormData", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "MissingChild.aspx.cs", "btnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "MissingChild.aspx.cs", "lnkPreview_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "MissingChild.aspx.cs", "lnkPreview_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private string BuildHTML()
        {
            ...
            try
            {
                objInBuiltData.ErrorHandling("LOG", "MissingChild.aspx.cs", "BuildHTML", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                strPrintHtml.Append("<h1 style=\"font-size: 14px; text-align: center; color: #444444; text-decoration: underline; font-weight: bold;\">Missing</h1>");
                ...
                strHtml.Append("<div style=\"text-align: center; font-size: 26px; width:300px; line-height: 28px; border-bottom: 1px dashed #d1d1d1; padding-bottom:5px; font-weight: normal; color: #f15b29;\">Missing</div>");
                ...
                {
                    strHtml.Append("<tr>");
                    strHtml.Append("<td colspan='2' style='padding: 8px 4px 0px 4px; font-weight: bold;'>Agency Name for Contact :</td></tr>");
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 5px; line-height:16px;\">Agency Name for Contact :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 5px;\">" + txtBriefDesc.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + (txtPDDept.Text.Trim() != "" ? "<br/>" : "") + txtPDPhone.Text.Trim() + "</div>");
                }
                if (txtKidsDesc.Text.Trim() != "" || txtKidsPhone.Text.Trim() != "")
                {
                    strHtml.Append("<tr>");
                    strHtml.Append("<td colspan='2' style='padding: 8px 4px 0px 4px; font-weight: bold;'>Organization :</td></tr>");
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 5px; line-height:16px;\">Organization :</div>");
                ...
                if (txtKidsCase.Text.Trim() != "")
                {
                    ...
                    strHtml.Append("<td style='padding: 4px; font-weight: bold; width: 112px;'>Case # :</td>");
                    strHtml.Append("<td style='color: #353535;'>" + txtKidsCase.Text.Trim() + "</td></tr></table>");

                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px;\">Case # :</div>");
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "MissingChild.aspx.cs", "BuildHTML", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
