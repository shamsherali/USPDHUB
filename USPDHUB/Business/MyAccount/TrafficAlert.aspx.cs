...
{
    public partial class TrafficAlert : System.Web.UI.Page
    {
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "GetAutoShareRecordStatus", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
