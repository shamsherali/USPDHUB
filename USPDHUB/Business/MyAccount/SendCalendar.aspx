<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeBehind="SendCalendar.aspx.cs" Inherits="USPDHUB.Business.MyAccount.SendCalendar" %>
...
//            var calAddOnId = $get('<%=hdnCalAddOnId.ClientID %>').value;
//            var daylimit = $get('<%=hdnlimit.ClientID %>').value;
//            PageMethods.ValidateSendrSchedule(id.value, userid, calAddOnId, daylimit, OnSuccess, OnFail);
...
//                }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <div style="display: block; margin-left: auto; margin-right: auto; width: 250px;">
                                                                                                        <asp:CheckBox runat="server" ID="chkStoreLinks" Text="  App Store Links" Visible="false"
                                                                                                            Style="padding-right: 30px;"></asp:CheckBox>
            ...
            <asp:HiddenField ID="hdnCalAddOnId" runat="server" />
