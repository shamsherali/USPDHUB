...
{
    public partial class DesktopLogin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "DesktopLogin.aspx.cs", "Page_Load", Convert.ToString(ex.Message),
        ...
        private string FormPosting()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "DesktopLogin.aspx.cs", "FormPosting", Convert.ToString(ex.Message),
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        private void CallfromClientSide()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "DesktopLogin.aspx.cs", "CallfromClientSide", Convert.ToString(ex.Message),
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private void GetFreeUserDetails()
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "DesktopLogin.aspx.cs", "GetFreeUserDetails", Convert.ToString(ex.Message),
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private int GetDetails(DataTable dtpermissions)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "DesktopLogin.aspx.cs", "GetDetails", Convert.ToString(ex.Message),
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return returnval;
        }
