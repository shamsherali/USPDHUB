<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeBehind="SendBulletins.aspx.cs" Inherits="USPDHUB.Business.MyAccount.SendBulletins" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="height: 32px; font-size: 18px; color: #EC2027; margin-bottom: 5px; margin-top: 5px;
                                            ...
                                            Email Content <a id="Anchor" href="javascript:ModalHelpPopup('Email Content',140,'');">
                                                ...
                                                <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="padding-top: 20px;">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtMailSubject" Text="Test Content Campaign" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
