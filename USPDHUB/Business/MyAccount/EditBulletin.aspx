...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PopupSubmiteTxt() {
            ...
            if (htmlContent == "") {
                htmlContent = "<span style='font-weight: normal; font-style: normal; text-decoration: none; color: black; font-size: 14px; font-family: " + document.getElementById('<%=hdnUserFont.ClientID %>').value + ";'>";
            }
        ...
        function OnClientButtonClicking(toolbar, args) {
            ...
            if (Mystring.indexOf('span') <= 0) {
                var innerText = '';
                Mystring = "<span style='font-weight: normal; font-style: normal; text-decoration: none; color: black; font-size: 14px; font-family: " + document.getElementById('<%=hdnUserFont.ClientID %>').value + ";'>" + innerText;
            }
                                            ...
                                            <asp:UpdateProgress ID="UpdateProgress8" runat="server" DisplayAfter="3">
                                                <ProgressTemplate>
                                                    <img src="../../images/popup_ajax-loader.gif" border="0" /><b><font color="green">Your
                                                        data saving is in progress....</font></b>
                                                </ProgressTemplate>
                                            </asp:UpdateProgress>
                                        </td>
                                    </tr>
