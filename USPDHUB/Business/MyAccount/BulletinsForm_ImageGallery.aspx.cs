    ...
    public partial class BulletinsForm_ImageGallery : BaseWeb
    {
        ...
        protected void lnkSearch_Click(object sender, EventArgs e)
        {
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkSearch_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkSearch_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkSearch_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
