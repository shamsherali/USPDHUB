<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeBehind="AddOnsReports.aspx.cs" Inherits="USPDHUB.Business.MyAccount.AddOnsReports"
                                                ...
                                                <tbody>
                                                        ...
                                                        <td style="padding-bottom: 20px;">
                                                            <asp:Panel ID="pnlgridUpdates" runat="server" ScrollBars="Auto" Width="100%" Height="400px">
                                                                <asp:GridView ID="gridUpdates" runat="server" ShowFooter="false" AutoGenerateColumns="false"
                                                                    ...
                                                                    FooterStyle-Height="60" DataKeyNames="Custom_ID">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Title" SortExpression="Bulletin_Title">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdateName" runat="server" Text='<%#Bind("Bulletin_Title")%>'
                                                                                    CommandArgument='<%# Bind("Custom_ID") %>' OnClick="lnkupdateName_Click" Class="SortHeader"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Sent">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblSent" runat="server" Text='<%# GetBulletinsCounts(Eval("Custom_ID"),1) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lblhistroy" runat="server" Text='<%#GetBulletinsCounts(Eval("Custom_ID"),1) %>'
                                                                                    OnClick="lblhistroy_Click" CommandArgument='<%#Eval("Custom_ID") %>'></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass="align-center" />
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Sent1" Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblSent2" runat="server" Text='<%# GetBulletinsCounts(Eval("Custom_ID"),1) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Opened">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOpened" runat="server" Text='<%# GetBulletinsCounts(Eval("Custom_ID"),2) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lnkopen" runat="server" CommandArgument='<%# Bind("Custom_ID") %>'
                                                                                    Text='<%# GetBulletinsCounts(Eval("Custom_ID"),2) %>' OnClick="lnkopen_Click"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Opened1" Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOpened2" runat="server" Text='<%# GetBulletinsCounts(Eval("Custom_ID"),2) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Opt Out">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOptOut" runat="server" Text='<%# GetBulletinsCounts(Eval("Custom_ID"),3) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lnkoptout" runat="server" CommandArgument='<%# Bind("Custom_ID") %>'
                                                                                    Text='<%#GetBulletinsCounts(Eval("Custom_ID"),3) %>' OnClick="lnkoptout_Click"
                                                                                    CausesValidation="false"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass="align-center" />
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Opt Out1" Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOptOut2" runat="server" Text='<%# GetBulletinsCounts(Eval("Custom_ID"),3) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Bounced Back">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblBounced" runat="server" Text='<%#GetBulletinsCounts(Eval("Custom_ID"),4) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lnkBounced" runat="server" Text='<%#GetBulletinsCounts(Eval("Custom_ID"),4) %>'
                                                                                    CommandArgument='<%# Bind("Custom_ID") %>' OnClick="lnkBounced_Click" CausesValidation="false"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass="align-center" />
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="TotalScheduleCount" runat="server" Text='<%#GetSheduledCount(Eval("Custom_ID")) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                                    ...
                                                    <tr style="height: 40px; background-color: #D2E5FA;">
                                                        <td align="center">
                                                            ...
                                                            <asp:Button ID="btnConsolidatedeport" Text="Consolidated Report" runat="server" OnClick="btnConsolidatedeport_Click" OnClientClick="return ValidateRadioButton('2');"/>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Panel Style="display: none; min-height: 150px; max-height: 600px;" ID="pnlmailopen"
                                runat="server" Width="920" ScrollBars="Auto">
