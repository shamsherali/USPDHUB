<%@ WebHandler Language="C#" Class="UploadAppGallery" %>
...
public class UploadAppGallery : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            if (ParentType == "1")
                RootFolder = HttpContext.Current.Server.MapPath("~/Upload/AppGallery/") + PID;
            else if (ParentType == "2")
                RootFolder = HttpContext.Current.Server.MapPath("~/Upload/AppGallery/") + PID + "\\" + childFolderName;
