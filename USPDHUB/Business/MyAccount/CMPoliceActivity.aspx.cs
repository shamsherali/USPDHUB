...
{
    public partial class CMPoliceActivity : BaseWeb
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "Page_Load", ex.Message,
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void LoadDefaultData()
        {
            try
            {
                ...
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "LoadDefaultData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void LoadFormData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "LoadFormData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "LoadFormData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "btnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "btnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "lnkPreview_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                if (!string.IsNullOrEmpty(txtFromDate.Text))
                {
                    txtFromHours.Enabled = true;
                    txtFromMinutes.Enabled = true;
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "lnkPreview_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private string BuildHTML()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "BuildHTML", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                strPrintHtml.Append("<h1 style=\"font-size: 14px; text-align: center; color: #444444; text-decoration: underline; font-weight: bold;\">Police Activity</h1>");
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "BuildHTML", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        ...
        private string BuildHeader()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
            return strHeader;
        ...
        protected bool ValidationTime(string starttime1, string endtime1)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMPoliceActivity.aspx.cs", "ValidationTime", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMPoliceActivity.aspx.cs", "ValidationTime", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return false;
            }
        }
