...
{
    public partial class CrisisCallLog : BaseWeb
    {
        public int UserID = 0;
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "BtnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private void LoadDefaultData()
        {
            ...
            */
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "LoadDefaultData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        public static string GetCallertypeAgency()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "GetCallertypeAgency", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return Agencystring;
        }
        ...
        public static string GetCallerTypeRegions()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "GetCallerTypeRegions", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return returnString;
        }
        ...
        public static string GetCallerRequestRegions()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "GetCallerRequestRegions", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return returnString;
        }
        ...
        public static string GetOfficers(string regionName)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "GetOfficers", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return returnString;
        ...
        public static IList<string> GetBulletinAutoCompleteData(string bulletinName)
        {
            ...
            catch (Exception ex)
            {
                ...
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "GetBulletinAutoCompleteData", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return result;
            }
            finally
        ...
        public static string ReplaceShortURltoHmlString(string htmlString)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrisisCallLog.aspx.cs", "ReplaceShortURltoHmlString", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return htmlString;
        }
