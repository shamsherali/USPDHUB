<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeBehind="SheriffsMessageForm.aspx.cs" Inherits="USPDHUB.Business.MyAccount.SheriffsMessageForm"
                    ...
                    <div class="contentwrap">
                        <div class="largetxt">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtChiefName"
                                ...
                                ErrorMessage="Sheriff Name is mandatory." style="font-size:14px;">*</asp:RequiredFieldValidator>&nbsp;<span style="font-size: 12px;
                                    color: #000;">(Max Characters 25)</span>
                            <br />
