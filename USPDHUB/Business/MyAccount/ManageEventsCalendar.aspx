<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PaidTools.master"
    Inherits="Business_MyAccount_ManageEventsCalendar" CodeBehind="~/Business/MyAccount/ManageEventsCalendar.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fnShowMessage(EventId) {
            ...
            if (confrm == true) {
                var url = "../../Business/MyAccount/EventsCalendar.aspx?EventId=" + EventId;
                window.location = url;
            }
        }
        ...
        function GetConfirm(text, controlID) {
            ...
            if (ValidateEvent(controlID)) {
                if (text.toLowerCase() == 'publish') {
                    ...
                    return confirm('Are you sure you want to make the selected event(s) ' + text + '?');
            }
            else {
                return false;
            }
        ...
        function ValidateEvent(ControlId) {
            ...
            if (document.getElementById("<%=hdnarchive.ClientID%>").value != "Archive") {
                ...
                if (selectedcount == 0) {
                    ...
                    if (id.indexOf("lnkdelete") != -1)
                        return confirm('Are you sure you want to delete selected event(s)?');
                    ...
                    if (id.indexOf("lnkdelete") != -1)
                        ...
                        if (document.getElementById("<%=hdnCommandArg.ClientID%>").value == '') {
                            ...
                            if (id.indexOf("lnkChangeCurrent") != -1)
                                return confirm('Are you sure you want to reinstate this event?');
                            else
                                return true;
                        }
                    }
                ...
                <tr>
                    <td class="valign-top">
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr>
                                <td class="navy20" valign="top" align="center">
                                    <div id="boxes">
                                                ...
                                                <tr>
                                                    <td align="right">
                                                        <span class="cursor"><a class="navigate">
                                                            <img src="../../images/popup_close.gif" border="0" /></a></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="GridDock" id="dvGridWidth" style="border: 1px solid #428ad7;">
                                                                                <asp:GridView ID="GrdEvents" runat="server" PageSize="5" OnPageIndexChanging="GrdEvents_PageIndexChanging"
                                                                                    ForeColor="Black" EmptyDataText="" OnRowDataBound="GrdEvents_RowDataBound" DataKeyNames="EventId,Expiration_Date"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Image">
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lblupdatethub" Text='<%#Eval("ParentEventID")%>' runat="server" />
                                                                                            </ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Select">
                                                                                            <ItemTemplate>
                                                                                                <%--<asp:RadioButton ID="rbUpdate" runat="server" AutoPostBack="true" OnCheckedChanged="rbUpdate_CheckedChanged"
                                                                                                    onclick='<%# string.Format("javascript:RadioCheck(this, \"{0}\",\"{1}\")", "", Eval("EventId")) %>' />--%>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Title" SortExpression="Name">
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton ID="lnkEventName" OnClick="lnkUpdateName_Click" Text='<%#Eval("EventTitle") %>'
                                                                                                    runat="server" CommandArgument='<%#Eval("EventId")%>'></asp:LinkButton>
                                                                                            </ItemTemplate>
                                                                                            <ItemStyle Width="165px"></ItemStyle>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Email Status" SortExpression="Status">
                                                                                            <ItemTemplate>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="border: 0px;" valign="top" nowrap="nowrap">
                                                                                                            ...
                                                                                                            <asp:LinkButton Style="font-weight: bold; color: blue; font-family: verdana; color: #0b689d;"
                                                                                                                ...
                                                                                                                Text="Campaign report" CommandArgument='<%# Bind("EventId") %>'></asp:LinkButton>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Status" SortExpression="IsPublic">
                                                                                            <ItemTemplate>
                                                                                                ...
                                                                                                <%--<asp:LinkButton ID="lnkStatus" runat="server" CausesValidation="false" CommandArgument='<%# Bind("EventId") %>'
                                                                                            ...
                                                                                            <ItemStyle HorizontalAlign="Center" Width="115px"></ItemStyle>
                                                                                        </asp:TemplateField>
                                                        ...
                                                        <td class="share">
                                                            <div>
                                                                <table border="0" width="95%" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a class="cursor" onclick="alert('Please select an event.');">
                                                            ...
                                                            <div>
                                                                <table border="0" width="95%" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a class="cursor" onclick="alert('Please select an event.');" style="display: none;">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <%--<asp:Panel ID="PnlGoogleEvents" runat="server" Style="display: none;" DefaultButton="BtnLoginGoogleEvents">
                                            <table class="modalpopup" cellspacing="0" cellpadding="0" width="500px" border="0">
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:LinkButton ID="lnkClosePopup" runat="server" CausesValidation="false"><img src="../../Images/popup_close.gif" alt="" /></asp:LinkButton>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" colspan="2">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <span style="color: Green; font-weight: bold;">* Please enter your Gmail credentials.</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right">
                                                                ...
                                                                <td align="left">
                                                                    ...
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtUname"
                                                                        Display="Dynamic" ErrorMessage="Invalid Email Format." SetFocusOnError="True"
                                                                        ValidationExpression="\w+([-+.]\w+)*@gmail.com" ValidationGroup="g">*</asp:RegularExpressionValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" align="center">
                                                                    <asp:Button ID="BtnLoginGoogleEvents" ValidationGroup="g" runat="server" Text="Sync Events"
                                                                        OnClick="BtnLoginGoogleEvents_Click" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <asp:Label ID="lblpopuperrormsg" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
    ...
    <script type="text/javascript">
        function CallJquery() {
            ...
            document.getElementById('DIDIFrm').innerHTML = "<iframe src=\"https://player.vimeo.com/video/36114442\" width=\"500\" height=\"340\" frameborder=\"0\" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>";
        ...
        if (browserName != "Microsoft Internet Explorer") {
            $(document).ready(function () {
                document.getElementById('DIDIFrm').innerHTML = "";
                document.getElementById('DIDIFrm').innerHTML = "<iframe src=\"https://player.vimeo.com/video/36114442\" width=\"500\" height=\"375\" frameborder=\"0\" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>";
                $("a.modal1").click(function (e) {
                    e.preventDefault();
                    //Get the A tag
                    var id = $(this).attr('href');
