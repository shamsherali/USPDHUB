<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagePSCInvitation.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.ManagePSCInvitation" ValidateRequest="false"
    ...
    <script type="text/javascript">
        ...
        prm.add_endRequest(function () {
            ...
            $('#help1').CreateBubblePopup({
                ...
                innerHtml: '<p style="line-height:18px; text-align:left; font-size:14px;">Disabling a device allows the app owner to restrict </br> that device from displaying the private smartconnect button </br>temporarily. This is especially helpful if the app user</br> reports the device misplaced or lost. To reinstate it,</br> simply enable it.</p>',
                innerHtmlStyle: {
                    color: '#FFFFFF',
                    'text-align': 'center'
