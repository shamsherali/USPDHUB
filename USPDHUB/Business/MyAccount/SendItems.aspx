<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="SendItems.aspx.cs" Inherits="USPDHUB.Business.MyAccount.SendItems" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="height: 32px; font-size: 18px; color: #EC2027; margin-bottom: 5px; margin-top: 5px;
                                            ...
                                            Email Bulletin <a id="Anchor" href="javascript:ModalHelpPopup('Email Bulletin',140,'');">
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-top: 5px; padding-left: 170px;" align="left">
                                                                                        ...
                                                                                        <asp:LinkButton ID="lnktestbusinessUpdate" runat="server" OnClick="lnktestBulletin_Click"
                                                ...
                                                <asp:Panel ID="pnldiscontact" runat="server" Width="100%">
                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <iframe id="frmcontacts" runat="server" src="ContactManagement.aspx" 
                                                ...
                                                <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="padding-top: 20px;">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtMailSubject" Text="Test Bulletin Campaign" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr style="padding-top: 20px; padding-bottom: 10px;">
                                                            ...
                                                            <td>
                                                                <asp:Button ID="btntestsend" runat="server" OnClick="btntestsend_Click" Text="Send Test Bulletin"
                                                                    ValidationGroup="t" />
                                                            </td>
                                                        </tr>
                                                    </tbody>
