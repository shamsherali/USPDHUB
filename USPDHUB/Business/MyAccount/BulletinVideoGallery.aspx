<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulletinVideoGallery.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.BulletinVideoGallery" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script>
        ...
        function SubmitVideoThumbUrl(thumbUrl, youtube_video_id) {
            ...
            "<img style='vertical-align:bottom; margin-left: 10px;' src='" + thumbUrl + "' border='0' width='280px'    /></a>";
