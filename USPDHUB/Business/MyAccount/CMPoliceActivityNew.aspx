<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" ValidateRequest="false" CodeBehind="CMPoliceActivityNew.aspx.cs" 
Inherits="USPDHUB.Business.MyAccount.CMPoliceActivityNew" %>
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function PreviewHTML(type) {
            ...
            previewHTMLStr = "<table cellpadding='0' cellspacing='0' style='padding-left:100px; padding-top:10px;padding-right:5px; text-align:left;'>" + thirdBorder + "</table>";
    ...
    <script type="text/javascript">
        ...
        function EditImage(imgdivID, parentID) {
            ...
            ifrm.setAttribute("src", "BulletinsForm_ImageGallery.aspx?fitblockwidth=" + (document.getElementById(imgdivID).offsetWidth - 22) + "&imgSrc=" + imgSrc + "&folder=Forms");
