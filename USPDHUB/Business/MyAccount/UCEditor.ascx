<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCEditor.ascx.cs" Inherits="USPDHUB.Business.MyAccount.UCEditor" %>
    ...
    function ShowPopup(value) {
        ...
        if (editHTML.trim() == "") {
            ...
            for (i = 0; i < ColordropDown.get_buttons().get_count(); i++) {
                var oldColor = ColordropDown._getAllItems()[i].get_value().toLowerCase();
                                    ...
                                    <Items>
                                        ...
                                        <telerik:RadToolBarDropDown Text="Black">
                                            <Buttons>
                                                ...
                                                <telerik:RadToolBarButton Text="Black" Group="Color" Value="Black">
                                                </telerik:RadToolBarButton>
                                                <telerik:RadToolBarButton Text="Blue" Group="Color" Value="Blue">
                                                </telerik:RadToolBarButton>
                                                <telerik:RadToolBarButton Text="Fuchsia" Group="Color" Value="Fuchsia">
                                                </telerik:RadToolBarButton>
                                                <telerik:RadToolBarButton Text="Gray" Group="Color" Value="Gray">
                                                </telerik:RadToolBarButton>
                                                <telerik:RadToolBarButton Text="Green" Group="Color" Value="Green">
                                                </telerik:RadToolBarButton>
                                                <telerik:RadToolBarButton Text="Red" Group="Color" Value="Red">
                                                </telerik:RadToolBarButton>
                                                <telerik:RadToolBarButton Text="Yellow" Group="Color" Value="Yellow">
                                                </telerik:RadToolBarButton>
