...
namespace USPDHUB.Business.MyAccount
{
    public partial class SheriffCrimeHighlights : BaseWeb
    {
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SheriffCrimeHighlights.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void LoadDefaultData()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SheriffCrimeHighlights.aspx.cs", "LoadDefaultData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            if (ValidatePublishDate())
            {
                ...
                string urlinfo = Page.ResolveClientUrl("~/Business/MyAccount/SheriffCrimeHighlights.aspx");
