...
{
    public partial class CMCrimeHighlights : BaseWeb
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMCMCrimeHighlights.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
                // *** Get Domain Name *** //
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCMCMCrimeHighlights.aspx.cs", "Page_Load", ex.Message, Convert.ToString(ex.StackTrace),
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCMCMCrimeHighlights.aspx.cs", "GetAutoShareRecordStatus", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void LoadDefaultData()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCMCMCrimeHighlights.aspx.cs", "LoadDefaultData", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private bool ValidatePublishDate()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMCrimeHighlights.aspx.cs", "ValidatePublishDate", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCrimeHighlights.aspx.cs", "ValidatePublishDate", ex.Message,
        ...
        protected void btnDashboard_OnClick(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMCrimeHighlights.aspx.cs", "btnDashboard_OnClick", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCrimeHighlights.aspx.cs", "btnDashboard_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        private void Save_Update_BulletinDetails()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCrimeHighlights.aspx.cs", "Save_Update_BulletinDetails", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMCMCrimeHighlights.aspx.cs", "BtnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (ValidatePublishDate())
                {
                    ...
                    string urlinfo = Page.ResolveClientUrl("~/Business/MyAccount/CMCrimeHighlights.aspx");
                    Response.Redirect(urlinfo);
                }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCMCrimeHighlights.aspx.cs", "BtnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void BtnPublish_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMCMCrimeHighlights.aspx.cs", "BtnPublish_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                if (rbPublish.Checked)
                    publishValue = "2";
                if (ValidatePublishDate())
                {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCMCrimeHighlights.aspx.cs", "BtnPublish_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void BtnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMCrimeHighlights.aspx.cs", "BtnCancel_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCrimeHighlights.aspx.cs", "BtnCancel_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        public static string ReplaceShortURltoHmlString(string htmlString)
        {
            ...
            catch (Exception ex)
            {
                InBuiltDataBLL objInBuiltData = new InBuiltDataBLL();
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMCrimeHighlights.aspx.cs", "ReplaceShortURltoHmlString", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return htmlString;
        }
