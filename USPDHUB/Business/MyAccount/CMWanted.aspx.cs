...
{
    public partial class CMWanted : BaseWeb
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "btnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (addflag)
                {
                    ...
                    BulletinXML = "<Bulletin DefaultImg='" + hdnDefaultPerson.Value + "' DefaultImgLink='" + hdnDPLink.Value + "' FirstName='" + txtFirstName.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' LastName='" + txtLastName.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' " +
                                   ...
                                   " ExHours='" + ExHour + "' ExMinutes='" + ExMin + "' ExSS='" + ExSS + "'  MiddleName='" + txtMiddleName.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' />";
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "btnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        private void LoadDefaultData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
                //Fill the Categories
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "LoadDefaultData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private void LoadFormData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "LoadFormData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "LoadFormData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        public string GetTotalHeight()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "GetTotalHeight", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "GetTotalHeight", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return "";
            }
        }
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "lnkPreview_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "lnkPreview_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private string BuildHTML()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "BuildHTML", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                {
                    strHtml.Append("<tr>");
                    strHtml.Append("<td style='padding: 4px;'>Bulletin Date :</td>");
                    strHtml.Append("<td style='color: #353535;'>" + txtBulletinDate.Text.Trim() + "</td></tr>");

                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Date :</div>");
                    strPrintHtml.Append("<div style=\"float: left; width: 438px; margin-bottom: 10px;\">" + txtBulletinDate.Text.Trim() + "</div>");
                }
                if (txtReason.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Reason :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtReason.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                ...
                if (txtLastName.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Last Name :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtLastName.Text.Trim() + "</div>");
                }
                // *** For first name *** //
                if (txtFirstName.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">First Name :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtFirstName.Text.Trim() + "</div>");
                }
                ...
                if (txtNickname.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Nickname :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtNickname.Text.Trim() + "</div>");
                }
                // *** For Date of Birth *** //
                if (txtDOB.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Date of Birth :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtDOB.Text.Trim() + "</div>");
                }
                // *** For age *** //
                if (txtAge.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Age :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtAge.Text.Trim() + "</div>");
                }
                // *** For Gender *** //
                if (ddlGender.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Gender/Race :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + ddlGender.SelectedValue + "</div>");
                }
                // *** For Height *** //
                string height = "";
                ...
                if (height != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Height :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + height + "</div>");
                }
                // *** For Weight *** //
                if (txtWeight.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Weight :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtWeight.Text.Trim() + "</div>");
                }
                // *** For Eyes *** //
                if (ddlEyes.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Eyes :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + ddlEyes.SelectedValue + "</div>");
                }
                // *** For Hair *** //
                if (ddlHair.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Hair :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + ddlHair.SelectedValue + "</div>");
                }
                // *** For Complexion *** //
                if (ddlCompletion.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Complexion :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + ddlCompletion.SelectedValue + "</div>");
                }
                // *** For Race *** //
                if (ddlRace.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Race :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + ddlRace.SelectedValue + "</div>");
                }
                ...
                if (txtMarks.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Distinguishing Marks :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtMarks.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                ...
                if (hdnAnotherImg.Value != "")
                {
                    ...
                    if (hdnAnotherImgLink.Value == "")
                    {
                        ...
                        // PDF Print HTML
                        strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold;  text-align:center; float: left; margin-right: 10px; margin-bottom: 10px; border: 1px solid #dddddd; padding: 0px; width:100%;\"><img src=\"" + hdnAnotherImg.Value + "\" /></div>");
                    }
                    else
                    {
                        strHtml.Append("<a href='" + hdnAnotherImgLink.Value + "' target='_blank'><img src='" + hdnAnotherImg.Value + "'/></a>");
                        // PDF Print HTML
                        strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold;  text-align:center; float: left; margin-right: 10px; margin-bottom: 10px; border: 1px solid #dddddd; padding: 0px; width:100%; \"><a href='" + hdnAnotherImgLink.Value + "' target='_blank'><img src='" + hdnAnotherImg.Value + "'/></a></div>");
                    }
                    strHtml.Append("</td></tr>");
                }
                ...
                if (txtAddInfo.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; color: red; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Additional Information :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtAddInfo.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                // *** For Remarks *** //
                if (txtRemarks.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; color: red; font-weight: bold; float: left; width: 162px; margin-right: 10px; margin-bottom: 10px;\">Remarks :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-bottom: 10px;\">" + txtRemarks.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "BuildHTML", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        ...
        private string BuildHeader()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMWanted.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        ...
        private string BuildLocatedImage(string htmlString)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "BuildLocatedImage", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return htmlString;
        }
        ...
        private void PngImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "PngImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void JpegImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "JpegImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void BmpImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMWanted.aspx.cs", "BmpImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
