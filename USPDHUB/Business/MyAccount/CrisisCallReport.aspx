<%@ Page Language="C#" MasterPageFile="~/PaidTools.master" AutoEventWireup="true"
    CodeBehind="CrisisCallReport.aspx.cs" ValidateRequest="false" Inherits="USPDHUB.Business.MyAccount.CrisisCallReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="grdDownloads" />
        </Triggers>
        <ContentTemplate>
            <table class="page-padding" cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <asp:Button ID="btnBack" CssClass="button" runat="server" Text="Back" 
                                        CausesValidation="false" onclick="btnBack_Click" />&nbsp;&nbsp;<asp:Button
                                        ID="btncancel" CssClass="button" runat="server" Text="Cancel" 
                                        onclick="btncancel_Click" />
                                </td>
                            </tr>
                        </table>
                        <table cellpadding="0" cellspacing="0" border="0" id="tabber" width="100%" style="display: none;">
                            <tr>
                                <td align="center">
                            ...
                            <tr>
                                <td class="content">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td class="leftmenu">
                                                <asp:GridView ID="grdDownloads" runat="server" AutoGenerateColumns="False" CssClass="datagrid2">
                                                    <EmptyDataRowStyle ForeColor="#C00000"></EmptyDataRowStyle>
                                                    <Columns>
                                                        <asp:BoundField DataField="Start_Date" DataFormatString="{0:MM/dd/yyyy}" HeaderText="From Date"
                                                            HtmlEncode="False">
                                                            <HeaderStyle Width="325px"></HeaderStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="End_Date" DataFormatString="{0:MM/dd/yyyy}" HeaderText="To Date"
                                                            HtmlEncode="False">
                                                            <HeaderStyle Width="325px"></HeaderStyle>
                                                        </asp:BoundField>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFromDate" runat="server" Text='<%# Bind("Start_Date") %>' Visible="false"></asp:Label>
                                                                <asp:Label ID="lblEndDate" runat="server" Text='<%# Bind("End_Date") %>' Visible="false"></asp:Label>
