<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeBehind="ManageAddOns.aspx.cs" Inherits="USPDHUB.Business.MyAccount.ManageAddOns"
            ...
            <table class="page-padding" cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                    <td class="valign-top">
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td>
                                                    <%if (hdnIsPrivateModule.Value == "1")
                                                      { %>
                                                    <span style="font-weight: bold; font-size: 14px; margin-left: 50px;">Private Module</span>
                                                    <%}
                                                      else
                                                      {%>&nbsp;
                                                    <%} %>
                        ...
                        <p style="margin-right:147px;float:right;margin-top:17px;">Page Size  <UcPageSize:PageSize ID="PageSizes" runat="server" /></p>
                                        ...
                                        <tr>
                                                                        ...
                                                                        <td valign="top">
                                                                            <div class="GridDock" id="dvGridWidth" style="border: 1px solid #428ad7;">
                                                                                <asp:GridView ID="GrdBulletins" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                    CssClass="datagrid2" AllowPaging="True" DataKeyNames="Custom_ID,Expiration_Date"
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Select">
                                                                                            <ItemTemplate>
                                                                                                <%--  <asp:RadioButton ID="rbBulletin" runat="server" AutoPostBack="true" OnCheckedChanged="rbBulletin_CheckedChanged"
                                                                                                    onclick='<%# string.Format("javascript:RadioCheck(this, \"{0}\",\"{1}\")", "", Eval("Custom_ID")) %>' />--%>
                                                                                                <asp:CheckBox ID="chkCurrentTabCustomID" runat="server" AutoPostBack="true" OnCheckedChanged="chkCurrentTabCustomID_CheckedChanged" />
                                                                                            </ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Name" SortExpression="Name">
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton ID="lnkTitle" runat="server" CausesValidation="false" Text='<%# Bind("Bulletin_Title") %>'
                                                                                                    CommandArgument='<%# Bind("Custom_ID") %>' OnClick="lnkTitle_Click"></asp:LinkButton>
                                                                                            </ItemTemplate>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="border: 0px;" valign="top" nowrap="nowrap">
                                                                                                            ...
                                                                                                            <asp:LinkButton Style="font-weight: bold; color: blue; font-family: verdana; color: #0b689d;"
                                                                                                                ...
                                                                                                                Text="Campaign report" CommandArgument='<%# Bind("Custom_ID") %>'></asp:LinkButton>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </ItemTemplate>
                                            ...
                                            <td class="rightmenu">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td class="rightLinks">
                                                            <asp:LinkButton ID="lnkPrvInvitations" runat="server" CausesValidation="false" OnClick="lnkPrvInvitations_Click"><span style="background: url(../../images/Dashboard/side_icons.png) no-repeat 6px -370px;"></span>Manage Invites</asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <%} %>
                                                    <tr>
                                                            ...
                                                            <div style="display: block;">
                                                                <table border="0" width="95%" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a class="cursor" onclick="alert('Please select a Title.');">
                                                                                <img src='../../images/Dashboard/facebooknew.gif' alt='Share on Facebook Page' width='55'
                                                                                    height='36' title='Share on Facebook Page' border='0' /></a> <a class="cursor" onclick="alert('Please select a Title.');"
                                                                                        style="display: none;">
                                                                ...
                                                                <asp:GridView ID="grdschemail" runat="server" PageSize="10" AllowPaging="True" OnPageIndexChanging="grdschemail_PageIndexChanging"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("Custom_ID") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                ...
                                <tr>
                                    <td align="left" class="header">
                                        <div style="float: left; text-align: left; padding: 10px 0px 0px 5px;">
                                            <asp:Label ID="Label1" runat="server" Text="App Display Order"></asp:Label>
                                        ...
                                        <div id="Div1" style="height: 300px; overflow-y: auto; border: solid 1px #ccc; padding-top: 5px;">
                                            <ul id="sortable">
                                                <asp:ListView ID="OrderListView" OnItemDataBound="OrderListView_ItemDataBound" runat="server"
                                                    DataKeyNames="Custom_ID" ItemPlaceholderID="myItemPlaceHolder">
                                                    <LayoutTemplate>
                                                    </LayoutTemplate>
                                                    <LayoutTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <li class="ui-state-default" id='id_<%# Eval("Custom_ID") %>' style="border: 1px solid #ccc;
                                                            background: #EEEEEE; font-weight: normal; color: #8C8C8C;">
                                                            <asp:Label ID="lblKey" runat="server" Text='<%#Eval("Custom_ID") %>' Visible="false" />
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding-right: 10px; padding-bottom: 20px" align="center">
                                                <asp:Button ID="btnShareOnPage" runat="server" class="FBpopupBtn" CausesValidation="false"
                                                    Text="Post Data" OnClick="btnShareOnPage_Click" />
                                                <%--onclick="ShareOnPage()"--%>
                                            </td>
                                        </tr>
                                        <tr>
