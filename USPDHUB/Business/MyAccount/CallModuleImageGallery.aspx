<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CallModuleImageGallery.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.CallModuleImageGallery" ValidateRequest="false" %>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:61px;">
                                                <asp:Button ID="Button1" runat="server" Font-Bold="true" 
                                                    OnClick="btnSystemImages_Click" Text="Default Library" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;
                            ...
                            <tr>
                                ...
                                <td rowspan="2" style="padding-left: 10px;">
                                    <asp:ImageButton ID="ImgUserImg" runat="server" ImageUrl='<%# Eval("Image_Thumb","~/Upload/CallModule/" + ProfileID + "/" + UserModuleId + "/{0}") %>'
    ...
    <script type="text/javascript" language="javascript">
        ...
        if (document.getElementById('hdnClose').value != "") {
            ...
            if (document.getElementById('txtwebaddress').value != "" && document.getElementById('txtwebaddress').value != "http://") {
                if (parent.document.getElementById("ctl00_cphUser_hdnDPLink") != null) {
                    parent.document.getElementById("ctl00_cphUser_hdnDPLink").value = document.getElementById('txtwebaddress').value;
                }
