<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="CMPrintPressRelease.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.CMPrintPressRelease" %>
                        ...
                        <div class="form_wrapper">
                            ...
                            <div class="fields_wrap ">
                                ...
                                <div class="right_fields" style="margin: 10px 0px 0px 0px; width: 450px;">
                                    ...
                                    <asp:LinkButton ID="lnkPreview" runat="server" OnClick="lnkPreview_Click" OnClientClick="ValidatePublishDate();"><img src="../../images/BulletinThumbs/preview.png" width="100" height="37"></asp:LinkButton>
