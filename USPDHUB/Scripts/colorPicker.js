...
Control.ColorPicker.prototype = {
    initialize: function (field, options) {
        ...
        if (!Control.ColorPicker.CONTROL) {
          ...
          '<div id="colorpicker-footer"><span id="colorpicker-value">#<input type="text" onclick="this.select()" id="colorpicker-value-input" name="colorpicker-value" value=""></input></span><button id="colorpicker-okbutton">OK</button><button id="colorpicker-cancelbutton">Cancel</button></div>'
    ...
    open: function (event) {
        ...
        this.isOpen = true;
        this.previousColor = this.field.value;
    ...
    cancel: function (event) {
        ...
        Event.stopObserving(this.control.cancelButton, "click", this.closeOnClickCancelListener);
        Event.stopObserving(this.control.pickerArea, "mousedown", this.updateOnClickPickerListener);
        this.field.value = this.previousColor;
        this.updateSwatch();
