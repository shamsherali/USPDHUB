...
(function ($, window, document) {
    ...
    SearchableOptionList.prototype = {
        ...
        _applySearchTermFilter: function () {
            ...
            $(".sol-select-all").css("display","block");
             $(".sol-deselect-all").css("display","block");
            ...
            if (lowerCased.trim().length > 0) {
             $(".sol-select-all").css("display","none");
              $(".sol-deselect-all").css("display","none");
        ...
        _renderOption: function (solOption, $optionalTargetContainer) {
            ...
            if (this.config.multiple) {
                // use checkboxes
                //$inputElement = $('<input type="checkbox" class="sol-checkbox" style="display:none;"/>');
        ...
        _selectionChange: function ($changeItem, skipCallback) {
            ...
            if ($changeItem.prop('checked')) {
                ...
                //$changeItem[0].nextSibling.className='sol-label-text-select';
            } else {
                this._removeSelectionDisplayItem($changeItem);
                //$changeItem[0].nextSibling.className='sol-label-text-disselect';
            }
