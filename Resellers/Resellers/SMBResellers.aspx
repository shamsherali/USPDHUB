<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMBResellers.aspx.cs" Inherits="Resellers.SMBResellers" %>
        ...
        <ContentTemplate>
            <div id="outerwrapper">
                <div id="wrapper">
                    <div id="banner">
                        <div id="brand">
                            <img src="<%=Page.ResolveClientUrl("~/images/smbnationlogo.png")%>" alt="SMB Nation"
                                border="0">
                        </div>
                        <div id="bannerright">
                            <div id="social">
                        ...
                        <div id="contentleft500" style="float: none; margin-left: 205px; width: 600px;">
                            ...
                            <div id="signupform">
                                ...
                                <div>
                                    ...
                                    <asp:HiddenField ID="hdnResellerName" Value="SMBNation" runat="server" />
                                </div>
                            </div>
                            <br>
                        </div>
