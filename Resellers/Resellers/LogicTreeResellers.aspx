<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogicTreeResellers.aspx.cs"
    Inherits="Resellers.LogicTreeResellers" %>
...
<head id="Head1" runat="server">
    ...
    <title>LogicTree Resellers</title>
        ...
        <ContentTemplate>
            <div id="outerwrapper">
                <div id="wrapper">
                    <div id="banner">
                        <div id="brand">
                            <img src="http://www.logictreeit.com/media/common/logic-tree-it-logo.jpg" alt="SMB Nation"
                                border="0">
                        </div>
                        <div id="bannerright">
                            <div id="social">
                            ...
                            <div id="signupform">
                                ...
                                <div class="txtfildwrap">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtphonenumber"
                                        ...
                                        SetFocusOnError="True" CssClass="errormsg_text">*</asp:RequiredFieldValidator>
                                ...
                                <div>
                                    ...
                                    <asp:HiddenField ID="hdnResellerName" Value="LogicTree" runat="server" />
                                </div>
                            </div>
                            <br>
                        </div>
