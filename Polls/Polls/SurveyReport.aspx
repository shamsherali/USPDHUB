<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyReport.aspx.cs" Inherits="Polls.SurveyReport"
...
<head>
    ...
    <link rel="stylesheet" href="http://www.uspdhub.com/css/SmartConnectStyle.css">
</head>
<body>
    <style>
        .logo img
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 dashbox1">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 graph">
                        <p>
                            <asp:Label runat="server" ID="lblTitle1"></asp:Label>
                        </p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 dashboard">
                        <p>
                            Total Participants:
                            <asp:Label runat="server" ID="lblCount1"></asp:Label>
                        </p>
