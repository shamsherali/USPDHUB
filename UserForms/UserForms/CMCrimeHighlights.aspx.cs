    ...
    public partial class CMCrimeHighlights : BaseWeb
    {
        ...
        private void GetBulletinDetails()
        {
            try
            {
                ...
                if (dtBulletinDetails.Rows.Count > 0)
                {
                    ...
                    {
                        objInBuiltData.CreateImage(uspdVirtualFolder + "\\Upload\\CustomModules\\", Convert.ToInt32(Session["ProfileID"]),
        ...
        private void Save_Update_BulletinDetails()
        {
            try
            {
                ...
                if (txtExDate.Text != "")
                {
                    expiryDate = Convert.ToDateTime(txtExDate.Text.Trim() + " " + ExpiryTimeControl1.SelectedTime);
                }
                ...
                //Create Bulletin Image
                objInBuiltData.CreateImage(uspdVirtualFolder + "\\Upload\\CustomModules\\", ProfileID, UserID, CustomID, previewHtml);
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ValidatePublishDate())
                {
                    ...
                    string urlinfo = Page.ResolveClientUrl("CMCrimeHighlights.aspx");
                    Response.Redirect(urlinfo);
                }
        ...
        protected void BtnPublish_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ValidatePublishDate())
                {
                    ...
                    Session["msgSave"] = "";
                    //
                    string urlinfo = Page.ResolveClientUrl(RootPath + "/Business/MyAccount/ManageAddOns.aspx");
