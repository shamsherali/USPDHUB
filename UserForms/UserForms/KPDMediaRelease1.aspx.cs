...
namespace UserForms
{
    public partial class KPDMediaRelease1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "MediaRelease.aspx.cs", "Page_Load", ex.Message, Convert.ToString(ex.StackTrace),
        ...
        private bool Save_Update_Details()
        {
            ...
            catch (Exception ex)
            {
                //Error 
                isSuccess = false;
                objInBuiltData.ErrorHandling("ERROR", "MediaRelease.aspx.cs", "Save_Update_Details", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return isSuccess;
        }
