<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="CMSheriffsMessage.aspx.cs" Inherits="UserForms.CMSheriffsMessage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
                <div id="wrapper">
                    <div class="headernav">
                        <%=BulletinName %>Sheriff Message<asp:TextBox ID="txt" runat="server" Width="0" BorderStyle="none"
                    ...
                    <div class="contentwrap">
                        <div class="largetxt">
                            <asp:Label ID="lblChiefStart" runat="server" Text="Message from "></asp:Label><asp:TextBox
                                ID="txtChiefName" runat="server" Text="the Sheriff" MaxLength="25" onkeyup="CountMaxLength(this,'Sheriff Name');"
                                onChange="CountMaxLength(this,'Sheriff Name');" Width="170"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtChiefName"
                                ...
                                ErrorMessage="Sheriff Name is mandatory." Style="font-size: 14px;">*</asp:RequiredFieldValidator>&nbsp;
                            <span style="font-size: 12px; color: #000;">(Max Characters 25)</span>
                            <br />
    ...
    <script type="text/javascript">
        ...
        function DisplayImage() {
            ...
            CountMaxLength(document.getElementById('<%=txtChiefName.ClientID %>'), 'Sheriff Name');
        }
