...
namespace UserForms
{
    public partial class KPDMediaRelease : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "KPDMediaRelease.aspx.cs", "Page_Load", ex.Message, Convert.ToString(ex.StackTrace),
        ...
        private void LoadDefaultData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "KPDMediaRelease.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "KPDMediaRelease.aspx.cs", "LoadDefaultData", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private void LoadFormData()
        {
                ...
                if (dtFormData.Rows.Count > 0)
                {
                    ...
                    if (hdnEditXML.Value.Trim() != "")
                    {
                        ...
                        if (xmldoc.SelectSingleNode("Bulletins/Details/@DateTime") != null)
                        {
                            ...
                            {
                                str = xmldoc.SelectSingleNode("Bulletins/Details/@DateTime").Value.ToString();
                                char[] splitchar = { ' ' };
                                strArr = str.Split(splitchar);
                                txtIncidentDate.Text = strArr[0];
                                txtIncidentTime.Text = strArr[2];
                            }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "KPDMediaRelease.aspx.cs", "LoadFormData", ex.Message,
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "KPDMediaRelease.aspx.cs", "BtnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private bool ValidatePublishDate()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "KPDMediaRelease.aspx.cs", "ValidatePublishDate", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return false;
            }
        }
        private bool Save_Update_Details()
        {
            ...
            try
            {
                ...
                string printHTML = "";
                string CategoryName = "Media Release";
            ...
            catch (Exception ex)
            {
                //Error 
                isSuccess = false;
                objInBuiltData.ErrorHandling("ERROR", "KPDMediaRelease.aspx.cs", "Save_Update_Details", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return isSuccess;
        }
