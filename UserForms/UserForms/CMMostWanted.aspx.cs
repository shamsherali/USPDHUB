...
namespace UserForms
{
    public partial class CMMostWanted : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMostWanted.aspx.cs", "Page_Load", ex.Message,
        ...
        private void LoadFormData()
        {
            try
            {
                ...
                if (dtFormData.Rows.Count > 0)
                {
                    ...
                    xmldoc.LoadXml(hdnEditXML.Value);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMostWanted.aspx.cs", "LoadFormData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMostWanted.aspx.cs", "BtnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private bool ValidatePublishDate()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMostWanted.aspx.cs", "ValidatePublishDate", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return false;
            }
        }
        private bool Save_Update_Details()
        {
            ...
            catch (Exception ex)
            {
                //Error 
                isSuccess = false;
                objInBuiltData.ErrorHandling("ERROR", "CMMostWanted.aspx.cs", "Save_Update_Details", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return isSuccess;
        }
        protected void BtnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMostWanted.aspx.cs", "BtnCancel_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        [WebMethod]
