...
namespace UserForms
{
    public partial class CrimeWeeklyReport : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    DataTable dtCrimeDetailsReports = objBulletinBLL.GetCrimeWeeklyReportsDetailsByDates(dtFromTime, dtToTime, ProfileID, chkIncludePrivate.Checked,chkIncludeArchive.Checked);
                    ...
                    for (int i = 0; i < dtCrimeDetailsReports.Columns.Count-3; i++)
                    {
                        dt2.Rows.Add();
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        string xmlFileName = uspdVirtualFolder + "/BulletinPreview/CrimeReportColumnNames.xml";
        ...
        {
            Response.Redirect(Page.ResolveClientUrl(RootPath + "/Business/MyAccount/SelectBulletin.aspx"));
        }
