<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="CrimeWeeklyReport.aspx.cs" Inherits="UserForms.CrimeWeeklyReport"%>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td colspan="3">
                                        <br />
                                        <span style="font-weight:bold; font-size: 12px; color:#000000; vertical-align:top;">Include archived crime reports</span> <asp:CheckBox ID="chkIncludeArchive" runat="server" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
