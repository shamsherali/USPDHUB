<%@ Page Title="" Language="C#" MasterPageFile="~/PaidTools.master" AutoEventWireup="true"
    CodeBehind="TrafficAlert.aspx.cs" ValidateRequest="false" Inherits="UserForms.TrafficAlert" %>
                    ...
                    <div class="contentwrap">
                        ...
                        <div class="form_wrapper">
                            ...
                            <div class="fields_wrap">
                                ...
                                <div class="right_fields">
                                    <asp:CheckBox runat="server" ID="chkCleared" />
                                    <asp:TextBox runat="server" ID="txtCleared" placeholder="Cleared" Text="Cleared"
    ...
    <script type="text/javascript">
        function CountMaxLength(id, e) {
            ...
            if (myRegExp.test(id.value)) {
                ...
                if (e != undefined && (e.keyCode == 8 || e.keyCode == 46)) {
                    ...
                    document.getElementById('<%=txtCleared.ClientID %>').value = id.value.replace(/[&<]/g, '')
        ...
        */
        ...
        window.onload = function () {
            ...
            CountMaxLength(document.getElementById('<%=txtCleared.ClientID %>'));
        }
