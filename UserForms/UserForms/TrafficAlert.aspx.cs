...
namespace UserForms
{
    public partial class TrafficAlert : BaseWeb
    {
        public int UserID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                objInBuiltData.ErrorHandling("LOG", "Traffic.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "Page_Load", ex.Message, Convert.ToString(ex.StackTrace),
        ...
        private void LoadDefaultData()
        {
            try
            {
                objInBuiltData.ErrorHandling("LOG", "Traffic.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
#if fixme
                /*
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "LoadDefaultData", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void LoadFormData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "Traffic.aspx.cs", "LoadFormData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "LoadFormData", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            try
            {
                objInBuiltData.ErrorHandling("LOG", "Traffic.aspx.cs", "btnCancel_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "btnCancel_Click", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            try
            {
                objInBuiltData.ErrorHandling("LOG", "Traffic.aspx.cs", "lnkPreview_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                if (!string.IsNullOrEmpty(txtFromDate.Text))
                {
                    txtFromHours.Enabled = true;
                    txtFromMinutes.Enabled = true;
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "lnkPreview_Click", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private string BuildHTML()
        {
            try
            {
                ...
                if (chkCleared.Checked)
                {
                    ...
                    strHtml.Append("<div align='center' style='color: black; font-weight:bold; z-index: 99999; " +
                    "text-align: center; padding-top: 100px; padding-left: 275px; '>  <span><img src='" + imgSrc + "' /></span> </div>");
                    ...
                    " '>  <span><img src='" + imgSrc + "' style=\"position: absolute; margin-top: 100px; margin-left: 90px; \" /></span> </div>");
                }
                else
                {
                ...
                if (txtBulletinDate.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"font-weight: bold; float: left; width: 215px; margin-right: 10px;\">Date :</div>");
                    strPrintHtml.Append("<div style=\"float: left; width: 385px;\">" + txtBulletinDate.Text.Trim() + "</div>");
                }
                if (chkAccident.Checked)
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\">" + chkAccident.Text + "</div>");
                }
                if (chkRoadClosure.Checked)
                {
                    ...
                    strHtml.Append("</tr>");
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\">" + chkRoadClosure.Text + "</div>");
                }
                if (chkConstruction.Checked)
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\">" + chkConstruction.Text + "</div>");
                }
                if (chkWeather.Checked)
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\">" + chkWeather.Text + "</div>");
                }
                if (chkChains.Checked)
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\">" + chkChains.Text + "</div>");
                }
                if (chkSnowLevel.Checked == true && txtSnowLevel.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\"><strong>" + chkSnowLevel.Text + "</strong >:  " + txtSnowLevel.Text + "</div>");
                }
                if (chkSpeicalEvent.Checked)
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\">" + chkSpeicalEvent.Text + "</div>");
                }
                if (chkHazMat.Checked)
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\">" + chkHazMat.Text + "</div>");
                }
                if (chkOther.Checked == true && txtOther.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\"><strong>" + chkOther.Text + "</strong >:  " + txtOther.Text + "</div>");
                ...
                if (chkTuneRadio.Checked == true && txtAM.Text.Trim() != "" && txtFM.Text.Trim() != "" && chkForRoadCondition.Checked == true && txtConditionsCall.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\"> <div style=\"border: 1px solid black; width:255px; padding: 8px 6px 0px 10px;\">" + chkTuneRadio.Text + "<br /><span style='padding-left: 15px;'> AM " + txtAM.Text + "</span><br /><span style='padding-left: 15px;'> FM " + txtFM.Text + "</span><br /><span style='padding-left: 15px;'> Road Conditions Call " + txtConditionsCall.Text + "</span></div></div>");
                ...
                if (txtLocation.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 215px; margin-right: 10px;\">Location :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 385px;\">" + txtLocation.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                if (txtCity.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 215px; margin-right: 10px;\">City :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 385px;\">" + txtCity.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                if (txtzipcode.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 215px; margin-right: 10px;\">Zip code :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 385px;\">" + txtzipcode.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                ...
                if (hdnAddImg1.Value != "")
                {
                    ...
                    if (hdnAddImg1Link.Value == "")
                    {
                        ...
                        // PDF Print HTML
                        strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; text-align:center; margin-top: 20px auto; border: 1px solid #dddddd;padding: 0px; width:100%; \"><img src=\"" + hdnAddImg1.Value + "\"/></div>");
                    }
                    else
                    {
                        strHtml.Append("<a href='" + hdnAddImg1Link.Value + "' target='_blank'><img src='" + hdnAddImg1.Value + "'/></a>");
                        // PDF Print HTML
                        strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; text-align:center; margin-top: 20px auto; border: 1px solid #dddddd;padding: 0px; width:100%; \"><a href='" + hdnAddImg1Link.Value + "' target='_blank'><img src='" + hdnAddImg1.Value + "'/></a></div>");
                    }
                ...
                if (txtInformation.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 215px; margin-right: 10px;\">Information :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 385px;\">" + txtInformation.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                // *** If uploaded the image *** //
                if (hdnAddImg2.Value != "")
                {
                    ...
                    if (hdnAddImg2Link.Value == "")
                    {
                        ...
                        // PDF Print HTML
                        strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; text-align:center; margin-top: 20px auto; border: 1px solid #dddddd;padding: 0px; width:100%; \"><img src=\"" + hdnAddImg2.Value + "\"/></div>");
                    }
                    else
                    {
                        strHtml.Append("<a href='" + hdnAddImg2Link.Value + "' target='_blank'><img src='" + hdnAddImg2.Value + "'/></a>");
                        // PDF Print HTML
                        strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; text-align:center; margin-top: 20px auto; border: 1px solid #dddddd;padding: 0px; width:100%; \"><a href='" + hdnAddImg2Link.Value + "' target='_blank'><img src='" + hdnAddImg2.Value + "'/></a></div>");
                    }
                    strHtml.Append("</td></tr>");
                }
                if (chkWhenDate.Checked == true && txtFromDate.Text.Trim() != "" && txtToDate.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 215px; margin-right: 10px;\">When :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 385px;\"><span style='margin-left:0px;'>From " + txtFromDate.Text + "</span>  &nbsp;  <span style='margin-left:5px;'>To " + txtToDate.Text + "</span></div>");
                }
                if (chkClosureTime.Checked == true && (txtFromHours.Text.Trim() != "" && txtToHours.Text.Trim() != ""))
                {
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 215px; margin-right: 10px;\">Expected Delay/Closure Time :</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 385px;\">From " + fromTime + "  &nbsp; To " + toTime + "</div>");
                }
                strHtml.Append("</table>");
                if (chkPleaseLimit.Checked)
                {
                    strHtml.Append("<div style=\"page-break-inside: avoid; overflow: hidden; float: left;\">");
                    ...
                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 600px; margin-right: 10px;\"><strong>Please limit phone calls. </strong></div>");
                }
                strHtml.Append("</div>");
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "BuildHTML", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                // Log 
                objInBuiltData.ErrorHandling("LOG", "Traffic.aspx.cs", "btnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
...
//                var exTime = "";
                    ...
                    if (Session["C_USER_ID"] != null && Session["C_USER_ID"].ToString() != "")
                    {
                        ...
                        if (hdnPermissionType.Value == "A" && (!string.IsNullOrEmpty(hdnPermissionType.Value))) //A for author
                        {
                            BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBid, BulletinName, BulletinHtml, BulletinXml,
                                CUserID, CUserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false, chkContact.Checked,
                                isPublish, dateExpires, datePublish, ddlCategories.SelectedValue, false, id, printerHtml);
                            if (isPrivate == true)
                                returnvalue = objCommon.SendAuthorNotifications(Session["C_USER_NAME"].ToString(), BulletinID, PageNames.BULLETIN, UserID, Session["username"].ToString(), PageNames.TALERT, DomainName);
                        }
                        else if (hdnPermissionType.Value == "P" && (!string.IsNullOrEmpty(hdnPermissionType.Value))) //P for publisher
                        {
                            if (isPrivate == true)
                                BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBid, BulletinName, BulletinHtml,
                                    BulletinXml, CUserID, CUserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false,
                                    chkContact.Checked, isPublish, dateExpires, datePublish, ddlCategories.SelectedValue, isPrivate, CUserID, printerHtml);
                            else
                                BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBid, BulletinName, BulletinHtml,
                                    BulletinXml, CUserID, CUserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false,
                                    chkContact.Checked, isPublish, dateExpires, datePublish, ddlCategories.SelectedValue, isPrivate, id, printerHtml);
                        }
                    }
                    else
                    {
                        if (isPrivate == true)
                            BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBid, BulletinName, BulletinHtml, BulletinXml,
                                CUserID, CUserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false, chkContact.Checked,
                                isPublish, dateExpires, datePublish, ddlCategories.SelectedValue, isPrivate, CUserID, printerHtml);
                        else
                            BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBid, BulletinName, BulletinHtml, BulletinXml,
                                CUserID, CUserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false, chkContact.Checked,
            ...
            {
                // Error 
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "btnSave_Click", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        private string BuildHeader()
        {
            try
            {
                objInBuiltData.ErrorHandling("LOG", "Traffic.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "Traffic.aspx.cs", "BuildHeader", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
