...
namespace UserForms
{
    public partial class BulletinsForm_ImageGallery : BaseWeb
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (TimeoutException ex)
            {
                ...
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "Page_Load - timeout is only caught by HttpException.", ex.Message,
            ...
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "Page_Load - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "Page_Load", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        public void GetBulletinImages()
        {
            try
            {
                ...
                //User Images Path
                string bulletinImagesPath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "/Upload/Common/" + ProfileID.ToString();
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "GetBulletinImages - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "GetBulletinImages - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "GetBulletinImages", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private void DeleteBulletinImages()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "DeleteBulletinImages", string.Empty, string.Empty, string.Empty, string.Empty);

                if (File.Exists(ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID.ToString()))
                {
                    string[] allImages = Directory.GetFiles(ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID.ToString());
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "DeleteBulletinImages - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "DeleteBulletinImages - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "DeleteBulletinImages", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void BtnUpload_Click(object sender, EventArgs e)
        {
                    ...
                    if (imageExtension == ".jpg" || imageExtension == ".JPG" || imageExtension == ".JPEG" || imageExtension == ".jpeg" || imageExtension == ".GIF" || imageExtension == ".gif" || imageExtension == ".png" || imageExtension == ".PNG")
                    {
                        ...
                        if (Session["ProfileID"] != null)
                        {
                            if (Session["ProfileID"].ToString() != "")
                            {
                                ...
                                imagepath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID.ToString();
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "BtnUpload_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "BtnUpload_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "BtnUpload_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            finally
            {
        ...
        protected void lnkClear_Click(object sender, EventArgs e)
        {
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkClear_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkClear_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkClear_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private string GetUserProfileImageName(string imagename, string imageExtension)
        {
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "GetUserProfileImageName - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "GetUserProfileImageName - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "GetUserProfileImageName", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void ImgUserImg_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "ImgUserImg_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                hdnClose.Value = "";
                hdnCheck.Value = "";
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ImgUserImg_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ImgUserImg_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ImgUserImg_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void ShowImageResizePanel(string rLoadImageUrl, string resize)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "ShowImageResizePanel", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                else
                {
                    if (resize == "2")
                    {
                        rsizeimagepath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID.ToString() + "\\" + rsizeimagepath;
                    }
                    else
                    {
                        rsizeimagepath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Bulletins\\" + FolderName + "\\" + ProfileID.ToString() + "\\" + TempSesPath + "\\" + rsizeimagepath;
                ...
                if (File.Exists(rsizeimagepath))
                {
                    ...
                    //
                    string tempSavePath = "";// ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\tempbulletinswork\\" + ProfileID + Session["TempName"] + "" + Extension;
                    ...
                    string tempbulletinswork = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "/Upload/tempbulletinswork/" + FolderName + "/";
                    if (!Directory.Exists(tempbulletinswork))
                    {
                        Directory.CreateDirectory(tempbulletinswork);
                    }
                    tempSavePath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\tempbulletinswork\\" + FolderName + "\\" + ProfileID + Session["TempName"] + "" + extension;
                    rsizeimagepath = rsizeimagepath.Replace("%20", " ");
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ShowImageResizePanel - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ShowImageResizePanel - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ShowImageResizePanel", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        public void SaveResizeImage()
        {
            ...
            try
            {   //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "SaveResizeImage", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                imageUrl = ConfigurationManager.AppSettings.Get("USPDFolderPath") + (imageUrl);
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "SaveResizeImage - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "SaveResizeImage - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "SaveResizeImage", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "btnsubmit_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                string savePath = string.Empty;
                string tempImagePath = string.Empty;
                string rVirtualPath = string.Empty;
                string myString = string.Empty;
                TempFolderPath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Bulletins\\" + FolderName + "\\" + ProfileID.ToString() + "\\" + TempSesPath;
                ...
                if (hdnCheck.Value != "")
                {
                    ...
                    savePath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID + "\\" + myString;
                    TempFolderPath = TempFolderPath + "\\" + myString;
                    tempImagePath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\tempbulletinswork\\" + FolderName + "\\" + ProfileID + Session["TempName"] + Session["ImgExt"].ToString();
                ...
                else
                {
                    ...
                    savePath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID + "\\" + myString;
                    TempFolderPath = TempFolderPath + "\\" + myString;
                    tempImagePath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\tempbulletinswork\\" + FolderName + "\\" + ProfileID + Session["TempName"] + unChangedImage;
                    Neodynamic.WebControls.ImageDraw.ImageElement uploadedImage;
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btnsubmit_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btnsubmit_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btnsubmit_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnSaveResizeImage_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "btnSaveResizeImage_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                hdnCheck.Value = "1";
                SaveResizeImage();
            }
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btnSaveResizeImage_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btnSaveResizeImage_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btnSaveResizeImage_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btncancel_Click(object sender, EventArgs e)
        {
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btncancel_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btncancel_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "btncancel_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void lnkDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "lnkDelete_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                for (int i = 0; i < DListBulletinImages.Items.Count; i++)
                {
                    ...
                    if (chkImage.Checked == true)
                    {
                        ...
                        deleteImagePath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID.ToString() + "\\" + deleteImagePath;
                        ...
                        thumbPath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Common\\" + ProfileID.ToString() + "\\" + thumbPath;
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkDelete_Click - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkDelete_Click - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                ...
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "lnkDelete_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void ResizeImage(string orgImageName)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "BulletinsForm_ImageGallery.aspx.cs", "ResizeImage", string.Empty, string.Empty, string.Empty, string.Empty);

                string tempFolderPath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\Bulletins\\" + FolderName + "\\" + ProfileID.ToString() + "\\" + TempSesPath;
                string unChangedImage = ".jpg";
                DateTime myDate = DateTime.Now;
                string myString = orgImageName + "_" + myDate.ToString("ddMMyyhhmmss") + unChangedImage;
                tempFolderPath = tempFolderPath + "\\" + myString;
                string tempImagePath = ConfigurationManager.AppSettings.Get("USPDFolderPath") + "\\Upload\\tempbulletinswork\\" + FolderName + "\\" + ProfileID + Session["TempName"] + unChangedImage;
                Neodynamic.WebControls.ImageDraw.ImageElement uploadedImage;
                uploadedImage = Neodynamic.WebControls.ImageDraw.ImageElement.FromFile(tempImagePath);
                Neodynamic.WebControls.ImageDraw.Resize actResize = new Neodynamic.WebControls.ImageDraw.Resize();
                actResize.LockAspectRatio = Neodynamic.WebControls.ImageDraw.LockAspectRatio.None;
            ...
            catch (TimeoutException ex)
            {
                // Timeout doesn't get caught. Must be a different type of timeout.
                // So far, timeout is only caught by HttpException.
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ResizeImage - timeout is only caught by HttpException.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (HttpException ex)
            {
                ...
                // }
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ResizeImage - Took too long. Please upload a smaller image.", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "BulletinsForm_ImageGallery.aspx.cs", "ResizeImage", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
    }
