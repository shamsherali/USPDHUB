<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    ValidateRequest="false" CodeBehind="ManagePrivateInvitations.aspx.cs" Inherits="USPDHUB.Business.MyAccount.ManagePrivateInvitations" %>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="right" style="padding-top: 30px;">
                                                    <asp:LinkButton runat="server" ID="btnSendInviation" Text="Send Invitation" OnClick="btnSendInviation_OnClick"
                                                        CssClass="btn" Visible="false"></asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                        ...
                                                        <asp:GridView ID="GrdInviters" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Email ID" SortExpression="Email">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblEmailID" Text='<%# Bind("EmailID") %>' runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Mobile Number" SortExpression="MobileNumber">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblMobileNumber" Text='<%# Bind("MobileNumber") %>' runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Device Management">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton runat="server" ID="lnkDeviceCount" Text='<%# Bind("DeviceCount") %>'
                                                                            OnClick="lnkDeviceCount_OnClick" OnClientClick="return CallHelpMethod();" CommandArgument='<%# Bind("InviterID") %>'></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText='Actions'>
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton runat="server" ID="lnkDelete" Font-Bold="true" Text="Delete" OnClick="lnkDelete_OnClick"
                                                                            CommandArgument='<%# Bind("InviterID") %>' OnClientClick="return confirm('Are you sure you want to delete?');"></asp:LinkButton>
                                                                       ...
                                                                       <%-- &nbsp;
                                                                        <asp:LinkButton runat="server" ID="lnkResend" Font-Bold="true" Text="Add Device"
                                                                            OnClick="lnkResend_OnClick" CommandArgument='<%# Bind("InviterID") %>' OnClientClick="return confirm('Are you sure you want to send another invitation?');"></asp:LinkButton>--%>
                                                                    </ItemTemplate>
                            ...
                            <tr>
                                <td align="center" style="background-color: #D2E5FA; border: 1px solid #D1DDEA; padding: 7px 0px 7px 0px;">
                                    <asp:Button ID="btnSepupInvitations" runat="server" Text="Back" CausesValidation="false"
                                        OnClick="btnSepupInvitations_OnClick" />
                                    &nbsp;
                                                                            ...
                                                                            <asp:GridView ID="grdDeviceDetails" runat="server" PageSize="10" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText='Actions <span style="margin-left:10px; padding-top:10px;"><a href="#"><img id="help1" src="../../images/Dashboard/new.png" /></a></span>'>
                                                                                        <ItemTemplate>
                                                                                            <asp:LinkButton runat="server" ID="lnkDelete1" Font-Bold="true" Text="Delete" OnClick="lnkDelete1_OnClick"
                                                                                                CommandArgument='<%# Bind("InvitationID") %>' OnClientClick="return confirm('Are you sure you want to delete?');"></asp:LinkButton>
                                                                                            &nbsp;
                                                                                            <asp:LinkButton runat="server" ID="lnkDisable1" Font-Bold="true" Text="Disable" OnClick="lnkDisable1_OnClick"
                                                                                                CommandArgument='<%# Bind("InvitationID") %>' OnClientClick="return Enable_Disable(this);"></asp:LinkButton>
                                                                                        </ItemTemplate>
                                                                                        <ItemStyle Width="175px"></ItemStyle>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
