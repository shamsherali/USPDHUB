...
namespace USPDHUB.Business.MyAccount
{
    public partial class CMMissingPerson : BaseWeb
    {
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMissingPerson.aspx.cs", "GetAutoShareRecordStatus", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        public string GetTotalHeight()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMissingPerson.aspx.cs", "GetTotalHeight", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return Height;
        }
        ...
        private string BuildLocatedImage(string htmlString)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMissingPerson.aspx.cs", "BuildLocatedImage", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
            return htmlString;
        ...
        private void PngImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMissingPerson.aspx.cs", "PngImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        ...
        private void JpegImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMissingPerson.aspx.cs", "JpegImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        ...
        private void BmpImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMMissingPerson.aspx.cs", "BmpImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
