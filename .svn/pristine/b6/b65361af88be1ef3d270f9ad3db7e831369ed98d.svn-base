<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    ValidateRequest="false" CodeBehind="SendInvitationPrivateModule.aspx.cs" Inherits="USPDHUB.Business.MyAccount.SendInvitationPrivateModule" %>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <%-- <asp:Label ID="lblTitle" runat="server" Text="Private Module Contacts"></asp:Label>--%>
                                        <h1>
                                            <asp:Literal ID="ltrlTitleImage" runat="server"></asp:Literal>&nbsp; <span style="vertical-align: middle">
                                                Private Module Contacts For:
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" id="tabber" width="100%">
                                                        ...
                                                        <table class="popuptablecheckbox" cellspacing="0" cellpadding="0" width="100%">
                                                            <tr>
                                                                <td style="padding-left: 4px;">
                                                                    *Note: Please select 1 or more contacts within your chosen groups.
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="CheckBox1" runat="server"  Checked='<%# Convert.ToBoolean(Convert.ToInt32(Eval("checkvalue").ToString())) %>'
                                                                            AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged"  ToolTip='<%# Eval("ContactID") %>'></asp:CheckBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                            ...
                            <tr>
                                <td align="center" style="background-color: #D2E5FA; border: 1px solid #D1DDEA; padding: 7px 0px 7px 0px;">
                                    ...
                                    <asp:Button ID="btnSepupInvitations" runat="server" Text="Manage Invitations" CausesValidation="false"
