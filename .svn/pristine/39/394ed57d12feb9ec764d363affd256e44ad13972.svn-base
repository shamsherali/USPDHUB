    ...
    public partial class MissingPerson : BaseWeb
    {
            ...
            try
            {
                ...
                if (addflag)
                {
                    ...
                    BulletinXML = "<Bulletin DefaultImg='" + hdnDefaultPerson.Value + "' DefaultImgLink='" + hdnDPLink.Value + "' FirstName='" + txtFirstName.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' LastName='" + txtLastName.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' NickName='" + txtNickname.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' DOBMonth='" + DOBMonth + "' DOBDay='" + DOBDay + "' DOBYear='" + DOBYear + "' DateOfBirth='" + txtDOB.Text.Trim() + "' Age='" + txtAge.Text.Trim().Replace("'", "&apos;") + "' Gender='" + ddlGender.SelectedValue + "'" +
                                   ...
                                   " IsLocated='" + chkLocated.Checked + "'" +
                                   " ExpTime='" + hdnTimePicker.Value + "' Apprehended='" + txtApprehend.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "'  ContentCall='" + txtContentPhone.Text.Trim() + "'/>";
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                plainHtmlStr = objCommon.ReplaceShortURltoHtmlString(plainHtmlStr);
        ...
        private string BuildHTML()
        {
            ...
            try
            {
                ...
                if (txtBulletinDate.Text.Trim() != "")
                {
                    ...
                    strHtml.Append("<td width='52%' style='color: #353535; padding-top:10px;'>" + txtBulletinDate.Text.Trim() + "</td></tr>");

                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px; padding-top:10px;\">Date :</div>");
                    strPrintHtml.Append("<div style=\"float: left; width: 438px; margin-top: 5px; padding-top:10px;\">" + txtBulletinDate.Text.Trim() + "</div>");
                }
                if (chkAdult.Checked)
                {
                    strHtml.Append("<tr>");
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkAdult.Text + " </strong></div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-top: 5px;\"><br/></div>");
                }
                if (chkDependAdult.Checked)
                {
                    ...
                    strHtml.Append("</tr>");
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkDependAdult.Text + " </strong></div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-top: 5px;\"><br/></div>");
                }
                if (chkJuvenile.Checked)
                {
                    ...
                    strHtml.Append("</tr>");
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkJuvenile.Text + " </strong></div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-top: 5px;\"><br/></div>");
                }
                if (chkOther2.Checked == true && txtOther2.Text != "")
                {
                    ...
                    strHtml.Append("</tr>");
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkOther2.Text + "  </strong>:</div>");
                ...
                if (chkAmberAlert.Checked)
                {
                    ...
                    strHtml.Append("</tr>");
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkAmberAlert.Text + " </strong></div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-top: 5px;\"><br/></div>");
                }
                if (chkSilverAlert.Checked)
                {
                    ...
                    strHtml.Append("</tr>");
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkSilverAlert.Text + " </strong></div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 438px; margin-top: 5px;\"><br/></div>");
                }
                if (chkStranger.Checked)
                {
                    ...
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 400px; margin-top: 5px;\"><br/></div>");
                }
                ...
                if (chkOther1.Checked == true && txtOther1.Text != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkOther1.Text + "  </strong>:</div>");
                ...
                if (chkAtRisk.Checked == true && txtAtRisk.Text != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\"> <strong>" + chkAtRisk.Text + "  </strong>:</div>");
                ...
                if (txtLastName.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Last Name :</div>");
                ...
                if (txtFirstName.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">First Name :</div>");
                ...
                if (txtNickname.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Nickname :</div>");
                ...
                if (txtDOB.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Date of Birth :</div>");
                ...
                if (txtAge.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Age :</div>");
                ...
                if (ddlGender.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Gender/Race :</div>");
                ...
                if (height != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Height :</div>");
                ...
                if (txtWeight.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Weight :</div>");
                ...
                if (ddlEyes.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Eyes :</div>");
                ...
                if (ddlHair.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Hair :</div>");
                ...
                if (ddlCompletion.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Complexion :</div>");
                ...
                if (ddlRace.SelectedValue != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Race :</div>");
                ...
                if (txtNationality.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Nationality :</div>");
                ...
                if (txtMarks.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Distinguishing Marks :</div>");
                ...
                {
                    strHtml.Append("<tr>");
                    strHtml.Append("<td style='page-break-inside: avoid; padding: 6px 4px 8px 1px;'>Date of Last Contact :</td>");
                    strHtml.Append("<td style='page-break-inside: avoid; color: #353535;'>" + txtLCD.Text.Trim() + "</td></tr>");

                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Date of Last Contact :</div>");
                ...
                if (txtAddInfo.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; color: red; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Additional Information :</div>");
                ...
                if (txtRemarks.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; color: red; font-weight: bold; float: left; width: 165px; margin-right: 10px; margin-top: 5px;\">Remarks :</div>");
