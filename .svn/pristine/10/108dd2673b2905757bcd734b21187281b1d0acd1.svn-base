...
{
    public partial class PublicCallIndexMaster : System.Web.UI.MasterPage
    {
        ...
        {
            dtButtons = objAddOnBLL.GetPublicCallIndex_Buttons(ProfileID, Convert.ToInt32(Session["CustomModuleID"]));
            ...
            if (dtButtons.Rows.Count > 0)
            {
                ...
                if (Request.CurrentExecutionFilePath.ToString().ToLower().Contains("managepubliccallindexaddons") == true)
        ...
        private void LoadSelectedButton_Grid(string rowID = "0")
        {
            ...
            if (Request.CurrentExecutionFilePath.ToString().ToLower().Contains("managepubliccallindexaddons"))
            {
            ...
            else if (Request.CurrentExecutionFilePath.ToString().Contains("ManagePublicCallIndexContacts"))
            {
                string RedirectUrl = Page.ResolveClientUrl("~/Business/MyAccount/ManagePublicCallIndexContacts.aspx?tt=" + DateTime.Now.Second + "&rowid=" + rowID);
        ...
        protected void lnkEditButtonName_OnClick(object sender, EventArgs e)
        {
            ...
            dtCustomModuleAppIcons = objAgency.GetCustomModuleAppIcons(CustomModuleId, DomainName, false);
        ...
        protected void lnkOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtobj = objAddOn.GetAllPublicCallIndexAddOnsByorder(CustomModuleId);
        ...
        protected void OrderListView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                if (File.Exists(Server.MapPath("~") + "\\Upload\\AppThumbs\\PublicCallModules\\" + ProfileID.ToString() + "\\" + lblKey.Text + ".jpg"))
                    lblOrderThumb.Text = "<img src='" + RootPath + "/Upload/AppThumbs/PublicCallModules/" + ProfileID.ToString() + "/" + lblKey.Text + ".jpg?Guid=" + ImageDisID + "' width='50' height='20' />";
                else
                    lblOrderThumb.Text = "";
            }
        }
