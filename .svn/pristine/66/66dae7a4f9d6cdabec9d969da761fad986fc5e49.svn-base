...
{
    public partial class ManageButtons : BaseWeb
    {
        ...
        public void LoadCustomModules(bool addMobile, bool checkSettings)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManageButtons.aspx.cs", "LoadCustomModules()", ex.Message,
        ...
        {
            if (lvCustomModule.Items.Count > 0)
            {
                foreach (ListViewDataItem item in lvCustomModule.Items)
                {
            ...
            Response.Redirect(RootPath + "/Business/MyAccount/ManageButtons.aspx");
        }
