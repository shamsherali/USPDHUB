<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" Inherits="USPDHUB.Business.MyAccount.SendUpdates"
    EnableEventValidation="false" CodeBehind="SendUpdates.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function checkemailcount(id) {
            ...
            var daylimit = document.getElementById('<%=hdnlimit.ClientID %>').value;
            ...
            $get('<%= hdnSelectedEmails.ClientID%>').value = count;
        }
        ...
        function OnSuccess(result) {
            if (result == 1 & count != 0) {
                ...
                //              $get('<%=chkduplicatecont.ClientID %>').style.display = "";
                //              $get('<%=lblduplicate.ClientID %>').style.display = "";
                //              $get('<%=chkContactus.ClientID %>').style.display = "";
                //              $get('<%=lblContactus.ClientID %>').style.display = "";
            }
            if (result == 2 & count != 0) {
                $get('<%=pnltext.ClientID %>').style.display = "";
            ...
            if (count == 0) {
                ...
                $get('<%=rbtnall.ClientID %>').checked = false;
                $get('<%=rbtnemailsperday.ClientID %>').checked = false;
                //              $get('<%=chkduplicatecont.ClientID %>').style.display = "none";
                //              $get('<%=lblduplicate.ClientID %>').style.display = "none";
                //              $get('<%=chkContactus.ClientID %>').style.display = "none";
                //              $get('<%=lblContactus.ClientID %>').style.display = "none";
            }
        }
        function OnFail()
        { }
    ...
    <!-- *** Start show Edit or Createupdate *** -->
    <script type="text/javascript">
        function CallJquery() {
    ...
    <script type="text/javascript">
        ...
        if (browserName != "Microsoft Internet Explorer") {
            $(document).ready(function () {
                ...
                ifrm.style.height = '275px';
                ifrm.style.width = '490px';
                ifrm.setAttribute("scrolling", "yes");
                ifrm.setAttribute("src", document.getElementById('<%=hdnURLPath.ClientID %>').value + "/ProfileIframes/PlayVideo.aspx?DemoVideo=5233326.wmv.flv");
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="height: 32px; font-size: 18px; color: #EC2027; margin-bottom: 5px; margin-top: 5px;
                                            ...
                                            Send Content <a href="javascript:ModalHelpPopup('Email Content',162,'');">
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" width="100%" border="0" style="padding-bottom: 10px;">
                                                                    <tbody>
                                                                                ...
                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tr>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:Button ID="lnkimportcontacts" OnClick="lnkimportcontacts_Click" runat="server"
                                                                                                                        ...
                                                                                                                        Text="Select Contacts"></asp:Button>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
                                                                                        ...
                                                                                        <td valign="middle" style="padding: 0px 0px 0px 5px;" width="200px" align="center">
                                                                                            <asp:Label ID="lblUpdatethumb" runat="server" Text="No Content Thumbnail"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td height="35" class="navy20" width="520">
                                                                                                        ...
                                                                                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                                                                            <tr>
                                                                                                                <td style="padding: 0px 0px 0px 10px;">
                                                                                                                    <asp:RadioButton ID="rbtnall" runat="server" GroupName="rbtnsendrschedule" TabIndex="4"
                                                                                                                        AutoPostBack="true" OnCheckedChanged="rbtnall_SelectedIndexChanged" />
                                                                                                                </td>
                                                                                                        ...
                                                                                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" style="padding: 0px 10px 0px 50px;">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="padding: 0px 0px 10px 0px;">
                                                                                                                    <asp:RadioButton ID="rbtnemailsperday" runat="server" AutoPostBack="true" GroupName="rbtnsendrschedule"
                                                                                                                        OnCheckedChanged="rbtnemailsperday_SelectedIndexChanged" TabIndex="5" onclick="CPcheckpostback()" />
                                                                                                                </td>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    <td height="30" class="navy20">
                                                                                        Step 5: Add Links That Will Appear on Your Email
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #04519D;">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:CheckBox runat="server" ID="chkContactus"></asp:CheckBox>&nbsp;<asp:Label
                                                                                                        runat="server" ID="lblContactus" Text="Contact Us"></asp:Label>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-top: 5px; padding-left: 170px;" align="left">
                                                                                        <asp:LinkButton ID="lnkCancelMail" runat="server" CausesValidation="false" TabIndex="10"
                                                                                            OnClick="lnkCancelMail_Click"><img src="../../images/Dashboard/cancel_button.gif" alt=""/></asp:LinkButton>
                                                                                        <asp:LinkButton ID="lnktestbusinessUpdate" runat="server" OnClick="lnktestbusinessUpdate_Click"
                                                                                            CausesValidation="false"><img src="../../images/Dashboard/send-testemail.png" alt=""/></asp:LinkButton>
                                                                                        <asp:LinkButton ID="lnkSendmail" runat="server" OnClick="lnkSendmail_Click" ValidationGroup="g"
                                                                                            TabIndex="9" OnClientClick="return validateRemainingMails();"><img src="../../images/Dashboard/send_button.gif" alt=""/></asp:LinkButton>
                                                                                        <asp:LinkButton ID="lnkSchEmail" runat="server" OnClick="lnkSchEmail_Click" ValidationGroup="g"
                                                                                            TabIndex="9" OnClientClick="return validateRemainingMails();"><img src="../../images/Dashboard/scheduleandsend_button.gif" alt=""/></asp:LinkButton>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                            ...
                                            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="padding-top: 20px;">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtMailSubject" Text="Test Update Campaign" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr style="padding-top: 20px; padding-bottom: 10px;">
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btntestsend" runat="server" OnClick="btntestsend_Click" Text="Send Test Update"
                                                                ValidationGroup="t" />
                                                        </td>
                                                    </tr>
                                                </tbody>
            ...
            <script type="text/javascript">
                //              document.getElementById('<%=chkduplicatecont.ClientID %>').style.display="none";
                //              document.getElementById('<%=lblduplicate.ClientID %>').style.display="none";
                //              document.getElementById('<%=chkContactus.ClientID %>').style.display="none";
                //              document.getElementById('<%=lblContactus.ClientID %>').style.display="none";
