<%@ Page Title="" Language="C#" MasterPageFile="~/Business/MyAccount/CallIndexMaster.Master"
    AutoEventWireup="true" CodeBehind="ManageCallIndexAddOns.aspx.cs" Inherits="USPDHUB.Business.MyAccount.ManageCallIndexAddOns" %>
                                                            ...
                                                            <td valign="top">
                                                                <div class="GridDock" id="dvGridWidth" style="border: 1px solid #428ad7;">
                                                                    <asp:GridView ID="GrdCallIndex" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                        ...
                                                                        PageSize="5" AllowPaging="True" OnPageIndexChanging="GrdCallIndex_PageIndexChanging"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <%--  <asp:TemplateField HeaderText="Select">
                                                                                ...
                                                                                <ItemStyle Width="30px" VerticalAlign="Top"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField>
                                                                                <HeaderTemplate>
