...
{
    public partial class PrintPressRelease : System.Web.UI.Page
    {
        public int UserID = 0;
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "PrintPressRelease.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
            ...
            try
            {
                ...
                if (addflag)
                {
                    ...
                    BulletinXML = "<Bulletin Case='" + txtCase.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' ReleaseDate='" + txtDate.Text + "' ReleaseHours='" + txtTimeHours.Text + "'  ReleaseMin='" + txtTimeMins.Text + "'  ReleaseAMPM='" + ddlDateTime.SelectedValue.ToString() + "'  Location='" + txtlocation.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' CrimeOffence='" + txtCrimeOffence.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' Suspects='" + txtSuspects.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "'" +
                                    "  Vehicle='" + txtVehicle.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "'  Weapon='" + txtWeapon.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "'  Summary='" + txtSummary.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' InvestOfficer='" + txtInvestOfficer.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' PressReleasePrepareby='" + txtPreparedbBy.Text.Trim().Replace("'", "&apos;").Replace("&", "&amp;") + "' ExpDate='" + txtExpires.Text.Trim() + "'" +
                    ...
                    if (Session["C_USER_ID"] != null && Session["C_USER_ID"].ToString() != "")
                    {
                        ...
                        {
                            BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBID, BulletinName, BulletinHtml, BulletinXML, C_UserID, C_UserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false, chkContact.Checked, IsPublish, dateExpires, datePublish, ddlCategories.SelectedValue, false, id, printerHtml);
                            if (IsPrivate == true)
                        ...
                        {
                            if (IsPrivate == true)
                                BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBID, BulletinName, BulletinHtml, BulletinXML, C_UserID, C_UserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false, chkContact.Checked, IsPublish, dateExpires, datePublish, ddlCategories.SelectedValue, IsPrivate, C_UserID, printerHtml);
                            else
                                BulletinID = objBulletin.Insert_Update_BulletinDetails(BulletinID, TemplateBID, BulletinName, BulletinHtml, BulletinXML, C_UserID, C_UserID, Convert.ToBoolean(hdnArchive.Value), UserID, ProfileID, chkCall.Checked, false, chkContact.Checked, IsPublish, dateExpires, datePublish, ddlCategories.SelectedValue, IsPrivate, id, printerHtml);
                        }
                    }
                    else
                    {
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "PrintPressRelease.aspx.cs", "lnkPreview_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private string BuildHTML()
        {
            try
            {
                ...
                {
                    /*strHtml.Append("<div style=\"overflow: hidden; float: left; width: 100%;\">");
                    strHtml.Append("<div align='left' style=\"float: left; text-align: left; width: 90%; padding: 3px 0px 0px 0px; margin: 2px 5px 0px 10px;\">Vehicle :</div>");
                    strHtml.Append("<div align='left' style=\"color: #353535; padding: 3px 0px 0px 0px; margin: 2px 0px; margin-left:15px; width: auto;\"><label style=\"float: left; text-align: left;\">" + txtVehicle.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</label></div></div>");*/
                    strHtml.Append("<tr>");
                    strHtml.Append("<td colspan='2' style='page-break-inside: avoid; padding: 6px 4px 0px 4px;'>Vehicle :</td></tr><tr>");
                    strHtml.Append("<td colspan='2' style='page-break-inside: avoid; color: #353535; padding-left: 8px;'>" + txtVehicle.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</td></tr>");

                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 110px; margin-right: 10px; margin-bottom: 10px;\">Vehicle:</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 490px; margin-bottom: 10px;\">" + txtVehicle.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                //*** weapon
                if (txtWeapon.Text.Trim() != "")
                {
                    /*strHtml.Append("<div style=\"overflow: hidden; float: left; width: 100%;\">");
                    strHtml.Append("<div align='left' style=\"float: left; text-align: left; width: 90%; padding: 3px 0px 0px 0px; margin: 2px 5px 0px 10px;\">Weapon :</div>");
                    strHtml.Append("<div align='left' style=\"color: #353535; padding: 3px 0px 0px 0px; margin: 2px 0px; margin-left:15px; width: auto;\"><label style=\"float: left; text-align: left;\">" + txtWeapon.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</label></div></div>");*/
                    strHtml.Append("<tr>");
                    strHtml.Append("<td colspan='2' style='page-break-inside: avoid; padding: 6px 4px 0px 4px;'>Weapon :</td></tr><tr>");
                    strHtml.Append("<td colspan='2' style='page-break-inside: avoid; color: #353535; padding-left: 8px;'>" + txtWeapon.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</td></tr>");

                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 110px; margin-right: 10px; margin-bottom: 10px;\">Weapon:</div>");
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; float: left; width: 490px; margin-bottom: 10px;\">" + txtWeapon.Text.Trim().Replace("\r\n", "<br/>").Replace("\n", "<br/>") + "</div>");
                }
                //*** Summary
                ...
                if (txtInvestOfficer.Text.Trim() != "")
                {
                    ...
                    strHtml.Append("<tr>");
                    strHtml.Append("<td colspan='2' style='page-break-inside: avoid; padding: 6px 4px 0px 4px;'>Investigating Officer :</td></tr><tr>");
                    ...
                    strPrintHtml.Append("<div style=\"page-break-inside: avoid; font-weight: bold; float: left; width: 210px; margin-right: 10px; margin-bottom: 10px;\">Investigating Officer:</div>");
