<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="CMChiefsMessage.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.CMChiefsMessage" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
                <div id="wrapper">
                    <div class="headernav">
                        <%=BulletinName %>Chief Message<asp:TextBox ID="txt" runat="server" Width="0" BorderStyle="none"
                    ...
                    <div class="contentwrap">
                        <div class="largetxt">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtChiefName"
                                ...
                                ErrorMessage="Chief Name is mandatory." Style="font-size: 14px;">*</asp:RequiredFieldValidator>&nbsp;
