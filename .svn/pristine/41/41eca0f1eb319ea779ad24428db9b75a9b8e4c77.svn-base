<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="MissingPerson.aspx.cs" Inherits="UserForms.MissingPerson" ValidateRequest="false" %>
                    ...
                    <div class="contentwrap">
                        ...
                        <div class="form_wrapper">
                                ...
                                <div style="float: left; text-align: left; width: 550px; padding: 3px 0px 0px 0px;
                                    ...
                                    <label>
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="CheckBox1" runat="server" Text="dummyCheckbox" Style="display: none;" />
                            ...
                            <div class="fields_wrap ">
                                <div class="left_lable">
                                    <span style="padding-left: 2px;">&nbsp;</span><label>
                                        <img style="vertical-align:middle" src="<%=RootPath %>/Images/content_call.png"/> Number: </label>
                                </div>
                                <div class="right_fields">
                            ...
                            <div class="fields_wrap">
                                ...
                                <div class="right_fields">
                                    ...
                                    <asp:TextBox runat="server" ID="txtApprehend" placeholder="Located" Text="Located"
    ...
    <script type="text/javascript">
        ...
        function BindImages(typeValue) {
            ...
            if (document.getElementById("<%=txtExpires.ClientID %>").value != "" && typeValue == 1) {
                ...
                document.getElementById("<%=hdnTimePicker.ClientID %>").value = document.getElementById(controlName).value;
