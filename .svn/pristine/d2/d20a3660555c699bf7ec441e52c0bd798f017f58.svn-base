<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventAnnouncement.aspx.cs"
    Inherits="UserForms.EventAnnouncement" MasterPageFile="~/Admin.Master" ValidateRequest="false" %>
    ...
    <script type="text/javascript">
        ...
        function PreviewHTML(typeID) {
           ...
           var Rows = '';
            ...
            Rows = Rows + "<tr><td colspan='2' style='padding:5px; font-size: 26px; line-height: 28px; font-weight: normal; color: #f15b29; text-align: center; border-bottom: 1px dashed #d1d1d1;'>Event Announcement</td></tr>";
            if (Date != '') {
        ...
        function ShowExTimeDiv() {
            ...
            if (document.getElementById("<%=txtExDate.ClientID %>").value == "" || document.getElementById("<%=txtExDate.ClientID %>").value == "MM/DD/YYYY") {
                document.getElementById('<%=ExpiryTimeControl1.FindControl("ddlTime").ClientID %>').disabled = true;
            }
            else {
                document.getElementById('<%=ExpiryTimeControl1.FindControl("ddlTime").ClientID %>').disabled = false;
            }
        }
        ...
        function ValidateAMPM() {
            if (document.getElementById("<%=txtStartExHours.ClientID %>").value != "" && document.getElementById("<%=txtEndExHours.ClientID %>").value != "") {
                if (document.getElementById("<%=ddlStartExSS.ClientID %>").value == 'PM' && document.getElementById("<%=ddlEndExSS.ClientID %>").value == 'AM') {

                    document.getElementById("<%=ddlEndExSS.ClientID %>").value = 'PM';
            ...
            if (document.getElementById("<%=txtStartExHours.ClientID %>").value != "") {
                ...
                if (document.getElementById("<%=txtStartExHours.ClientID %>").value != '' && document.getElementById("<%=txtStartExHours.ClientID %>").value != 'Hour') {
                    ...
                    if (document.getElementById("<%=ddlStartExSS.ClientID %>").value == 'AM' && selHours == 12)
                        selHours = 0;
                    if (document.getElementById("<%=ddlStartExSS.ClientID %>").value == 'PM' && selHours < 12)
                        selHours += 12;
                }
                if (document.getElementById("<%=txtStartExMinutes.ClientID %>").value != '' && document.getElementById("<%=txtStartExMinutes.ClientID %>").value != 'Minutes')
            ...
            if (document.getElementById("<%=txtEndExHours.ClientID %>").value != "") {
                ...
                if (document.getElementById("<%=txtEndExHours.ClientID %>").value != '' && document.getElementById("<%=txtEndExHours.ClientID %>").value != 'Hour') {
                    ...
                    if (document.getElementById("<%=ddlEndExSS.ClientID %>").value == 'AM' && selHours == 12)
                        selEndHours = 0;
                    if (document.getElementById("<%=ddlEndExSS.ClientID %>").value == 'PM' && selHours < 12)
                        selEndHours += 12;
                }
                if (document.getElementById("<%=txtStartExMinutes.ClientID %>").value != '' && document.getElementById("<%=txtStartExMinutes.ClientID %>").value != 'Minutes')
                    ...
                    <div class="form_wrapper" style="float: none; width: auto;">
                     <div class="largetxt">
                        ...
                        <div class="fields_wrap ">
                            ...
                            <div class="right_fields">
                                <asp:TextBox ID="txtPhoneNumber" onkeyup="transform(this);" runat="server"></asp:TextBox>
                                <%--placeholder="hh.mmAM/PM"--%>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularDate" runat="server" ControlToValidate="txtExDate"
                                                        ...
                                                        ValidationGroup="EA" ErrorMessage="Invalid Date Format">*</asp:RegularExpressionValidator><br />
