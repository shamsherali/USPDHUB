<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="KPDMediaRelease1.aspx.cs" Inherits="UserForms.KPDMediaRelease1" ValidateRequest="false"
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphUser" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var maintable = document.getElementById("<%=hdnEditHTML.ClientID %>").Value;
            $("#maintable").tableDnD();
                                ...
                                "<div class=\"PersonIncident\" id=\"edit" + CID + "\"> " +
                                    ...
                                    "<tr>" + // DOB
                                        "<td><span style='font-weight:bold;'>Date of Birth:</span></td>" +
                                            "<td><input type='text' style='font-weight:bold;' id='txtDOB" + CID + "' name='txtDOB" + CID + "' onblur='CalculateAge(this)' /></td>" +
                                    "</tr>" +
        ...
        function checkTotal(imgInput, countInput, crimeInput, bailInput, trEdit, CID) {
            ...
            if (countValue != '' && crimeValue != '' && bailValue != '') {
                ...
                var arrestnewtable = "<div id='divpreviewcount" + CID + "' style='width:100%;'><table style='text-align: left; width:100%;' class='tblpreviewcount' id='tblpreviewcount" + CID + "' cellpadding=\"2\" cellspacing=\"0\" width='100%'> " +
                                            "<tr id='firsttr" + CID + "'>" +
                                            "<th>COUNTS</th>" +
                                            "<th>CRIME</th>" +
                            ...
                            "<td class='drop ui-sortable' style='min-height: 20px;'>" +
                             "<div id='trheader" + CID + "' >" +
                                 ...
                                 "<div class='Div" + headerTitle + "' id=\"edit" + CID + "\" style='float: left; margin-top: 10px;'> " +
                                            ...
                                            "<br/><img class='deleteblockclass'  src='../../Images/Remove.png'  style='cursor: pointer; padding-top: 5px; margin-left:5px;' onclick='RemoveBlock(trheader" + CID + "," + CID + ")' />" +
                                             "</div>" +
                                    " <br/> <table id='tblAuthorDetails' cellpadding=\"2\" cellspacing=\"0\" width='100%' class='authorClass'> " +
                                     "<tr>" + // Author Title
        ...
        function PreviewHTML(type) {
            ...
            if ($('#maintable tr').length > 0) {
                $('#maintable .PersonIncident, #maintable .VehicleIncident, #maintable .DivSummary, #maintable .DivImages, #maintable .DivAuthor').each(function () {
                    ...
                    if ($(this).attr("class") == 'PersonIncident') { // *** Start of person
                        ...
                        //Print HTML
                        printHTML = "<table class='radius' id='tblprint" + i + "' cellpadding='0' cellspacing='0' width='100%' style='border-bottom: 0px solid black; margin-top:5px;'>" + printHTML + "</table>";
                        ...
                        //Print HTML
                        printHTML = "<table class='radius' id='tblprint" + i + "' cellpadding='0' cellspacing='0' style='border-bottom: 0px solid black; margin-top:4px;' width='100%'>" + printHTML + "</table>";
                        childTable = childTable + childRow;
                        //Print HTML
                        totalPrintHTML = totalPrintHTML + printHTML;
                    ...
                    else if ($(this).attr("class") == 'DivSummary') // *** Start of Summary
                    {
                        ...
                        //Print HTML
                        printHTML = "<table class='radius' id='tblprintsummary" + i + "' cellpadding='0' cellspacing='0' style='margin-top:5px;' width='100%'>" + printHTML + "</table>";
                        childTable = childTable + childRow;
                        //Print HTML
                        totalPrintHTML = totalPrintHTML + printHTML;
                    ...
                    else if ($(this).attr("class") == 'DivAuthor') // *** Start of Author
                    {
                        ...
                        //Print HTML
                        printHTML = "<table class='radius' id='tblprintauthr' cellpadding='0' cellspacing='0' style='margin-top:5px;' width='100%'>" + printHTML + "</table>";
                        childTable = childTable + childRow;
                        //Print HTML
                        totalPrintHTML = totalPrintHTML + printHTML;
                    } // *** End of Author
            ...
            /*** final html string ***/
            previewHTMLStr = "<table cellpadding='0' cellspacing='0' style='padding-left:0px; text-align:left; border:1px solid black;'>" + firstBorder + sencodBoder + "</table>";

            //previewHTMLStr = previewHTMLStr + "</div>";
            //Print HTML
            printHTMLStr = "<table cellpadding='0' cellspacing='0' style='padding-left:0px; margin-top:20px; text-align:left; border:1px solid black;'>" + printfirstBorder + printsecondBorder + "</table>";
                            ...
                            <div class="fields_wrap ">
                                ...
                                <div class="right_fields" style="width: 470px;">
                                    <table width="85%" cellpadding="0" cellspacing="0" id='tblExTime'>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtExpires" runat="server" Width="100px" Height="18px" onChange="ShowExTimeDiv();"></asp:TextBox>
