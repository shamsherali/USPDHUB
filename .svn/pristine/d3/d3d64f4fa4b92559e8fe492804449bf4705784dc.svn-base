...
namespace USPDHUB.Business.MyAccount
{
    public partial class ContentDownload : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (!IsPostBack)
                {
                    ...
                    if (Convert.ToInt32(Session["BulletinID"]) == 0 && Session["BulletinID"] != null && Session["BulletinID"].ToString() != "")
                    {
                        ...
                        lblBulletinedit.Text = "<table width=\"450\" id=\"maintable\" style=\"border: 0px solid gray; border-image: none;" +
    "min-height: 100px;\" cellspacing=\"2\" cellpadding=\"2\">" +
    "<tbody>" +
        "<tr id=\"tr1\">" +
            "<td class=\"drop ui-sortable\" style=\"min-height: 20px;\">" +
                "<div class=\"assigned\" id=\"parentedit1\" style=\"margin-top: 10px; float: left;\">" +
                    "<div class=\"textdivStyle\" id=\"edit1\" style=\"padding: 5px; text-align: left; float: left;" +
                        "min-height: 100px;\">" +
                       "" +
                         "</div>" +
                   " <div class=\"editsectionclass\" id=\"editsection1\" style=\"float: left;\">" +
                     "   <img style=\"margin-left: 5px; cursor: pointer;\" onclick=\"EditImage(edit1)\" src=\"../../Images/EditImage.png\"><br>" +
                      "  <img class=\"deleteblockclass\" style=\"padding-top: 5px; margin-left: 5px; cursor: pointer;\"" +
                       "     onclick=\"RemoveBlock(edit1)\" src=\"../../Images/Remove.png\"></div>" +
                "</div>" +
            "</td>" +
       " </tr>" +
   " </tbody>" +
"</table>";
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "Page_Load", ex.Message,
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void BtnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "BtnCancel_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "BtnCancel_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "BtnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "BtnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void BtnPublish_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "BtnPublish_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                if (rbPublic.Checked)
                    publishValue = "2";
                if (ValidatePublishDate())
                {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "BtnPublish_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        private void GetBulletinDetails()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "GetBulletinDetails", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (dtBulletinDetails.Rows.Count > 0)
                {
                    ...
                    Session["TemplateBID"] = dtBulletinDetails.Rows[0]["Template_BID"].ToString();
                    ...
                    if (!string.IsNullOrEmpty(Convert.ToString(dtBulletinDetails.Rows[0]["Custom_XML"])))
                    {
                        string xmlSettings = Convert.ToString(dtBulletinDetails.Rows[0]["Custom_XML"]);
                        var xmlTools = XElement.Parse(xmlSettings, LoadOptions.PreserveWhitespace);
                        txtPDFLink.Text = Convert.ToString(xmlTools.Element("Content").Attribute("PDFUrl").Value);
                    }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "GetBulletinDetails", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private void Save_Update_BulletinDetails()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "Save_Update_BulletinDetails", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                int templateBid = Convert.ToInt32(Session["TemplateBID"]);
                ...
                string ContentCustomXML = "";
                ContentCustomXML = "<Contents><Content  PDFUrl='" + txtPDFLink.Text.Trim() + "'  ";
                ContentCustomXML = ContentCustomXML + "></Content></Contents>";

                string CategoryValue = ddlCategories.SelectedValue;
                ...
                if (exDate == string.Empty)
                {
                    ...
                    if (Session["C_USER_ID"] != null && Session["C_USER_ID"].ToString() != "")
                    {
                        if (hdnPermissionType.Value == "A" && (!string.IsNullOrEmpty(hdnPermissionType.Value)))
                        {
                            ...
                            CategoryValue, false, id, "", ContentCustomXML, ListDescription);
                            if (isPrivate == true)
                        ...
                        else if (hdnPermissionType.Value == "P" && (!string.IsNullOrEmpty(hdnPermissionType.Value)))
                        {
                            if (isPrivate == true)
                            {
                                ...
                                datePublish, CategoryValue, isPrivate, CUserID, "", ContentCustomXML, ListDescription);
                            }
                            else
                            {
                                bulletinID = objBulletin.Insert_Update_BulletinDetails(bulletinID, templateBid, bulletinTitle, previewHtml,
                                editHtmlText, CUserID, CUserID, isArchive, UserID, ProfileID, isCall, isPhotoCapture, isContactUs, isPublish, null,
                                datePublish, CategoryValue, isPrivate, id, "", ContentCustomXML, ListDescription);
                            }
                        }
                    }
                    else
                    {
                        if (isPrivate == true)
                        {
                            bulletinID = objBulletin.Insert_Update_BulletinDetails(bulletinID, templateBid, bulletinTitle, previewHtml,
                            editHtmlText, CUserID, CUserID, isArchive, UserID, ProfileID, isCall, isPhotoCapture, isContactUs, isPublish, null, datePublish,
                            CategoryValue, isPrivate, CUserID, "", ContentCustomXML, ListDescription);
                        }
                        else
                        {
                            bulletinID = objBulletin.Insert_Update_BulletinDetails(bulletinID, templateBid, bulletinTitle, previewHtml,
                            editHtmlText, CUserID, CUserID, isArchive, UserID, ProfileID, isCall, isPhotoCapture, isContactUs, isPublish, null, datePublish,
                            CategoryValue, isPrivate, id, "", ContentCustomXML, ListDescription);
                        }
                    }
                }
                else
                {
                    ...
                    if (Session["C_USER_ID"] != null && Session["C_USER_ID"].ToString() != "")
                    {
                        ...
                        if (hdnPermissionType.Value == "A" && (!string.IsNullOrEmpty(hdnPermissionType.Value)))
                        {
                            ...
                            datePublish, CategoryValue, false, id, "", ContentCustomXML, ListDescription);
                            if (isPrivate == true)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            expiryDate, datePublish, CategoryValue, isPrivate, id, "", ContentCustomXML, ListDescription);
                        }
                    }
                }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "Save_Update_BulletinDetails", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private bool ValidatePublishDate()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "ValidatePublishDate", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "ValidatePublishDate", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return false;
            }
        }
        ...
        private string BuildHeader()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ContentDownload.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }

        protected void btndummyDownload_OnClick(object sender, EventArgs e)
        {
            try
            {
                string VirtualPath = Server.MapPath("~/Upload/PDFDownloadDummy");
                string filename;
                ...
                using (var client = new WebClient())
                {
                    ...
                    filename = Path.GetFileName(txtPDFLink.Text);
                    VirtualPath = VirtualPath + "/" + filename;
                    client.DownloadFile(txtPDFLink.Text.Trim(), VirtualPath);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ContentDownload.aspx.cs", "btndummyDownload_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
