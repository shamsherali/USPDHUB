<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    ValidateRequest="false" CodeBehind="MostWanted.aspx.cs" Inherits="UserForms.MostWanted" %>
    ...
    <script type="text/javascript">
        ...
        function GetCurrentDate() {
            $.ajax({
                ...
                url: "MostWanted.aspx/GetUserTimeZoneDashboard",
                dataType: "json",
            ...
            //                                            "</tr>" +
                                            ...
                                            "</tr>" +
                                             "<tr>" + // Age
                                                ...
                                                "<td><input type='text' style='font-weight:bold;' id='txtAge" + CID + "' name='txtAge" + CID + "' onkeyup='integersOnly(this)'/></td>" +
                                            "</tr>" +
                                            "<tr>" + // Warrant Date
        ...
        function EditImage(value, parentID) {
            ...
            ifrm.setAttribute("src", '<%=RootPath %>' + "/Business/MyAccount/BulletinsForm_ImageGallery.aspx?fitblockwidth=" + (document.getElementById(imgdivID).offsetWidth - 12) + "&imgSrc=" + imgSrc + "&folder=Forms");
        ...
        function PreviewHTML(type) {
            ...
            //ROWS = ROWS + "<tr><td  style='height:15px; padding:0px 5px 10px; font-weight: bold;' colspan='2'></td></tr>";
            if (Description != "") {
                //HTML
                IsContactAdd = true;
            ...
            if (divtable != "") {
                ...
                $('#maintable tr.trheader').each(function () {
                    ...
                    if (Feet != "") {
                        // XML
                        childXMLElements = childXMLElements + " Feet='" + Feet + "' ";
                        Feet = Feet + "'";
                    }
                    if (Inches != "") {
                        // XML
                        childXMLElements = childXMLElements + " Inches='" + Inches + "' ";
                        Inches = Inches + "''";
                    }
                    if (Feet != "" || Inches != "") {
                        // HTML
            ...
            var titleName = "<div id='divTitle' style=\"background: #fffdfb; overflow: hidden; width: auto; margin: 0px; padding: 15px 0px 40px 0px;\">" +
                                "<div style=\"font-size: 26px; line-height: 28px; font-weight: normal; color: #f15b29; text-align: center; padding: 0px 0px 10px 0px; border-bottom: 1px dashed #d1d1d1;\">Most Wanted</div>";
