<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTools.aspx.cs" Inherits="USPDHUB.OP.inschoolhubin.AddTools" %>
                        ...
                        <div align="right">
                            <p>
                                <a href="Default.aspx">Home</a> | <a href="ContactUs.aspx">Contact Us</a> | <a href="features.html">
                                    Features</a> | <a href="Javascript:void(0);" class="active">Pricing</a> | <a href="aboutus.html">About
                                        Us</a> | <a href="login.aspx">Login</a> <%--<a onmouseover="changeImages('social_facebook','<%=Page.ResolveClientUrl("~/images/ISHOuterImages/social-facebook-over.gif")%>');return true"
            ...
            <div class="contentblock">
                <div class="contentblock">
                        ...
                        <p>
                            <a onmouseover="changeImages('button_signup','/images/ISHOuterImages/button-signup-over.jpg');return true"
                                ...
                                <img id="button_signup" src="/images/ISHOuterImages/button-signup.jpg" alt="" name="button_signup"
                                    width="116" height="30" border="0"></a>
                        </p>
                        <br />
                    </div>
                    <br />
                    <div class="signup1">
                        ...
                        <span>Sponsor</span> of the inSchoolHub
                        <br />
                        for schools in your community, 
                        <a href="/ISH/sponsor.html" target="_blank"><span>learn more</span></a> or call us at 800-281-0263--%></div>
                    <br />
                </div>
            </div>
            <div id="pricingcol2">
