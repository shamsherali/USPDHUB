...
{
    public partial class ChiefsMessageForm : BaseWeb
    {
        public int UserID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "Page_Load", ex.Message, Convert.ToString(ex.StackTrace),
        ...
        private void LoadDefaultData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "LoadDefaultData", ex.Message, Convert.ToString(ex.StackTrace),
                    Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void LoadFormData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "LoadFormData", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                //Getting and Assigning Expiration Time
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "LoadFormData", ex.Message,
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "btnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                //Check the Expiration Date & Time with Current date and Insert the Expiration Date & Time
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "btnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "btnCancel_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "btnCancel_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "lnkPreview_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "lnkPreview_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private string BuildHtml()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "BuildHTML", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (txtadditionalText.Text.Trim() != "")
                {
                    ...
                    // PDF Print HTML
                    //strPrintHtml.Append("<div style=\"color: red; font-weight: bold; float: left; width: 130px; margin-right: 10px; margin-bottom: 10px;\">Additional Details :</div>");
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "BuildHTML", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        ...
        private string BuildHeader()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "ChiefsMessageForm.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ChiefsMessageForm.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
