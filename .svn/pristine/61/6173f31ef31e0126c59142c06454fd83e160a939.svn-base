<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupPSCInvitations.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.SetupPSCInvitations" MasterPageFile="~/Business/MyAccount/PrivateSmartConnect.master" %>
                ...
                <asp:Panel runat="server" ID="pnlSetup">
                    <div class="row-wrapper">
                        <div class="leftcol">
                            ...
                            Setup Contacts and manage groups to email invitations for viewing your Private QR Connect buttons.
                        </div>
                    ...
                    <div class="row-wrapper">
                        <div class="leftcol">
                            ...
                            Send Invitations to contacts so that the Private QR Connect Button will display
                            on their device.
                            <br />
                            <br />
                            <b>Note</b>: The Private QR Connect Button will only display on devices that
