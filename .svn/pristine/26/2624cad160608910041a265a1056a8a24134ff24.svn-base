<%@ Page Title="" Language="C#" MasterPageFile="~/PaidTools.master" AutoEventWireup="true"
    CodeBehind="EditBulletin2.aspx.cs" ValidateRequest="false" Inherits="USPDHUB.Business.MyAccount.EditBulletin2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PreviewHTML(typeID) {
            ...
            if (EntID == 1) {
                ...
                $.ajax({
                    ...
                    url: "EditBulletin2.aspx/ReplaceShortURltoHmlString",
                    dataType: "json",
                    processData: false,
                    success: function (data) {
                        bulletinHeader = data.d;
                        //alert(bulletinHeader);
        ...
        function RemoveBlock(value) {
            ...
            if (confirm("Are you sure you want to delete this block?")) {
                var parenttrid = $("#" + divID).closest('tr').attr('id');
                $("#" + divID).remove();
                var childdivsCount = $("#" + parenttrid + " div").size();
                if (childdivsCount == 0)
                    $("#" + parenttrid).remove();
                    ...
                    for (j = 0; j < divtable.rows[i].cells.length; j++) {
                        for (k = 0; k < divtable.rows[i].cells[j].children.length; k++) {
                            ...
                            if (divtable.rows[i].cells[j].children[k].tagName == "DIV") {
                                ...
                                //Adding Span tags
                                if (getHTML.indexOf('span') <= 0) {
                                    getHTML = "<span style='font-weight: normal; font-style: normal; text-decoration: none; color: black; font-size: 16px; font-family: Arial; text-align: left; display: block;'>" + getHTML + "</span>";
                                }
                                ...
                                if (commandName == "Bold") {
                                    ...
                                    var newColorName = button.get_value().toLowerCase();

                                    for (a = 0; a < colorDropDown.get_buttons().get_count(); a++) {
                                        var oldColor = colorDropDown._getAllItems()[a].get_value().toLowerCase();
    ...
    <div id='editorPopup' style="display: none; position: absolute; margin-top: 150px;
        ...
        <uc2:UCEditor ID="loginbox" runat="server" />
    </div>
                    ...
                    <div class="form_wrapper" style="float: none; width: auto;">
                        ...
                        <div class="stepswrapmain">
                                    ...
                                    <telerik:RadToolBar ID="Maintoolbar" Width="472" runat="server" OnClientButtonClicking="Maintoolbar_OnClientButtonClicking"
                                        ...
                                        <Items>
                                            ...
                                            <telerik:RadToolBarDropDown Text="Black" Enabled="false">
                                                <Buttons>
                                                    <telerik:RadToolBarButton Text="Black" Group="MainColor" Value="Black">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Blue" Group="MainColor" Value="Blue">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Fuchsia" Group="MainColor" Value="Fuchsia">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Gray" Group="MainColor" Value="Gray">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Green" Group="MainColor" Value="Green">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Red" Group="MainColor" Value="Red">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Yellow" Group="MainColor" Value="Yellow">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Brown" Group="MainColor" Value="rgb(93, 73, 4)">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton Text="Gold" Group="MainColor" Value="rgb(214, 177, 56)">
                                                    </telerik:RadToolBarButton>
                                                </Buttons>
                                            </telerik:RadToolBarDropDown>
                            ...
                            <div style="float: left; margin: 65px 0px 0px 300px;">
                                ...
                                <a id="A1" href="javascript:ModalHelpPopup('Add Text to Content Template',192,'');">
                                ...
                                <div class="right_fields">
                                    <div style="margin: 0px 0px 0px 0px;">
                                        <table cellpadding="0" cellspacing="0" id='tblExTime'>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtExDate" runat="server" Width="100px" onChange="ShowExTimeDiv();" Height="18px"></asp:TextBox>
