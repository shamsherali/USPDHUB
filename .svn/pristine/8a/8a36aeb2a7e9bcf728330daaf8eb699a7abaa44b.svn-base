...
{
    public partial class EditBulletin2 : BaseWeb
    {
        public int UserID = 0;
        ...
        private void Save_Update_BulletinDetails()
        {
            try
            {
                ...
                string customXML = "";
                customXML = "<Bulletins><Details  IsLocated='" + chkLocated.Checked + "' LocatedText='" + txtLocated.Text.Trim() + "' " +
                " ContentCall='" + txtContentPhone.Text.Trim() + "'  /> </Bulletins>";
                    ...
                    */
                    ...
                    if (Session["C_USER_ID"] != null && Session["C_USER_ID"].ToString() != "")
                    {
                        ...
                        if (hdnPermissionType.Value == "A" && (!string.IsNullOrEmpty(hdnPermissionType.Value)))
                        {
                            ...
                            datePublish, ddlCategories.SelectedValue, false, id, "", customXML, ListDescription);
                            if (isPrivate == true)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            expiryDate, datePublish, ddlCategories.SelectedValue, isPrivate, id, "", customXML, ListDescription);
                        }
                    }
                }
                /************************************ Auto Share ***************************************/
        ...
        public static string BuildWatermarkImage(string htmlString, string locatedText, bool IsLocated)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "EditBulletin2.aspx.cs", "BuildWatermarkImage", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
        ...
        public static string BuildLocatedImage_Dynamically(string htmlString, string imgname = "")
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "EditBulletin2.aspx.cs", "BuildLocatedImage_Dynamically newImgPath:" + newImgPath
