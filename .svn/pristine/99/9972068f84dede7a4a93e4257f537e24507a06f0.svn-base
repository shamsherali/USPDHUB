<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeBehind="CallIndexAutoMessage.aspx.cs" Inherits="USPDHUB.Business.MyAccount.CallIndexAutoMessage"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="server">
    ...
    prm.add_endRequest(function () {
        //CountMaxLength(this, event, 'callIdentityCount');
        ...
        function Show_Hide_EmailMessageDivs() {
            ...
            $("#divSettings3").css("display", "none");
            $("#tblIncludeImage").css("display", "block");
            ...
            if (IsShowSetting) {
                ...
                $("#tblIncludeImage").css("display", "none");
              
                document.getElementById("<%=chkImage.ClientID %>").checked = false;
            }
        }
        ...
        function ValidateGroupSelection(controlID) {
            ...
            if (controlID == "1")
                ...
                gName = document.getElementById("<%=ddlPushGroup.ClientID %>").value;
            else if (controlID == "3")
                    ...
                    <tr>
                        ...
                        <td>
                            <table style="margin-bottom: 30px;">
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtCallBtnIdentity" runat="server" onkeyup="CountMaxLength(this,event,'callIdentityCount')" MaxLength="30" Width="300px"></asp:TextBox>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCallBtnIdentity" runat="server" Display="Dynamic"
                                            ...
                                            <p>You have (<span id="callIdentityCount">30</span>) characters left</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="ChkIsInitiatesPhoneCall" runat="server" Checked="true" Text="Initiate Phone Call"
                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="2" cellspacing="2" class="group-selection">
                                    <tr>
                                        ...
                                        <td align="left" style="width:189px">
                                            <asp:Label ID="lblChkEmail" runat="server" Text="Send auto email"></asp:Label>
                                            <span class="couponcode">
                                                <img border="0" src="../../images/Dashboard/new.png" />
                                                <span class="coupontooltip">Send auto email - An email will be automatically
                                                    sent to button recipients when button is initiated.</span></span>
                                        </td>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td style="width:221px">
                                                        <asp:Label ID="lblEmail" runat="server" Text="Enter email subject "></asp:Label>
                                                         <span class="couponcode">
                                                            <img border="0" src="../../images/Dashboard/new.png" />
                                ...
                                <table cellpadding="2" cellspacing="2" class="group-selection">
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <span class="couponcode">
                                                <img border="0" src="../../images/Dashboard/new.png" />
                                                <span class="coupontooltip">Send auto push notification - A  push notification
                                                    will be automatically sent to button recipients when button is initiated.</span></span>
                                        </td>
                                        <td>
                                            <table>
                                                <tr>
                                ...
                                <table cellpadding="2" cellspacing="2" class="group-selection">
                                    <tr>
                                        ...
                                        <td style="width:189px">
                                            <asp:Label ID="lblText" runat="server" Text="Send auto text message"></asp:Label>
                                            <span class="couponcode">
                                                <img border="0" src="../../images/Dashboard/new.png" />
                                                <span class="coupontooltip">Send auto text message - A text message will
                                                    be automatically sent to button recipients when button is initiated.</span></span>
                                        </td>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td style="width:221px">
                                                        <asp:Label ID="lblTextSub" runat="server" Text="Enter text message subject "></asp:Label>
                                                         <span class="couponcode">
                                                            <img border="0" src="../../images/Dashboard/new.png" />
                                        ...
                                        <td>
                                            <table id="divSettings3" style="display: none;">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblTDesc" runat="server" Text="Enter text message"></asp:Label>
                                                        <span class="couponcode">
                                                            <img border="0" src="../../images/Dashboard/new.png" />
                                ...
                                <table cellpadding="2" cellspacing="2">
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="chkGPS" runat="server" />
                                        </td>
                                        <td style="width:189px">
                                            <asp:Label ID="lblGPS" runat="server" Text="Include GPS Information"></asp:Label>
                                            <span class="couponcode">
                                                <img border="0" src="../../images/Dashboard/new.png" />
                                        ...
                                        <td>
                                            ...
                                            <span class="couponcode">
                                                <img border="0" src="../../images/Dashboard/new.png" />
                                                <span class="coupontooltip">Include All Phone Information : Sends caller's name, phone
                                                    number and email address with messages.</span></span>
                                        </td>
                                    </tr>
                                </table>
                                
                                <table cellpadding="2" cellspacing="2" id="tblIncludeImage" style="display: block;">
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="chkImage" runat="server" />
                                        </td>
                                        <td style="width:189px">
                                            <asp:Label ID="lblIncludeImage" runat="server" Text="Include Image"></asp:Label>
                            ...
                            <td valign="top" style="padding-left: 4px; border-left: 1px solid #dddddd; border-left-style: groove;">
                                ...
                                <div style="width: 170px; max-height: 480px; overflow-y: auto;">
                                    <asp:GridView runat="server" ID="grdListContacts" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFName1" runat="server" Text='<%# Eval("FirstName") + " " + Eval("LastName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataTemplate>
...
//                    return true;
        ...
        function EditImage(imgdivID) {
            ...
            ifrm.setAttribute("src", "CallModuleImageGallery.aspx?fitblockwidth=" + (document.getElementById(imgdivID).offsetWidth - 10) + "&imgSrc=" + imgSrc + "&folder=Forms&ModuleName=PrivateCallAddOns&Directory=DefaultCallModule");
        ...
        function BindImages(typeValue) {
            ...
            if (typeValue == "1") {
                ...
                if (document.getElementById('<%=chkPush.ClientID %>').checked) {
                    ...
                    if (document.getElementById('<%=txtPDesc.ClientID %>').value.trim() == "" && IsShowSetting == true)
                        document.getElementById('rfvPushDesc').style.display = "block";
                    //                    if ($('#ctl00_cphUser_ddlPushGroup :selected').val() == "0" || $('#ctl00_cphUser_ddlPushGroup :selected').val() == "Select Group")
                    //                        document.getElementById('rfvPushGroup').style.display = "block";
                }
