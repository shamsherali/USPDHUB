<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="FindMissing.aspx.cs" Inherits="UserForms.FindMissing" %>
            ...
            <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
                <div id="wrapper">
                    ...
                    <div class="contentwrap">
                        <div class="largetxt" style="height: 35px;">
                            <div style="width: 380px; margin: 0px auto;">
                                <asp:DropDownList ID='ddlType' runat="server" Width="150px" CssClass="select1" Font-Size="14"
                                    Height="32">
                                    <asp:ListItem Text="Lost" Value="Lost"></asp:ListItem>
                                    <asp:ListItem Text="Found" Value="Found"></asp:ListItem>
                                </asp:DropDownList>
                                <asp:TextBox ID="txtTitle" runat="server" CssClass="txtfild1" Width="200px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvTitle" runat="server" Display="Dynamic" ControlToValidate="txtTitle"
                                    ValidationGroup="SV" ErrorMessage="Name Required">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                        ...
                        <div class="form_wrapper">
                            ...
                            <div class="fields_wrap ">
                                <div class="left_lable">
                                    <span style="padding-left: 2px;">&nbsp;</span>
                                    <label>
                                        Expiration Date & Time:</label>
                                </div>
                                <div class="right_fields" style="width: 470px;">
                                    <table width="70%" cellpadding="0" cellspacing="0" id='tblExTime'>
                                      <colgroup>
                                            <col width="120px" />
                                            <col width="*" />
                                        </colgroup>
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtExpires" runat="server" CssClass="txtfild1"  Width="100px"
    ...
    <script type="text/javascript">
        ...
        function GetCurrentDate() {
            $.ajax({
                ...
                url: "FindMissing.aspx/GetUserTimeZoneDashboard",
                dataType: "json",
                success: function (response) {
                    ...
                    document.getElementById('<%= hdnCurrentDate.ClientID%>').value = currentTime;
                }
            });
        }
        ...
        function EditImage(imgdivID) {
            ...
            ifrm.setAttribute("src", '<%=RootPath %>' + "/Business/MyAccount/BulletinsForm_ImageGallery.aspx?fitblockwidth=" + (document.getElementById(imgdivID).offsetWidth - 30) + "&imgSrc=" + imgSrc + "&folder=Forms");
        ...
        function BindImages(typeValue) {
            ...
            if (document.getElementById("<%=txtExpires.ClientID %>").value != "" && typeValue == 1) {
                ...
                GetCurrentDate();
                var currentdate = document.getElementById("<%=hdnCurrentDate.ClientID %>").value;
        ...
        function FirstImageDelete() {
            if (confirm("Are you sure you want to delete this image?")) {
                ...
                document.getElementById("<%=hdnLink.ClientID %>").value = "";
            }
            return false;
        }
