<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeBehind="CAEventsReports.aspx.cs" Inherits="USPDHUB.Business.MyAccount.CAEventsReports" %>
    ...
    <script type="text/javascript">
        ...
        function Confirmation(ctrl) {
            if (ctrl.innerHTML == 'Active')
                return confirm('Are you sure you want to inactivate this item?');
            else
                                        ...
                                        <td style="height: 30px; font-size: 18px; color: #EC2027; margin-bottom: 5px; margin-top: 5px;
                                            ...
                                            <asp:HiddenField ID="hdnAddOnName" runat="server" />
                                                <asp:Literal ID="ltrlTitleImage" runat="server"></asp:Literal>&nbsp; <span style="vertical-align: middle">
                                                    <%=hdnAddOnName.Value %> Reports</span> <a href="javascript:ModalHelpPopup('Event Campaign Tracking Report',170,'');">
                                                                ...
                                                                <asp:GridView ID="GrdbusinessEvents" runat="server" ShowFooter="false" AutoGenerateColumns="false"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Title" SortExpression="EventTitle">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkEventName" runat="server" Text='<%#Bind("EventTitle")%>' CommandArgument='<%# Bind("CalendarId") %>'
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Sent">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblSent" runat="server" Text='<%# GetEventsCount(Eval("CalendarId"),1) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lblhistroy" runat="server" Text='<%#GetEventsCount(Eval("CalendarId"),1) %>'
                                                                                    OnClick="lblhistroy_Click" CommandArgument='<%#Eval("CalendarId") %>'></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass="align-center" />
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Sent1" Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblSent1" runat="server" Text='<%# GetEventsCount(Eval("CalendarId"),1) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Opened">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOpened" runat="server" Text='<%# GetEventsCount(Eval("CalendarId"),2) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lnkopen" runat="server" CommandArgument='<%# Bind("CalendarId") %>'
                                                                                    Text='<%# GetEventsCount(Eval("CalendarId"),2) %>' OnClick="lnkopen_Click" CausesValidation="false"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass="align-center" />
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Opened1" Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOpened1" runat="server" Text='<%# GetEventsCount(Eval("CalendarId"),2) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Opt Out">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOptOut" runat="server" Text='<%# GetEventsCount(Eval("CalendarId"),3) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lnkoptout" runat="server" CommandArgument='<%# Bind("CalendarId") %>'
                                                                                    Text='<%#GetEventsCount(Eval("CalendarId"),3) %>' OnClick="lnkoptout_Click" CausesValidation="false"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass="align-center" />
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Opt Out1" Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblOptOut1" runat="server" Text='<%# GetEventsCount(Eval("CalendarId"),3) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Bounced Back">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblBounced" runat="server" Text='<%#GetEventsCount(Eval("CalendarId"),4) %>'></asp:Label>
                                                                                <asp:LinkButton ID="lnkBounced" runat="server" Text='<%#GetEventsCount(Eval("CalendarId"),4) %>'
                                                                                    CommandArgument='<%# Bind("CalendarId") %>' OnClick="lnkBounced_Click" CausesValidation="false"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass="align-center" />
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Bounced Back1" Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblBounced1" runat="server" Text='<%# GetEventsCount(Eval("CalendarId"),4) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="TotalScheduleCount" runat="server" Text='<%#GetSheduledCount(Eval("CalendarId")) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                    </Columns>
