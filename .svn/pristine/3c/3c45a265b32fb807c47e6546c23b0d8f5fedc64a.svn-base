<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintAppUsageReport.aspx.cs"
    Inherits="USPDHUB.PrintAppUsageReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Online App Usage Report</title>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="25%" style="border: 0px solid gray;">
                      <tr>
                                    <td colspan="3" align="center">
                                        ...
                                        <br />
                                         ...
                                         <div class="app-chart">
                                            <asp:Label ID="lblTotalCount" runat="server"></asp:Label> 
                                              <div class="label-title"> <asp:Label ID="lblTitle" runat="server"></asp:Label></div>
                                        ...
                                        <div class="app-chart">
                                         <asp:Label ID="lblAppOpenCount" runat="server"></asp:Label> 
                                         <div class="label-title"> <asp:Label ID="lblAppOpenTitle" runat="server"></asp:Label> </div>
                                        <asp:Chart ID="chartAppOpen" runat="server" Width="400px">
                                            <Titles>
                                                <asp:Title ShadowOffset="30" />
                                            </Titles>
                                            <Legends>
                                            ...
                                            <ChartAreas>
                                                <asp:ChartArea Name="AppOpenChartArea" BackColor="white">
                                                </asp:ChartArea>
                                            </ChartAreas>
                                        </asp:Chart>
                                        </div>
