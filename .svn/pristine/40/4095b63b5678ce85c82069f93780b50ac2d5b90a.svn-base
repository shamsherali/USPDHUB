<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactus.aspx.cs" Inherits="USPDHUB.OP.inschoolhubin.Contactus" %>
            ...
            <div id="bannersecondary">
                ...
                <div id="rightcol">
                    <div id="navigation">
                        <div align="right">
                            <p>
                                <a href="Default.aspx">Home</a> | <a href="Javascript:void(0);" class="active">Contact Us</a> |
                                <a href="features.html">Features</a> | <a href="AddTools.aspx">Pricing</a> | <a href="aboutus.html">
                                    About Us</a> | <a href="login.aspx">Login</a> <%--<a onmouseover="changeImages('social_facebook','<%=Page.ResolveClientUrl("~/images/ISHOuterImages/social-facebook-over.gif")%>');return true"
        ...
        <div id="content">
            <div id="containercontact">
                <div id="containercontact-content">
                    <div id="contactinfo">
                        <img src="/images/ISHOuterImages/img-contactus.png" align="left" width="336" height="218"
                            style="margin-bottom: 15px;"><br/>
                        <div class="h3bold">
                            inSchoolHub Headquarters:</div>
                        <div class="h3">
                            Uma Aishwarya House, 3rd Floor<br />
                            Plot No: 8-2-502/I/A/G, Road No. 7, Banjara Hills</div>
                        <div class="h3">
                            Hyderabad, Andhra Pradesh, India - 500 034</div>
                        <div class="h3bold">
                            Phone: +91 40 - 6460 1150</div>
                        <div class="h3bold">
                            Monday - Friday 9 a.m. - 6 p.m. IST</div>
                        <br/>
                        <div class="h4">
                            Customer Care: <a href="mailto:support@inschoolhub.in">support@inschoolhub.in</a></div>
                        <div class="h4">
                            Sales Inquiries: <a href="mailto:sales@inschoolhub.in">sales@inschoolhub.in</a></div>
                        <br/>
                        <div class="h3bold">
                            For Information:</div>
                        <div class="h4">
                            Contact us at <a href="mailto:info@inschoolhub.in">info@inschoolhub.in</a></div>
                    </div>
                    <div id="contactform">
                        ...
                        <asp:TextBox runat="server" ID="txtPhone" MaxLength="12" CssClass="inputtextarea" Width="250px"></asp:TextBox>
