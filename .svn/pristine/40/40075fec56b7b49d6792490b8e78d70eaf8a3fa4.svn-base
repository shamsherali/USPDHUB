...
{
    public partial class SheriffActivity : System.Web.UI.Page
    {
        public int UserID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "Page_Load", ex.Message,
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void LoadDefaultData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "LoadDefaultData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void LoadFormData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "LoadFormData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "LoadFormData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "btnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "btnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "lnkPreview_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                if (!string.IsNullOrEmpty(txtFromDate.Text))
                {
                    txtFromHours.Enabled = true;
                    txtFromMinutes.Enabled = true;
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "lnkPreview_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private string BuildHTML()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "BuildHTML", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                strHtml.Append("<div style=\"font-size: 26px; line-height: 28px; font-weight: normal; color: #f15b29; text-align: center; padding: 0px 0px 10px 0px; border-bottom: 1px dashed #d1d1d1;\">Sheriff Activity</div>");
                ...
                strPrintHtml.Append("<h1 style=\"font-size: 14px; text-align: center; color: #444444; text-decoration: underline; font-weight: bold;\">Sheriff Activity</h1>");
                ...
                if (txtFromDate.Text.Trim() != "" && txtToDate.Text.Trim() != "")
                {
                    ...
                    strHtml.Append("<tr>");
                    strHtml.Append("<td colspan='2' style='padding: 4px;'>Date and Time of Activity :</td></tr>");
                    strHtml.Append("<tr><td colspan='2' style='color: #353535; padding-left: 20px;'><span style='margin-left:15px;'>From " + txtFromDate.Text + "&nbsp;" + fromTime + "</span> <br/> <span style='margin-left:25px;'>To " + txtToDate.Text + "&nbsp;" + toTime + "</span></td></tr>");

                    // PDF Print HTML 
                    strPrintHtml.Append("<div style=\"font-weight: bold; float: left; width: 180px; margin-right: 10px; margin-bottom: 10px;\">Date and Time of Activity :</div>");
                    strPrintHtml.Append("<div style=\"float: left; width: 420px; margin-bottom: 10px;\"><span style='margin-left:0px;'>From " + txtFromDate.Text + "&nbsp;" + fromTime + "</span> <br/> <span style='margin-left:0px;'>To " + txtToDate.Text + "&nbsp;" + toTime + "</span></div>");
                }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "BuildHTML", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        private string BuildHeader()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
            return strHeader;
        ...
        protected bool ValidationTime(string starttime1, string endtime1)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "SeriffActivity.aspx.cs", "ValidationTime", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "SeriffActivity.aspx.cs", "ValidationTime", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return false;
            }
        }
