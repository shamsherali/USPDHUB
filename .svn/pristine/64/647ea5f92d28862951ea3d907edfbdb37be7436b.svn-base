...
{
    public partial class CrimeHighlights : BaseWeb
    {
        public int UserID = 0;
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void LoadDefaultData()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "LoadDefaultData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "BtnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            finally
            {
                MPEProgress.Hide();
                string urlinfo = Page.ResolveClientUrl("~/Business/MyAccount/CrimeHighlights.aspx");
                Response.Redirect(urlinfo);
            }
        }
