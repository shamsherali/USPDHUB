...
namespace USPDHUBBLL
{
    public class XmlAPIUtilities
    {
        ...
        public static readonly string API_URL = ConfigurationSettings.AppSettings["CheckPCNameCP"];
        public static readonly string EXAMPLE_MERCHANT_NAME = ConfigurationSettings.AppSettings["CheckPC"];
        public static readonly string EXAMPLE_TRANSACTION_KEY = ConfigurationSettings.AppSettings["CheckPCKey"];



        // Live ID of logictree         
        //public const String EXAMPLE_MERCHANT_NAME = "74g5t6JJyL";
        //public const String EXAMPLE_TRANSACTION_KEY = "8w33TDX8a2unA7sk";
