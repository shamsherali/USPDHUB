...
namespace ResellersBLL
{
    public class CommonBLL
    {
        ...
        public int SaveContactInquiry(DataTable dtResellerInfo, ResellerModels.Inquiry objInquiry, string DomainName)
        {
        ...
        public int SaveResellerInquiry(DataTable dtResellerInfo, ResellerModels.Inquiry objInquiry, string DomainName)
        {
            int inquiryId = InquiryDAL.SaveResellerInquiry(objInquiry);
            string strfilepath = HttpContext.Current.Server.MapPath("~") + "\\EmailContent" + DomainName + "\\";
