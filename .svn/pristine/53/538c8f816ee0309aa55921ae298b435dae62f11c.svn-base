<%@ Page Title="" Language="C#" MasterPageFile="~/Business/MyAccount/CallIndexMaster.Master"
    ValidateRequest="false" AutoEventWireup="true" CodeBehind="SendCallIndexInvitation.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.SendCallIndexInvitation" %>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" style="color: #0c3879; padding-left: 4px;">
                                        <b><font size="2">Contacts Selected To Receive Invitation To Display Directory</font></b>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tr>
                                <td align="center" style="background-color: #D2E5FA; border: 1px solid #D1DDEA; padding: 7px 0px 7px 0px;">
                                    ...
                                    <asp:Button ID="btnSepupInvitations" runat="server" Text="Manage Invitations" CausesValidation="false"
                                        OnClick="btnSepupInvitations_OnClick" Width="150px" Height="24px" />&nbsp;&nbsp;
