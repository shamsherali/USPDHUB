...
{
    public partial class AddOnsReports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    DataTable dtTab = objAddOn.GetAddOnById(CustomModuleId);
                    if (dtTab.Rows.Count > 0)
                        hdnTabName.Value = Convert.ToString(dtTab.Rows[0]["TabName"]);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "Page_Load", ex.Message,
        ...
        public void FillDatalist()
        {
            try
            {
                dtobj = objAddOn.GetSendItemsByProfileID(ProfileID, CustomModuleId);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReports.aspx.cs", "FillDatalist", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private DataTable RemoveArchive(DataTable dt, string Archive)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AboutUs.aspx.cs", "RemoveArchive", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return dtData;
        ...
        protected void gridUpdates_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    string customID = lnkName.CommandArgument;
                    if (File.Exists(Server.MapPath("~") + "\\Upload\\CustomModules\\" + ProfileID.ToString() + "\\" + customID + ".jpg"))
                        lblupdateimg.Text = "<img src='" + RootPath + "/Upload/CustomModules/" + ProfileID.ToString() + "/" + customID + ".jpg' border='0' width='100' height='50'/>";
                    else
                        lblupdateimg.Text = "";
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "gridUpdates_RowDataBound", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void lblhistroy_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "lblhistroy_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void lnkopen_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DtOptOuts = objBulletin.GetOpenedMailsForBulletinID(Convert.ToInt32(lnkOpenID.CommandArgument), "CM");
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "lnkopen_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void grdoptouts_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "grdoptouts_PageIndexChanging", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void lnkoptout_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DtOptOuts = objAddOn.GetOptOutCountForItems(Convert.ToInt32(lnkOptOutID.CommandArgument));
                if (DtOptOuts.Rows.Count > 0)
                {
                    grdoptouts.DataSource = DtOptOuts;
                    grdoptouts.DataBind();
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "lnkoptout_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void grdmailopen_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "grdmailopen_PageIndexChanging", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void grdviewsenthis_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "grdviewsenthis_PageIndexChanging", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void gridUpdates_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "gridUpdates_Sorting", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private string GetSortDirection(string column)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "GetSortDirection", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void lnkupdateName_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtBusinessUpdateDetails = objAddOn.GetCustomModuleByID(Convert.ToInt32(lnkdetails.CommandArgument));
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "lnkupdateName_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private string UserProfileUnsubscribeLink()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "UserProfileUnsubscribeLink", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void grdviewsenthis_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "grdviewsenthis_RowDataBound", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        public string GetBulletinsCounts(object id, object flag)
        {
            ...
            {
                DataSet ds = null;
                ds = objAddOn.GetItemsCounts(Convert.ToInt32(id), Convert.ToInt32(flag), ProfileID);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "GetBulletinsCounts", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return value;
        }
        public string GetSheduledCount(object id)
        {
            ...
            try
            {
                value = ObjCommon.GetScheduledCount(Convert.ToInt32(id), 4);
            }
            catch (Exception ex)
            {
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "GetSheduledCount", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return value;
        }
        protected void lnkBounced_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DtOptOuts = objBulletin.GetBouncedEMailsForBulletinID(Convert.ToInt32(LnKBouncedID.CommandArgument), "CM");
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "lnkBounced_Click", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void grdBounced_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "grdBounced_PageIndexChanging", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            try
            {
                string url = "";
                if (hdnUrl.Value == "")
                    url = Page.ResolveClientUrl("~/Business/MyAccount/ManageAddOns.aspx");
                else
                    url = hdnUrl.Value;
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "btnCancel_Click", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnExportSelected_Click(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "btnExportSelected_Click", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        protected void btnConsolidatedeport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkheader.Checked == false)
                {
                    ...
                    foreach (GridViewRow grdrow in gridUpdates.Rows)
                    {
                        ...
                        DataRow[] dr = dt.Select("Custom_ID=" + k);
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "btnConsolidatedeport_Click", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "AddOnsReport.aspx.cs", "btnBack_Click", ex.Message,
               Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
    }
