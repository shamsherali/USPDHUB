<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagePSCContacts.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.ManagePSCContacts" MasterPageFile="~/Business/MyAccount/PrivateSmartConnect.Master" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" class="mailtbl" width="100%">
                                                    <tr>
                                                        <td align="right" style="padding-right: 10px;">
                                                            ...
                                                            indicates contact is approved for Private QR Connect
                                                            <br />
                                                                ...
                                                                <tr>
                                                                    <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                        <strong style="padding-left: 5px; width: 70px;">Contact Search:</strong>&nbsp;&nbsp;<asp:TextBox
                                                                            ID="txtSearchContact" runat="server" Style="margin-left: 8px;" Width="130px"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:LinkButton ID="lnkShowAll" runat="server" OnClick="lnkShowAll_Click" Text="Show All"
                                                                            CssClass="seachareabtn" Style="text-decoration: none; color: Black"></asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:TemplateField HeaderStyle-CssClass="groupsheadP" ItemStyle-Height="25px">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <br />
                                                                                            <asp:Label ID="lblEmail" runat="server" ToolTip='<%# Eval("EmailID") %>' Text='<%#Eval("EmailID")%>'
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="left" style="border: 1px solid #CCC;">
                                                            <asp:HiddenField ID="hdnSelG" runat="server" Value="0" />
                                                ...
                                                <table border="0" align="center" bgcolor="#eeeeee" style="padding: 10px;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;&nbsp;These contacts have agreed to receive email and SMS(text
                                                            messages).
                                                        </td>
                                                    </tr>
                                                    <tr>
