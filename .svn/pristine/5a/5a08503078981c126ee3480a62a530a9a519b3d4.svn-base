<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="MissingPerson.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.MissingPerson" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphUser" runat="server">
    ...
    <script src="../../Scripts/timePicker/jquery.timepicker.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#timePick').timepicker({ 'step': 5, timeFormat: 'g:i A' });

            $('#timePick').on('changeTime', function () {
                document.getElementById('<%=hdnTimePicker.ClientID %>').value = $(this).val();
            });
            $('#timePick').timepicker('setTime', document.getElementById('<%=hdnTimePicker.ClientID %>').value);
                ...
                <div id="wrapper">
                    ...
                    <div class="contentwrap">
                        <div class="largetxt" style="text-align: center; padding-left: 110px; height: 35px;">
                            <asp:DropDownList ID='ddlMissingPersonTypes' runat="server" Width="320px" CssClass="select1"
                                Font-Size="14" Height="32">
                                <asp:ListItem Text="Missing Person" Value="Missing Person"></asp:ListItem>
                                <asp:ListItem Text="Missing Person at Risk" Value="Missing Person at Risk"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="form_wrapper">
                                ...
                                <div style="float: left; text-align: left; width: 550px; padding: 3px 0px 0px 0px;
                                    ...
                                    <label>
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:CheckBox runat="server" Text="dummyCheckbox" Style="display: none;" />
                                                    <asp:CheckBox runat="server" ID="chkAdult" Text="Adult" />
                                                </td>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="chkDependAdult" Text="Dependent Adult" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="chkJuvenile" Text="Juvenile" />
                                                </td>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="chkOther2" Text="Other" />&nbsp;
                                                    <asp:TextBox runat="server" ID="txtOther2" Height="23px" Width="185px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="chkAmberAlert" Text="Amber Alert" />
                                                </td>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="chkSilverAlert" Text="Silver Alert" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="chkStranger" Text="Stranger Abduction" />
                                                </td>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="chkSuspicious" Text="Suspicious Circumstances" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <asp:CheckBox runat="server" ID="chkOther1" Text="Other" />&nbsp;
                                                    <asp:TextBox runat="server" ID="txtOther1" Height="23px" Width="355px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <asp:CheckBox runat="server" ID="chkAtRisk" Text="At Risk, Describe" />
                                                    <asp:TextBox runat="server" ID="txtAtRisk" Width="420px" CssClass="txtfild1" TextMode="MultiLine"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </label>
                            ...
                            <div class="browseimg_wrap">
                                <div id='imgwatermark' style="position: absolute; display: none; text-align: center;">
                                    <%--  <table width="300px" height="200px" border="0" cellspacing="0" style="text-align:center;" cellpadding="0">
                                        <tr>
                                            <td   align="center">
                                                <div align="center" style="color: #fff; position: relative; z-index: 99999; font-family: Arial, Helvetica, sans-serif;
                                                    font-size: 32px; -moz-transform: rotate(-45deg);
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <cc1:CalendarExtender ID="calex" runat="server" TargetControlID="txtExpires" Format="MM/dd/yyyy"
                                                    CssClass="MyCalendar" />
                                                <input id="timePick" type="text" style="width: 85px;" placeholder="Time" />
                                            </td>
                                            <td>
                                                <asp:TextBox runat="server" ID="txtExHours" Width="50px" Enabled="False" MaxLength="2"
                                                ...
                                                &nbsp; &nbsp;
                                                <asp:TextBox runat="server" ID="txtExMinutes" Width="50px" Enabled="False" MaxLength="2"
                                                    Style="display: none;"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlExSS" Enabled="False" Width="60px" Style="display: none;">
    ...
    <script type="text/javascript">
        ...
        function BindImages(typeValue) {
            ...
            if (document.getElementById("<%=txtExpires.ClientID %>").value != "" && typeValue == 1) {
                ...
                if (document.getElementById("<%=hdnTimePicker.ClientID %>").value != '') {
                    var seltime = parseInt(document.getElementById("<%=hdnTimePicker.ClientID %>").value);
                }
                selDate.setHours(seltime, seltime, 0);
