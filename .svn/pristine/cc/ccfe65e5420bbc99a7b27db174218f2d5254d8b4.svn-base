<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="USPDHUB.OP.inschoolhubcom.Login" %>
        ...
        <div id="container">
            <div id="bannersecondary">
                <div id="bannerleft">
                    <%if (IsLiteVersion)
                      { %>
                    <img src="<%=Page.ResolveClientUrl("~/images/ISHOuterImages/ihsalert-logo.png")%>"
                        alt="InSchoolHub" width="227" height="123" border="0">
                    <%}
                      else
                      { %>
                    <img src="<%=Page.ResolveClientUrl("~/images/ISHOuterImages/ihs-logo.png")%>" alt="InSchoolHub"
                        width="227" height="123" border="0">
                    <%} %></div>
                <!--bannerleft-->
                <div id="rightcol">
                    <div id="navigation">
                        <div align="right">
                            <p>
                                <%if (IsLiteVersion)
                                  { %>
                                <a href="http://www.inschoolalert.com/Default.aspx">Home</a>
                                <%}
                                  else
                                  { %>
                                <a href="Default.aspx">Home</a>
                                <%} %> 
                                | <a href="ContactUs.aspx">Contact Us</a> <%if (!IsLiteVersion)
                                                                            { %>| <a href="AddTools.aspx">Features & Pricing</a><%} %>
                                | <a href="aboutus.html">About Us</a> | <a href="Javascript:void(0);" class="active">
                                    Login</a>
