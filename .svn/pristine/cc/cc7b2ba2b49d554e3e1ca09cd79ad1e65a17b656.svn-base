<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uspdhubinfo.aspx.cs" Inherits="Resellers.uspdhubinfo" %>
        ...
        <ContentTemplate>
            <div id="outerwrapper" style="background-image: none;">
                <div id="wrapper">
                    <div id="banner">
                        <div id="brand">
                            <img src="http://www.uspdhub.com/images/verticallogos/uspdhubcomlogo.png" alt="USPDhub"
                                border="0">
                        </div>
                        <div id="bannerright">
                            <div id="social">
                        ...
                        <div id="contentleft500" style="float: none; margin-left: 205px; width: 600px;">
                            ...
                            <div id="signupform">
                                ...
                                <div>
                                    ...
                                    <asp:HiddenField ID="hdnResellerName" Value="USPDhub" runat="server" />
                                </div>
                            </div>
                            <br>
                        </div>
