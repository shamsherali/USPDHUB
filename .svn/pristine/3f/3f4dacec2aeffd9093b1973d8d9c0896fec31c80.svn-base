<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulletinsForm_ImageGallery.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.BulletinsForm_ImageGallery" ValidateRequest="false" %>
...
<body class="yui-skin-sam" style="background-color: #F8F6F6;">
                                ...
                                <table cellpadding="0" border="0" cellspacing="0" width="99%" style="margin-left: 5px;
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 5px; padding-left: 5px;">
                                            <asp:TextBox ID="txtwebaddress" runat="server" Text="http://"></asp:TextBox><br />
                                        </td>
                                    </tr>
    ...
    <script type="text/javascript" language="javascript">
        ...
        if (document.getElementById('hdnClose').value != "") {
            ...
            ImgDivID1 = ImgDivID;
            document.getElementById('<%=CheckWidth.ClientID %>').value = parent.document.getElementById(ImgDivID1).offsetWidth - 30;
