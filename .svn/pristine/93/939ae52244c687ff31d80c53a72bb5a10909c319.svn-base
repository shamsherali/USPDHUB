<%@ Page Title="" Language="C#" MasterPageFile="~/AdminHome.master" AutoEventWireup="true"
    CodeBehind="TestUserManagement.aspx.cs" Inherits="USPDHUB.Admin.TestUserManagement" %>
                            ...
                            <td valign="top">
                                <asp:GridView ID="ConsumersGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="User_ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkClientAc" runat="server" OnClick="lnkClientAc_Click" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"User_ID") %>'
                                                    Text="&lt;img src='../Images/user_type.png' alt='Make Client User' title='Make Client User' border='0'/&gt;"
                                                    OnClientClick="return confirm('Are you sure you want to make this user as client user?');"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
