...
{
    public partial class ManagePublicCallIndexContacts : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (groupID > 0)
            {
                objAddOns.AddGroupForPublicCallIndex(groupID, txtcontactgroupname.Text, txtcontactgroupdes.Text, true, false, UserModuleID, ProfileID, C_UserID, UserID);
                hdnGroupID.Value = "";
        ...
        protected void chkGroupName_CheckedChanged(object sender, EventArgs e)
        {
            ...
            dtGroupNameList = objAddOns.GetActiveContactsForPublicCall(UserModuleID, groupIds);
        ...
        protected void btnGroupDelete_Click(object sender, EventArgs e)
        {
            ...
            objAddOns.DeleteGroupsForPublicCallIndex(groupIds);
            BindGroupsData();
            GVCallIndexContacts.DataBind();
        }
        protected void lnkEditGroup_Click(object sender, EventArgs e)
        {
            ...
            ds = objAddOns.GetPublicCallIndexGroupByID(GroupID);
        ...
        protected void btnContactAdd_Click(object sender, EventArgs e)
        {
            ...
            if (existingContactId >= 0)
            {
                ...
                if (contactID == 0 && existingContactId > 0)
                    ...
                    insertId = contactID;
                insertId = objAddOns.InsertUpdatePublicCallContacts(insertId, txtFirstname.Text, txtLastname.Text, txtEmail.Text, txtcompanyname.Text, txtAddress.Text, txtCity.Text, txtState.Text, txtZipcode.Text, txtPhone.Text, txtMobile.Text, txtFax.Text, true, false, UserModuleID, ProfileID, UserID, C_UserID, txtPosition.Text, txtOrganization.Text, true, false);
                if (insertId > 0)
                {
        ...
        protected void btnDeleteContact_Click(object sender, EventArgs e)
        {
            ...
            objAddOns.DeletePublicCallIndexContacts(contactIds);
            BindGroupsData();
            GVCallIndexContacts.DataBind();
        }
        protected void lnkEditContact_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = new DataSet();
            ds = objAddOns.GetPublicCallIndexContactByID(ContactID);
            if (ds.Tables[0].Rows.Count > 0)
            {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = objAddOns.SearchPublicCallContactEmail(txtSearchContact.Text, UserModuleID);
        ...
        protected void btnGroupNext_Click(object sender, EventArgs e)
        {
            ...
            {
                groupId = objAddOns.AddGroupForPublicCallIndex(0, txtImportGroup.Text.Trim(), "", true, false, UserModuleID, ProfileID, C_UserID, UserID);
                if (groupId > 0)
                {
        ...
        protected void Submit1_Click(object sender, EventArgs e)
        {
            ...
            {
                lblError.Text = ex.Message.Replace("to", "in");
                modalImport.Show();
            }
        }
        ...
        private int AddContacts(DataTable dtcsvtable, out int successCount)
        {
            ...
            foreach (DataRow dr in dtcsvtable.Rows)
            {
                ...
                if (re.IsMatch(email))
                {
                    objAddOns.InsertImportContactsForPublicCall(0, names[0].ToString(), lastname, email, companyname, address, city, state, zipcode, phonenumber, mobilenumber, faxnumber, true, false, UserModuleID, ProfileID, UserID, C_UserID, Convert.ToInt32(hdnImportGroupId.Value), title, organization);
                    successCount++;
                }
                else
                {
