...
{
    public partial class ManagePSCInvitation : System.Web.UI.Page
    {
        ...
        protected void lnkResend_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                int invitationID = objPrivateModuleBLL.Insert_Update_Invitation(inviteesID, "Invited", string.Empty, string.Empty,
                    pOTP, string.Empty, 0, UserModuleID, ProfileID, "", ButtonTypes.PrivateSmartConnect);
                ...
                objCommonBLL.SendPrivateSmartConnect_InvitationMails("", DomainName, invitationID.ToString(), ProfileID, "", UserID, RootPath, mobileNumber);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "ManagePSCInvitation.aspx.cs", "Page_Load", ex.Message,
