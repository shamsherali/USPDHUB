<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactus.aspx.cs" Inherits="USPDHUB.Contactus" %>
    ...
    <div id="contentwrap">
        <div id="content">
            <div class="pagehead">
                Contact Us</div>
            <div align="center">
                <img src="images/OuterImages/shadow.png" width="100%" /></div>
            <div id="containercontact">
                <div id="containercontact-content">
                    <div id="contactinfo">
                        <img src="../images/OuterImages/img-contactus.png" align="left" width="336" height="218"
                    ...
                    <div id="contactform">
                        ...
                        <asp:TextBox runat="server" ID="txtComments" Width="244px" TextMode="MultiLine" Height="50"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSubject"
                            ErrorMessage="Comments is mandatory." SetFocusOnError="True" ValidationGroup="A"
                            Font-Size="XX-Small">*</asp:RequiredFieldValidator><br />
                        ...
                        <div class="left" style="padding-left: 135px; padding-top: 10px;">
                            <asp:LinkButton ID="lnkSubmit" runat="server" ValidationGroup="A" OnClick="lnkSubmit_Click"><img src="../images/OuterImages/submit.png" /></asp:LinkButton>
                        </div>
                        <div class="clear60">
                        </div>
                    </div>
