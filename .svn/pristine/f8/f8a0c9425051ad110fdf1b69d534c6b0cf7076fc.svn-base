<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemImageGallery.aspx.cs"
    Inherits="USPDHUB.Business.MyAccount.SystemImageGallery" ValidateRequest="false" %>
...
<body class="yui-skin-sam" style="background-color: #F8F6F6;">
            ...
            <table width="730px" border="0" cellpadding="0" cellspacing="0" class="rounded-cornersBox">
                <tr>
                    <td valign="top" style="border-right: 1px solid #BED1F4;">
                        <table border="0" cellpadding="0" cellspacing="0" style="line-height: 18px; padding: 10px; font-size:14px;">
                            <tr>
                                <td valign="top" style="border-right: 1px solid #BED1F4; padding-left:20px; ">
                                    Click on the image of your choice to make it the button icon. Click on Back button
                ...
                <div style="float: right; padding-right: 67px;">
                    <asp:Panel ID="pnlSelectSearch" runat="server" DefaultButton="lnkSearch">
                        ...
                        <asp:TextBox ID="txtSearch" runat="server" onkeypress="return EnterEvent(event)"></asp:TextBox><asp:RequiredFieldValidator
                            ID="rfvSearch" runat="server" ValidationGroup="S" ControlToValidate="txtSearch">*</asp:RequiredFieldValidator>&nbsp;
                        <asp:LinkButton ID="lnkSearch" runat="server" OnClick="lnkSearch_Click" Text="Search"
                            ValidationGroup="S" Class="btnorange"></asp:LinkButton>&nbsp;&nbsp;<asp:LinkButton
                                ID="lnkClear" runat="server" OnClick="lnkClear_Click" Text="Clear" CausesValidation="false"
                                Class="btnblue"></asp:LinkButton>
                    </asp:Panel>
                </div>
            </div>--%>
            <div style="border: 1px solid #DFE7F6; height: 460px; overflow-y: scroll; overflow-x: hidden;
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;
                            ...
                            <tr>
                                ...
                                <td rowspan="2" style="padding-left: 10px;">
                                    <asp:ImageButton ID="ImgUserImg" Style="height: 100px; width: 100px;" runat="server"
                                        ImageUrl='<%# Eval("Image_Thumb","~/Upload/" + DirectoryName+"/"  + DomainName + "/{0}") %>'
                                        OnClick="ImgUserImg_Click" OnClientClick="return ShowProgressBar('2')" CausesValidation="false" />
                            ...
                            <tr>
                                <td style="line-height: 18px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                    ...
                                    <asp:Label ID="lblimgdim" runat="server" Text='<%#Eval("ImageName") %>'></asp:Label><br />
                                    <%--<asp:Label ID="lblimgdate" runat="server" Text='<%# Eval("Image_Date", "{0:MM/dd/yy hh:mm tt}") %>'></asp:Label>--%>
                                </td>
                                <td style="padding-left: 30px;">
                                    &nbsp;
                                </td>
                        ...
                        <tr>
                                ...
                                <table cellpadding="0" border="0" cellspacing="0" width="100%" style="margin-left: 5px;
                                    ...
                                    <tr>
                                        <td style="padding-top: 33px;" align="center">
                                            <asp:Button ID="btncancel" runat="server" Text="Default Library" OnClick="btncancel_Click"
                            ...
                            <td style="border-left: 1px solid #000; vertical-align: top; padding-top: 5px; padding-right: 5px;">
                                <table cellpadding="0" border="0" cellspacing="0" width="99%" style="margin-left: 5px;
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <strong style="font-size: 15px;">3&nbsp;&nbsp; Create Hyperlink</strong> <a href="javascript:window.parent.ModalHelpPopup('Create Link to Image',171,'');">
    ...
    <script type="text/javascript">
        ...
        function SetDivAlignment() {
            ...
            if ((divWidth - imgWidth - 10) / 2 > 0) {
                document.getElementById('yui_img_wrap').style.left = ((divWidth - imgWidth - 10) / 2) + "px";

            } else {
                document.getElementById('yui_img_wrap').style.left = "5px";
            }
        }
    ...
    <script type="text/javascript" language="javascript">
        ...
        if (document.getElementById('hdnClose').value != "") {
            ...
            if (parent.document.getElementById("ctl00_cphUser_hdnImage") != null) {
                parent.document.getElementById("ctl00_cphUser_hdnImage").value = RImgURL;
            }
            ...
            ImgDivID1 = ImgDivID;
            document.getElementById('<%=CheckWidth.ClientID %>').value = parent.document.getElementById(ImgDivID1).offsetWidth - 10;
