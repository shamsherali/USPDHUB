...
namespace UserForms
{
    public partial class CrimeHighlights : System.Web.UI.Page
    {
        public int UserID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CrimeHighlights.aspx.cs", "Page_Load", string.Empty, string.Empty, string.Empty, string.Empty);
                // *** Get Domain Name *** //
                ...
                if (!IsPostBack)
                {
                    if (Session["lblerrormsg"] != null)
                    {
                        lblerror.Text = Session["lblerrormsg"].ToString();
                        Session["lblerrormsg"] = "";
                    }
                    if (Session["msgSave"] != null)
                    {
                        lblmess.Text = Convert.ToString(Session["msgSave"]);
                        Session.Remove("msgSave");
                    }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "Page_Load", ex.Message,
        ...
        private void LoadDefaultData()
        {
            ...
            // Officer Types
            dtOfficerTypes = objBulletin.GetOfficerTypes(ProfileID, "Police");
        ...
        private string BuildHeader()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CrimeHighlights.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        ...
        protected void BtnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CrimeHighlights.aspx.cs", "BtnCancel_Click", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "BtnCancel_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidatePublishDate())
                {
                    ...
                    bool isSuccess = Save_Update_BulletinDetails();
                    if (isSuccess)
            ...
            {
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "SaveCrimeHighlights", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            finally
            {
                MPEProgress.Hide();
                Session["msgSave"] = Session["BulletinSuccess"];
                string urlinfo = Page.ResolveClientUrl("CrimeHighlights.aspx");
                Response.Redirect(urlinfo);
            }
        }
        ...
        protected void BtnPublish_Click(object sender, EventArgs e)
        {
            try
            {
                objInBuiltData.ErrorHandling("LOG", "CrimeHighlights.aspx.cs", "BtnPublish_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                if (ValidatePublishDate())
                {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "BtnPublish_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private bool ValidatePublishDate()
        {
            try
            {
                ...
                //Log
                objInBuiltData.ErrorHandling("LOG", "CrimeHighlights.aspx.cs", "ValidatePublishDate", string.Empty, string.Empty, string.Empty, string.Empty);
                bool addflag = true;
                dtToday = objCommon.ConvertToUserTimeZone(ProfileID);

                if (Convert.ToDateTime(txtFromDate.Text) > Convert.ToDateTime(txtToDate.Text))
                {
                    lblerror.Text = "<font size='2' color='red'>End Date should be later than or equal to Start Date.</font>";
                    addflag = false;
                }
                ...
                Session["lblerrormsg"] = lblerror.Text;
                return addflag;
            }
            catch (Exception ex)
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "ValidatePublishDate", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return false;
            }
        }
        ...
        private bool Save_Update_BulletinDetails()
        {
            bool isSuccess = true;
            try
            {
            ...
            catch (Exception ex)
            {
                //Error 
                isSuccess = false;
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "Save_Update_BulletinDetails", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return isSuccess;
        }
        ...
        protected void btnDashboard_OnClick(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CrimeHighlights.aspx.cs", "btnDashboard_OnClick", string.Empty, string.Empty, string.Empty, string.Empty);
                if (rbPublic.Checked)
                    publishValue = "2";
                if (ValidatePublishDate())
                {
                    ...
                    //
                    string urlPath = RootPath + "/Business/MyAccount/default.aspx";
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CrimeHighlights.aspx.cs", "btnDashboard_OnClick", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
