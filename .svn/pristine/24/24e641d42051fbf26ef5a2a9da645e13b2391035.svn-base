<%@ Page Title="" Language="C#" MasterPageFile="~/PaidTools.master" AutoEventWireup="true"
    CodeBehind="CrimeHighlights.aspx.cs" Inherits="UserForms.CrimeHighlights" ValidateRequest="false" %>
        ...
        /*.right_buttons
{
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#ctl00_ctl00_cphUser_cphUser_txtPhone').keyup(function (event) {
                // Allow: backspace, delete, tab, escape, and enter // Allow: home, end, left, right
                if (event.keyCode == 46 || event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 27 || event.keyCode == 13 ||
                (event.keyCode >= 35 && event.keyCode <= 39)) {
                    return;
        ...
        function AddIncidentPanel() {
            ...
            if (divtable.rows.length == 0) {
                ...
                var lastrow = CID - 1;
                //alert(divtable.rows[divtable.rows.length - 1].id)
        ...
        function PreviewHTML(type) {
            ...
            if (ContactTitle != "" || ContactName != "") {
                //HTML
                IsContactAdd = true;
                ROWS = ROWS + "<tr><td style='padding-left:5px;'>Contact Person:</td><td style='page-break-inside: avoid;'>" + ContactTitle + "&nbsp;" + ContactName + "</td></tr>";
            }
            ...
            if (EmailID != "") {
                if (IsContactAdd == false) {
                    ...
                    //HTML
                    ROWS = ROWS + "<tr><td >&nbsp;</td><td>" + EmailID + "</td></tr>";
                }
            }
            ...
            if (type == "1") {
                ...
                $.ajax({
                    ...
                    url: "CrimeHighlights.aspx/ReplaceShortURltoHmlString",
                    dataType: "json",
                    processData: false,
                ...
                <div class="form_wrapper" style="float: none; width: auto;">
                    ...
                    <div class="stepswrapmain">
                        ...
                        <div class="fields_wrap" style="margin-top: 5px; padding-top: 0px;">
                            ...
                            <div class='right_fields' style="width: 600px; margin-top: 0px; padding-top: 0px;">
                                <asp:TextBox ID="txtPhone" runat="server" MaxLength="13" Width="180px" Height="19px" onkeyup="transform(this);"></asp:TextBox>
