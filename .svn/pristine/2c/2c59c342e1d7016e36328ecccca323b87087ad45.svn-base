<%@ Page Title="" Language="C#" MasterPageFile="~/PaidTools.master" AutoEventWireup="true"
    CodeBehind="ManageSmartConnectCategories.aspx.cs" ValidateRequest="false" Inherits="USPDHUB.Business.MyAccount.ManageSmartConnectCategories" %>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" id="manage">
                            <tbody>
                                <tr>
                                    <td>
                                        <h1>
                                            Manage SmartConnect Categories</h1>
                                    </td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="header" align="center" colspan="2">
                                                                <br />
                                                                <span>SmartConnect Category</span><br />
                                                            </td>
                                                        </tr>
                                                        <tr>
