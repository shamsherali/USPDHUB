<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    EnableEventValidation="true" CodeBehind="CMCrimeHighlights.aspx.cs" ValidateRequest="false"
    Inherits="USPDHUB.Business.MyAccount.CMCrimeHighlights" %>
        ...
        function PreviewHTML(type) {
            ...
            if (EmailID != "") {
                if (IsContactAdd == false) {
                    IsContactAdd = true;
                    ROWS = ROWS + "<tr><td style='page-break-inside: avoid; padding-left:5px;'>Contact Person:</td style='page-break-inside: avoid;'><td>" + EmailID + "</td></tr>";
                }
                else {
                    //HTML
            ...
            if (PhoneNumber != "") {
                //HTML
                if (IsContactAdd == false) {
                    ROWS = ROWS + "<tr><td  style='page-break-inside: avoid; padding-left:5px;'>Contact Person:</td><td style='page-break-inside: avoid; margin:0px; padding:0px;'>" + PhoneNumber + "</td></tr>";
                }
                else {
                    ROWS = ROWS + "<tr><td style='page-break-inside: avoid; margin:0px; padding:0px;'>&nbsp;</td><td style='page-break-inside: avoid; margin:0px; padding:0px;'>" + PhoneNumber + "</td></tr>";
                }
            }
            //ROWS = ROWS + "<tr><td  style='height:10px;'></td></tr>";
            ...
            if (divtable != "") {
                ...
                $('#maintable tr.trheader').each(function () {
                    ...
                    if (Title != "") {
                        // HTML
                        childRow = childRow + "<tr><td valign='top' style='page-break-inside: avoid; padding-top:5px;'>Crime:</td><td style='padding-top:5px;'><b>" + Title + "</b></td></tr>";
                        // XML
                        childXMLElements = childXMLElements + " Title='" + Title + "' ";
                    }
                    if (Address != "") {
                        // HTML
                        childRow = childRow + "<tr><td valign='top' style='page-break-inside: avoid; padding-top:5px;'>Address:</td><td style='padding-top:5px; font-weight:bold;'>" + Address.replace(/\n/gi, "<br/>") + "</td></tr>";
                        // XML
