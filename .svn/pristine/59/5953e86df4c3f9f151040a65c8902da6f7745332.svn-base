...
namespace UserForms
{
    public partial class CMFindMissing : BaseWeb
    {
        public int UserID = 0;
        ...
        public string USPDFolderPath = ConfigurationManager.AppSettings.Get("USPDFolderPath");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string urlPath = RootPath + "/Business/MyAccount/ManageAddOns.aspx";
                ...
                if (Session["TemplateBID"] != null)
                    ModuleID = Convert.ToInt32(Session["TemplateBID"]);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "Page_Load", ex.Message,
        ...
        private void LoadDefaultData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMFindMissing.aspx.cs", "LoadDefaultData", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "LoadDefaultData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void LoadFormData()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMFindMissing.aspx.cs", "LoadFormData", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (!File.Exists(USPDFolderPath + "\\Upload\\CustomModules\\" + ProfileID.ToString() + "\\" + CustomID.ToString() + ".jpg"))
                {
                    objInBuiltData.CreateImage(USPDFolderPath + "\\Upload\\CustomModules\\", ProfileID, UserID, CustomID, dtFormData.Rows[0]["Bulletin_HTML"].ToString());
                }
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "LoadFormData", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "btnCancel_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMFindMissing.aspx.cs", "btnSave_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (addflag)
                {
                    ...
                    objInBuiltData.CreateImage(USPDFolderPath + "\\Upload\\CustomModules\\", ProfileID, UserID, CustomID, BulletinHtml);
            ...
            catch (Exception ex)
            {
                MPEProgress.Hide();
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "btnSave_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        ...
        protected void lnkPreview_Click(object sender, EventArgs e)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMFindMissing.aspx.cs", "lnkPreview_Click", string.Empty, string.Empty, string.Empty, string.Empty);
                if (!string.IsNullOrEmpty(txtFromDate.Text))
                {
                    txtFromHours.Enabled = true;
                    txtFromMinutes.Enabled = true;
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "lnkPreview_Click", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private string BuildHTML()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMFindMissing.aspx.cs", "BuildHTML", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "BuildHTML", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
        }
        ...
        private string BuildHeader()
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMFindMissing.aspx.cs", "BuildHeader", string.Empty, string.Empty, string.Empty, string.Empty);


                string strfilepath = USPDFolderPath + "\\BulletinPreview\\CommonHeader.txt";
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "BuildHeader", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return string.Empty;
            }
            return strHeader;
        ...
        protected bool ValidationTime(string starttime1, string endtime1)
        {
            ...
            {
                //Log
                objInBuiltData.ErrorHandling("LOG", "CMFindMissing.aspx.cs", "ValidationTime", string.Empty, string.Empty, string.Empty, string.Empty);
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMFindMissing.aspx.cs", "ValidationTime", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
                return false;
            }
        }
