<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SponsorAdUpload.aspx.cs"
    Inherits="USPDHUB.Admin.SponsorAdUpload" Title="" MasterPageFile="~/AdminHome.master" %>
                            ...
                            <asp:Panel ID="pnlUpload" runat="server">
                                <table class="body" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:FileUpload ID="FUUserImages" runat="server" CssClass="fileready" onchange="SetFileName();" Width="295px" />
                                                <br />
                                                <span class="profile-caption red-color">NOTE: Please use gif, jpeg, png or bmp files
                                                    only.</span>
                                                <br />
                                                <span style="color: #DC7224; font-weight: bold; margin-left: -90px;">Sponsor Ad Size:</span>
                                                <b>700px X 140px</b>
                                            </td>
                                        </tr>
                                        <tr>
