<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="MissingChild.aspx.cs" Inherits="UserForms.MissingChild" ValidateRequest="false" %>
                ...
                <div id="wrapper">
                    ...
                    <div class="contentwrap">
                        ...
                        <div class="form_wrapper">
                            ...
                            <div class="fields_wrap ">
                                <div class="left_lable">
                                    <span style="padding-left: 9px; color: #313131;">Agency Name for</span> <span style="padding-left: 9px;
                                        color: #313131;">Contact :</span>
                                </div>
                                <div class="right_fields">
                            ...
                            <div class="fields_wrap ">
                                <div class="left_lable">
                                    <span style="padding-left: 9px; color: #313131;">Agency Phone</span> <span style="padding-left: 9px;
                            ...
                            <div class="fields_wrap" style="padding-top: 10px;">
                                <div class="left_lable">
                                    <span style="padding-left: 9px; color: #313131;">Organization Name :</span>
                                </div>
                                <div class="right_fields">
                                    <asp:TextBox ID="txtKidsDesc" runat="server" CssClass="txtfild1" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                            <div class="fields_wrap ">
                                <div class="left_lable">
                                    <span style="padding-left: 9px; color: #313131;">Organization Phone </span><span
                                        style="padding-left: 9px; color: #313131;">Number:</span>
                                </div>
                                <div class="right_fields">
                                ...
                                <div class="right_fields" style="width: 470px;">
                                    <table   cellpadding="0" cellspacing="0" id='tblExTime'>
                                     <colgroup>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtExpires" runat="server" onChange="ShowExTimeDiv();" Width="100px" Height="18px"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function ThirdImageDelete() {
            if (confirm("Are you sure you want to delete this image?")) {
                ...
                document.getElementById("<%=hdnAnother1ImgLink.ClientID %>").value = "";
            }
