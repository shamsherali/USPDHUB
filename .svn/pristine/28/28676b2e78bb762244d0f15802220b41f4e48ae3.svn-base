<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgencyListing.aspx.cs"
    Inherits="USPDHUB.OP.inschoolalertcom.AgencyListing" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="MSCaptcha" Namespace="MSCaptcha" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><link rel="icon" href="/images/ishfav.ico" type="image/x-icon" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid no-padding">
                <header>
            <div class="container">
                <div class="logo"><img src="/images/ISAOuterImages/isa-logo.png" alt="InSchoolAlert"></div>
            ...
            <div id="signupcontent" style="margin-top: 50px;">
                <div id="containercontact">
                    ...
                    <div id="signupform">
                        ...
                        <div class="txtfildwrap">
                            <asp:TextBox ID="txtFirstName" TabIndex="1" class="signuptextarea" runat="server"
                                MaxLength="500">
                            </asp:TextBox>&nbsp;
                        ...
                        <div class="txtfildwrap">
                            <asp:TextBox ID="txtLastName" TabIndex="2" class="signuptextarea" runat="server"
                                MaxLength="500">
                            </asp:TextBox>
                        </div>
                        <div class="clear15">
                        ...
                        <div class="txtfildwrap">
                            <asp:TextBox ID="txtAgencyname" TabIndex="3" runat="server" MaxLength="500" class="signuptextarea">
                            </asp:TextBox>&nbsp;
                        ...
                        <div class="txtfildwraps">
                            <div style="float: right; display: none; width:285px;" id="Progress">
                                <div class="CheckUsername">
                                    <img src='../../images/popup_ajax-loader.gif' /><b><font color="green">Processing....</font></b></div>
                            </div>
                        </div>
                        <div style="margin: auto 0px; line-height: 12px; text-align:center; display: none;" id="EmailAvailability">
                        ...
                        <div class="label1">
                            <span class="errormsg">* </span>Zip Code</div>
                        <div class="txtfildwrap">
                            <asp:TextBox ID="txtzipcode" MaxLength="10" runat="server" Rows="7" TabIndex="5"
                        ...
                        <div style="width: 450px; margin: 0px auto;">
                            By clicking 'Submit' you agree to the <a href="Terms.html" target="_blank">Terms of Service</a> of this site.
                        </div>
                        <div class="signupbtn">
                            <asp:LinkButton ID="lnkSubmit" runat="server" OnClick="btnSubmit_Click" CausesValidation="true"
                                TabIndex="14" ValidationGroup="A"><img src="<%=Page.ResolveClientUrl("~/images/ISHOuterImages/submit.png")%>" alt="" border="0" /></asp:LinkButton>
                            <br />
