...
{
    public partial class ManagePSCContacts : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (groupID > 0)
            {
                objPSC.AddGroupForPSC(groupID, txtcontactgroupname.Text, txtcontactgroupdes.Text, true, false, UserModuleID, ProfileID, C_UserID, UserID);
                hdnGroupID.Value = "";
        ...
        protected void chkGroupName_CheckedChanged(object sender, EventArgs e)
        {
            ...
            dtGroupNameList = objPSC.GetActiveContactsForPSC(UserModuleID, groupIds);
        ...
        protected void btnGroupDelete_Click(object sender, EventArgs e)
        {
            ...
            objPSC.DeleteGroupsForPSC(groupIds);
            BindGroupsData();
            GVCallIndexContacts.DataBind();
        }
        ...
        protected void lnkEditGroup_Click(object sender, EventArgs e)
        {
            ...
            ds = objPSC.GetGroupByIDForPSC(GroupID);
        ...
        {
            DataSet dsGroups = new DataSet();
            dsGroups = objPSC.GetPSCActiveGroups(UserModuleID);
        ...
        protected void btnContactAdd_Click(object sender, EventArgs e)
        {
            ...
            if (existingContactId >= 0)
            {
                ...
                if (contactID == 0 && existingContactId > 0)
                    ...
                    insertId = contactID;
                insertId = objPSC.InsertUpdatePSCContacts(insertId, txtFirstname.Text, txtLastname.Text, txtEmail.Text, txtcompanyname.Text, txtAddress.Text, txtCity.Text, txtState.Text, txtZipcode.Text, txtPhone.Text, txtMobile.Text, txtFax.Text, true, false, UserModuleID, ProfileID, UserID, C_UserID, txtPosition.Text, txtOrganization.Text, chkSendInvitation.Checked, false);
                if (insertId > 0)
                {
        ...
        protected void btnDeleteContact_Click(object sender, EventArgs e)
        {
            ...
            objPSC.DeleteContactsForPSC(contactIds);
            BindGroupsData();
            GVCallIndexContacts.DataBind();
        }
        ...
        protected void lnkEditContact_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = new DataSet();
            ds = objPSC.GetContactByIDForPSC(ContactID);
            if (ds.Tables[0].Rows.Count > 0)
            {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = objPSC.SearchEmailIDForPSC(txtSearchContact.Text, UserModuleID);
        ...
        protected void btnGroupNext_Click(object sender, EventArgs e)
        {
            ...
            {
                groupId = objPSC.AddGroupForPSC(0, txtImportGroup.Text.Trim(), "", true, false, UserModuleID, ProfileID, C_UserID, UserID);
                if (groupId > 0)
                {
        ...
        private int AddContacts(DataTable dtcsvtable, out int successCount)
        {
            ...
            foreach (DataRow dr in dtcsvtable.Rows)
            {
                ...
                if (re.IsMatch(email))
                {
                    objPSC.InsertImportContactsForPSC(0, names[0].ToString(), lastname, email, companyname, address, city, state, zipcode, phonenumber, mobilenumber, faxnumber, true, false, UserModuleID, ProfileID, UserID, C_UserID, Convert.ToInt32(hdnImportGroupId.Value), title, organization);
                    successCount++;
                }
                else
                {
