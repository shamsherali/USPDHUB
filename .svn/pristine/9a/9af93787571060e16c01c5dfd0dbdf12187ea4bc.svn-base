<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Enhance.aspx.cs" Inherits="USPDHUB.OP.inschoolhubcom.Enhance" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function CheckedChange() {
            document.getElementById('<%=pnlregpay.ClientID %>').style.display = "none";
            document.getElementById('<%=pnlcarddetails.ClientID %>').style.display = "none";
        }
    </script>
</head>
<body>
                                                                                            ...
                                                                                            <asp:Panel ID="pnlregpay" runat="server">
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="paymentdetails">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <span style="color: Red;">($<asp:Label ID="lblDiscount" runat="server" Style="color: Red;"></asp:Label>)</span>&nbsp;<asp:Label
                                                                                                                ID="lblfreeTrail" runat="server" Visible="false"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
