...
namespace USPDHUB.Business.MyAccount
{
    public partial class CMSchoolNotification : BaseWeb
    {
        ...
        private void GetAutoShareRecordStatus()
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMSchoolNotification.aspx.cs", "GetAutoShareRecordStatus", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        ...
        private string BuildLocatedImage(string htmlString)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMSchoolNotification.aspx.cs", "BuildLocatedImage", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
            return htmlString;
        }
        ...
        private void PngImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMSchoolNotification.aspx.cs", "PngImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void JpegImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMSchoolNotification.aspx.cs", "JpegImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
        private void BmpImageWritter(string generatedImgpath, string uploadedfilepath, string filepath, int originX, int originY)
        {
            ...
            {
                //Error 
                objInBuiltData.ErrorHandling("ERROR", "CMSchoolNotification.aspx.cs", "BmpImageWritter", ex.Message,
                Convert.ToString(ex.StackTrace), Convert.ToString(ex.InnerException), Convert.ToString(ex.Data));
            }
        }
