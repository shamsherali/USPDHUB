<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" Inherits="Business_MyAccount_AboutUs"
    CodeBehind="AboutUs.aspx.cs" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphUser" runat="Server">
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            //alert(domainName);
            if (domainName == "inschoolalertcom") {
                $("#<%=lblOn.ClientID %>").css("display", "none");
                $("#<%=lblOff.ClientID %>").css("display", "none");
            }
        ...
        function ShowPreview() {
            ...
            if (divCount > 0) {
                ...
                $.ajax({
                    ...
                    url: "AboutUs.aspx/ReplaceShortURltoHmlString",
                    dataType: "json",
                    processData: false,
                    success: function (data) {
                        HtmlBody = data.d;

                        //document.getElementById("<%=hdnPreviewHTML.ClientID %>").value = HtmlBody;
                ...
                alert("You haven't built your about us yet.");
                return false;
            }
        }
            ...
            <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
                <div id="wrapper">
                    ...
                    <div class="contentwrap">
                            ...
                            <div style="text-align: right; float: left; margin: 16px 0px 0px 10px;">
                                ...
                                <img style="cursor: pointer;" onclick="AddBlocks('DIV_TEXT');" src="../../Images/addnewtext.png" />
                                 <%if (Convert.ToBoolean(hdnIsLiteVersion.Value))
                                  { %>
                                <a href="javascript:ModalHelpPopup('Add Text to Information',328,'');">
                                    <img src="<%=Page.ResolveClientUrl("~/images/Dashboard/new.png")%>" style="border: 0px;" /></a>
                                <%}
                                  else
                                  { %>
                                <a id="A1" href="javascript:ModalHelpPopup('Add Text to About Us',3,'');">
                              ...
                              <br />
                                ...
                                <img style="cursor: pointer;" onclick="AddBlocks('DIV_IMAGE');" src="../../Images/addnewimg.png" />
                                 <%if (Convert.ToBoolean(hdnIsLiteVersion.Value))
                                  { %>
                                <a href="javascript:ModalHelpPopup('Add Image on Information',327,'');">
                                    <img src="<%=Page.ResolveClientUrl("~/images/Dashboard/new.png")%>" style="border: 0px;" /></a>
                                <%}
                                  else
                                  { %>
                               <a id="AddImageProfileDetails" href="javascript:ModalHelpPopup('Add Image on About Us',194,'');">
                                    <img src="<%=Page.ResolveClientUrl("~/images/Dashboard/new.png")%>" /></a>
                                <%} %>
                                ...
                                <img style="cursor: pointer;" onclick="AddBlocks('DIV_VIDEO');" src="../../Images/AddVideo.png" />
                                  <%if (Convert.ToBoolean(hdnIsLiteVersion.Value))
                                  { %>
                                <a href="javascript:ModalHelpPopup('Add Video Link to Information',369,'');">
                                    <img src="<%=Page.ResolveClientUrl("~/images/Dashboard/new.png")%>" style="border: 0px;" /></a>
                                <%}
                                  else
                                  { %>
                             <a id="A2" href="javascript:ModalHelpPopup('Add Video to Template',274,'');">
                                    <img src="<%=Page.ResolveClientUrl("~/images/Dashboard/new.png")%>" /></a>
                                <%} %>
                        ...
                        <div class="fields_wrap" style="margin: 0 auto; width: 433px;">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn" border="0" OnClick="Button1_Click"
                            ...
                            <asp:Button ID="btnDashboard" runat="server" Text="Dashboard" CssClass="btn" border="0"
                                CausesValidation="false" OnClick="btnDashboard_OnClick" />
                            <asp:LinkButton ID="lnkPreview" runat="server" OnClientClick="return ShowPreview();">
                                    <img src="../../images/BulletinThumbs/preview.png"  width="100" height="37" style="margin:0px 6px 0px 0px;"></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </asp:Panel>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tbody>
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" visiable="false"></asp:Label>
                    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="lblProgress"
                        PopupControlID="pnlProgress" BackgroundCssClass="modal">
                    </cc1:ModalPopupExtender>
                    <asp:Panel Style="display: none;" ID="Panel2" runat="server" Width="500px">
                        <table class="modalpopup" cellspacing="0" cellpadding="0" width="100%" align="center"
                            border="0">
                            <tr>
                                <td align="center">
    ...
    <asp:HiddenField runat="server" ID="hdnAboutUsPermission" />
    ...
    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlVideoPreview" runat="server" Style="display: none" Width="600px">
                <table cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #EEECEC;
                    background-color: #F8F6F6;">
                    <tbody>
                        <tr>
